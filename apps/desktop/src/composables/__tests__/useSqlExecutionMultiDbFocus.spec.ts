 ...
 *
 * Background:
 *  - `crates/gauss-horizon-core/src/db/sqlserver.rs:523-542` synthesizes a pseudo result with a
...
function queryTab(database = "gauss_horizon_sqlserver_demo"): QueryTab {
  return {
    id: "tab-1",
    connectionId: "conn-1",
    database,
