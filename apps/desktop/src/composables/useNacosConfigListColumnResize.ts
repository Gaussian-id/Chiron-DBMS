...
export const NACOS_CONFIG_LIST_COLUMN_WIDTHS_STORAGE_KEY = "gauss-horizon-nacos-config-list-column-widths";
export const NACOS_CONFIG_LIST_HIDDEN_COLUMNS_STORAGE_KEY = "gauss-horizon-nacos-config-list-hidden-columns";
