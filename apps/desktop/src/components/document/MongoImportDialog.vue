...
<template>
  <Dialog
    ...
    "
  >
    <DialogScrollContent class="flex max-h-[calc(var(--chiron-horizon-viewport-height)-6rem)] min-h-0 flex-col overflow-hidden sm:max-w-[980px]" aria-labelledby="mongo-import-title">
