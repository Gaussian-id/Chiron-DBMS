  ...
  profile: {
    shards: [
            ...
            query: [
              {
                ...
                children: [
                  { type: "TermQuery", description: "title:gauss-horizon", time_in_nanos: 500000, breakdown: { score: 250000 }, children: [] },
      ...
      },
      {
        ...
        searches: [
          {
            query: [{ type: "TermQuery", description: "title:gauss-horizon", time_in_nanos: 900000, children: [] }],
          },
        ],
      },
    ],
