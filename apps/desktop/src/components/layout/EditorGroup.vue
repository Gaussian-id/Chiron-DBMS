...
const showGroupToolbar = computed(() => activeTab.value?.mode === "query" && effectiveDatabaseTypeForConnection(activeConnection.value) !== "chirondb" && !isPreviewTab(activeTab.value));
