    ...
    <div v-else class="flex min-h-0 min-w-0 flex-1" :class="{ 'event-editor-layout': isEventEditor }">
      <div class="flex min-h-0 min-w-0 flex-1 flex-col">
        <div v-if="isListView" class="object-browser-table flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
          ...
          <RecycleScroller ref="listScrollerRef" class="object-browser-scroller min-h-0 flex-1" :style="{ '--chiron-horizon-object-grid-min-width': `${objectGridMinWidth}px` }" :items="filteredRows" :item-size="34" :buffer="600" :skip-hover="true" key-field="id">
...
html.chiron-horizon-legacy-webview.dark .object-browser-scroller::-webkit-scrollbar-thumb {
  background: rgba(212, 212, 216, 0.28);
}

html.chiron-horizon-legacy-webview.dark .object-browser-scroller:hover::-webkit-scrollbar-thumb {
...
.object-browser-scroller :deep(.vue-recycle-scroller__item-wrapper) {
  min-width: var(--chiron-horizon-object-grid-min-width, 0px);
}
