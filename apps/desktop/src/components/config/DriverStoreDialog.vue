...
html.chiron-horizon-legacy-webview .driver-store-agent-row--installed::before {
  background: rgb(22 163 74) !important;
}

html.chiron-horizon-legacy-webview.dark .driver-store-agent-row--installed::before {
