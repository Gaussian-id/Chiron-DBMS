...
async function exportConfig() {
  await saveTextFile(serializeSqlFormatterConfig(settings.value), "gauss-horizon-sql-formatter.json", "JSON", "json");
}
        ...
        <div class="formatter-fields-grid grid gap-4">
          <div class="space-y-2">
            ...
            <div class="grid grid-cols-2 gap-2">
              <Button type="button" variant="outline" class="justify-center" :class="!settings.useTabs ? 'gauss-horizon-choice-selected' : ''" @click="updateOption('useTabs', false)">
                {{ t("settings.sqlFormatterIndentSpaces") }}
              </Button>
              <Button type="button" variant="outline" class="justify-center" :class="settings.useTabs ? 'gauss-horizon-choice-selected' : ''" @click="updateOption('useTabs', true)">
