...
import { createTableReferenceDropEvent, createTableReferencePayload, CHIRON_HORIZON_TABLE_REFERENCE_DROP_EVENT, type QueryEditorTableReferencePayload } from "@/lib/editor/queryEditorTableDrop";
...
function dispatchTableReferenceDrop(payload: QueryEditorTableReferencePayload, context: AiTableReferenceDropContext) {
  ...
  window.removeEventListener(CHIRON_HORIZON_TABLE_REFERENCE_DROP_EVENT, listener);
  return mentions;
}
