  ...
  <div ref="rootRef" tabindex="-1" class="mcp-scope-picker space-y-3 outline-none" :aria-busy="busy">
    ...
    <div class="grid grid-cols-1 gap-1 rounded-md border bg-muted/50 p-1 sm:grid-cols-2" role="radiogroup" :aria-labelledby="`${pickerId}-mode-label`">
      <Button
        ...
        :class="[scopeMode === 'all' ? 'chiron-horizon-choice-selected bg-background shadow-sm' : 'text-muted-foreground hover:bg-background/70', disabled ? 'cursor-not-allowed opacity-50' : '']"
      ...
      <Button
        ...
        variant="outline"
        class="settings-choice-card h-auto justify-center border-0 p-2.5 shadow-none"
        :class="[scopeMode === 'selected' ? 'chiron-horizon-choice-selected bg-background shadow-sm' : 'text-muted-foreground hover:bg-background/70', disabled ? 'cursor-not-allowed opacity-50' : '']"
