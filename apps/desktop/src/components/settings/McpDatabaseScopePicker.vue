      ...
      <div v-if="selectedConnection" class="space-y-3 p-3">
        ...
        <div class="grid gap-2 sm:grid-cols-3" role="radiogroup" :aria-label="t('settings.mcpDatabaseScopeAriaLabel')">
          <Button
            ...
            :class="selectedScope === 'all' ? 'gauss-horizon-choice-selected' : ''"
          ...
          <Button
            ...
            variant="outline"
            class="h-auto justify-start px-3 py-2 text-left"
            :class="selectedScope === 'selected' ? 'gauss-horizon-choice-selected' : ''"
          ...
          <Button
            ...
            variant="outline"
            class="h-auto justify-start px-3 py-2 text-left"
            :class="selectedScope === 'none' ? 'gauss-horizon-choice-selected' : ''"
