    ...
    <div class="flex-1 min-h-0 overflow-auto">
      ...
      <div class="grid grid-cols-6 gap-3 px-4 pt-3 pb-2">
        ...
        <div class="rounded-lg border bg-card text-card-foreground p-3">
          ...
          <div class="text-xl font-semibold tabular-nums chiron-horizon-editor-font-family truncate" :title="totalMemory">
            {{ totalMemory }}
          </div>
        </div>
        <!-- Used Memory -->
        <div class="rounded-lg border bg-card text-card-foreground p-3">
          ...
          <div class="text-xl font-semibold tabular-nums chiron-horizon-editor-font-family truncate" :title="usedMemory">
            {{ usedMemory }}
          </div>
        </div>
        <!-- Operation -->
        <div class="rounded-lg border bg-card text-card-foreground p-3">
          ...
          <div class="text-xl font-semibold tabular-nums chiron-horizon-editor-font-family truncate" :title="operation">
            {{ operation }}
          </div>
        </div>
        <!-- Hit Ratio -->
        <div class="rounded-lg border bg-card text-card-foreground p-3">
          ...
          <div class="text-xl font-semibold tabular-nums chiron-horizon-editor-font-family truncate" :title="hitRatio">
            {{ hitRatio }}
          </div>
        </div>
        <!-- Key Count -->
        <div class="rounded-lg border bg-card text-card-foreground p-3">
          ...
          <div class="text-xl font-semibold tabular-nums chiron-horizon-editor-font-family truncate" :title="keyCount">
            {{ keyCount }}
          </div>
        </div>
        <!-- Clients -->
        <div class="rounded-lg border bg-card text-card-foreground p-3">
          ...
          <div class="text-xl font-semibold tabular-nums chiron-horizon-editor-font-family truncate" :title="connectedClients">
            {{ connectedClients }}
          </div>
        </div>
      </div>
            ...
            <table class="w-full text-xs border-collapse">
              <tbody>
                <tr v-for="(entry, ei) in section.entries" :key="ei" class="hover:bg-muted/20">
                  ...
                  <td class="w-1/2 border-b px-3 py-1.5 chiron-horizon-editor-font-family tabular-nums select-text break-all cursor-context-menu" :title="t('common.copy') || 'Copy'" @contextmenu.prevent="copyEntryValue(entry)">{{ entry.value }}</td>
                </tr>
              </tbody>
            </table>
          </div>
