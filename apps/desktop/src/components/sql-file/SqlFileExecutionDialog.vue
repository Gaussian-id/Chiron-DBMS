...
// The web server caps SQL file uploads via CHIRON_HORIZON_SQL_FILE_UPLOAD_MAX_MB; fetch the
...
<template>
  <Dialog :open="open" @update:open="handleOpenChange">
    <DialogScrollContent class="flex max-h-[calc(var(--chiron-horizon-viewport-height)-6rem)] min-h-0 min-w-0 flex-col overflow-hidden sm:max-w-[860px]" :trap-focus="false" @interact-outside.prevent>
