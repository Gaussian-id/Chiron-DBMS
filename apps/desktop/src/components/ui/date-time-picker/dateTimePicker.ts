...
/**
 * Interprets the timezone-free wall-clock value in the Gauss Horizon device's system time
...
/** Converts Unix seconds to a timezone-free value in the Gauss Horizon device's system time zone. */
