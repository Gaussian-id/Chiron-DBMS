    ...
    <PopoverContent :align="SEARCHABLE_SELECT_HELP_PANEL_ALIGN" :class="cn('w-auto max-w-[calc(100vw-1rem)] border-0 bg-transparent p-0 shadow-none ring-0', contentClass)" :style="contentStyle">
      <div class="flex min-w-0 flex-col gap-2 sm:flex-row sm:items-start">
        <div ref="listCard" :class="cn('shrink-0 rounded-md border bg-popover p-1.5 shadow-md', listClass)">
          ...
          <div ref="listContainer" class="chiron-horizon-searchable-select-list max-h-64 overflow-y-auto py-1" @scroll="updateHelpPanelOffset" @pointerleave="emit('option-leave')">
            ...
            <template v-else-if="filteredOptions.length">
              ...
              >
                ...
                <div class="chiron-horizon-searchable-select-option-label min-w-0 flex-1 overflow-hidden">
...
<style>
.chiron-horizon-searchable-select-list {
  scrollbar-width: thin;
  scrollbar-color: color-mix(in oklch, var(--foreground) 30%, transparent) transparent;
}

.chiron-horizon-searchable-select-list::-webkit-scrollbar {
  width: 6px;
  height: 6px;
}

.chiron-horizon-searchable-select-list::-webkit-scrollbar-track {
  background: transparent;
}

.chiron-horizon-searchable-select-list::-webkit-scrollbar-thumb {
...
.chiron-horizon-searchable-select-list:hover::-webkit-scrollbar-thumb {
  border: 0;
  background: color-mix(in oklch, var(--foreground) 48%, transparent);
}

.dark .chiron-horizon-searchable-select-list {
  scrollbar-color: rgb(82, 82, 91) transparent;
}

.dark .chiron-horizon-searchable-select-list::-webkit-scrollbar-thumb {
  background: rgb(82, 82, 91);
  background-clip: padding-box;
}

.dark .chiron-horizon-searchable-select-list:hover::-webkit-scrollbar-thumb {
