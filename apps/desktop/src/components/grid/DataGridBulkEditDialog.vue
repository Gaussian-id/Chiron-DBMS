    ...
    <DialogContent :style="dialogContentStyle" class="sm:max-w-[680px]">
      ...
      <div class="space-y-2">
        ...
        <div v-if="scope === 'condition'" class="space-y-2">
          ...
          <template v-else>
            ...
            <textarea
              ...
              spellcheck="false"
              rows="3"
              class="chiron-horizon-data-grid-value-font min-h-20 w-full min-w-0 resize-y rounded-[6px] border border-input bg-transparent px-2.5 py-1.5 text-base outline-none transition-colors placeholder:text-muted-foreground focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 md:text-sm"
        ...
        <textarea
          ...
          spellcheck="false"
          rows="5"
          class="chiron-horizon-data-grid-value-font min-h-24 w-full min-w-0 resize-y rounded-[6px] border border-input bg-transparent px-2.5 py-1.5 text-base outline-none transition-colors placeholder:text-muted-foreground focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 md:text-sm"
