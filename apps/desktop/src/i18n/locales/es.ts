...
export default withEnglishFallback({
  ...
  pluginPlatform: {
    ...
    centerDescription: "Descubre capacidades opcionales de Gauss Horizon en un marketplace unificado y administra por separado los plugins instalados y los repositorios.",
    ...
    localInstallDescription: "Instala un .gauss-horizonp firmado obtenido fuera del marketplace. Gauss Horizon verifica automáticamente la integridad y la firma del repositorio.",
    repositoriesTitle: "Repositorios de plugins",
    repositoriesDescription: "Gauss Horizon administra la fuente oficial. Los repositorios propios o de terceros usan la configuración de confianza del repositorio.",
    ...
    allowUnsignedDevelopmentPackageDescription: "Solo afecta a la instalación manual de .gauss-horizonp y nunca reduce la verificación del marketplace oficial.",
    installPackage: "Instalar .gauss-horizonp",
    dropToInstall: "Suelta para instalar el paquete del plugin",
    dropInstallHint: "También puedes soltar un archivo .gauss-horizonp en esta página",
    packageFileType: "Paquete de plugin de Gauss Horizon",
    ...
    noInstalledPluginsDescription: "Instala un .gauss-horizonp firmado o permite explícitamente paquetes sin firmar para desarrollo local.",
  ...
  externalSqlFile: {
    modifiedTitle: "El archivo cambió fuera de Gauss Horizon",
    ...
    deletedDescription: "{path} fue eliminado o movido fuera de Gauss Horizon. El contenido del editor sigue disponible.",
  ...
  updates: {
    ...
    availableMessage: "Gauss Horizon {latest} está disponible. Estás usando la versión {current}.",
    upToDate: "Gauss Horizon está actualizado ({version}).",
    ...
    downloadStarted: "Descargando Gauss Horizon {version} en segundo plano.",
    activeTasksBlockUpdate: "Hay {count} tarea(s) en ejecución. Espera a que terminen antes de actualizar Gauss Horizon.",
    portableAutomaticUpdate: "Gauss Horizon descargará el ZIP portable firmado, reemplazará solo Gauss Horizon.exe después de salir y se reiniciará automáticamente. portable.gauss-horizon y data se conservarán.",
    ...
    readyToInstall: "Gauss Horizon {version} está listo para instalar.",
    installNow: "Instalar ahora",
    installedReadyToRestart: "Gauss Horizon se ha actualizado. Reinicia para finalizar.",
  ...
  sidebar: {
    ...
    importGaussHorizon: "Importar configuración Gauss Horizon",
  ...
  sqlLibrary: {
    ...
    storageHelp: "El contenido de la Biblioteca SQL se guarda en los datos de la aplicación Gauss Horizon, no como archivos .sql independientes en el disco.\nPara usarlo en el sistema de archivos, exporta la Biblioteca SQL.",
  ...
  connection: {
    ...
    rememberPasswordSaveFailed: "Conectado, pero Gauss Horizon no pudo recordar la contraseña: {message}",
    ...
    oracleTnsPathHint: "La ruta la lee el backend de Gauss Horizon/Oracle Agent. En escritorio es local; en Web y Docker pertenece al servidor.",
    ...
    nacosWebConsoleUrlHint: "Opcional. Abre la consola de Nacos en el navegador. Nacos 3 requiere su dirección de consola web independiente; el navegador necesita acceso directo y no reutiliza los túneles ni la autenticación de API de Gauss Horizon.",
    ...
    gaussdbConnectionModeNativeHint: "Usa el protocolo compatible con PostgreSQL integrado en Gauss Horizon para los modos A/PG/Oracle de GaussDB.",
    ...
    agentJavaTooOld: "Este controlador requiere Java 21. Use el JRE 21 administrado por Gauss Horizon o seleccione un ejecutable Java 21 en el Administrador de controladores.",
    ...
    jdbcPluginHint: "Instala primero el plugin JDBC de Gauss Horizon y luego importa el JAR del driver JDBC del proveedor.",
    ...
    kafkaKerberosKeytabPlaceholder: "Ruta en la máquina donde se ejecuta Gauss Horizon Agent, por ejemplo /etc/security/keytabs/user.keytab",
    kafkaKerberosKrb5ConfPlaceholder: "Opcional, ruta en la máquina donde se ejecuta Gauss Horizon Agent, por ejemplo /etc/krb5.conf",
    kafkaKerberosPathHint: "Las rutas de keytab y krb5.conf son leídas por Gauss Horizon Agent y deben existir en la máquina donde se ejecuta Gauss Horizon Agent; no se subirán archivos desde el navegador actual.",
    ...
    sqliteWorkerPlacementSessionHint: "Gauss Horizon sube el worker por SSH al host de archivos y elimina el archivo remoto al desconectar. Adecuado para uso temporal.",
    sqliteWorkerPlacementPersistHint: "Gauss Horizon sube el worker por SSH al host de archivos y lo deja allí tras desconectar. No se elimina automáticamente.",
    sqliteWorkerPlacementPreplacedHint: "Sube el worker al host de archivos manualmente y luego introduce su ruta absoluta. Gauss Horizon no lo subirá ni lo eliminará automáticamente, pero verificará que el archivo coincida con esta versión de Desktop.",
    ...
    sshWorkerUploadConsentMessage: "Gauss Horizon necesita copiar un worker de SQLite de corta duración en {host}:{port}. Es una acción privilegiada. Revisa la ruta de destino y el digest antes de permitir la subida.",
  ...
  editor: {
    ...
    unsavedChangesBatchCloseMultipleMessage: '{count} pestañas SQL que vas a cerrar tienen cambios sin guardar. Gauss Horizon muestra actualmente "{title}". ¿Guardar antes de continuar?',
    unsavedChangesAppCloseMessage: '"{title}" tiene cambios SQL sin guardar que se perderán si sales de Gauss Horizon. ¿Guardar antes de salir?',
    unsavedChangesAppCloseMultipleMessage: '{count} pestañas SQL tienen cambios sin guardar. Gauss Horizon muestra actualmente "{title}". Se perderán si sales de Gauss Horizon. ¿Guardar antes de salir?',
  ...
  tabs: {
    ...
    externalFileMissing: "Eliminado o movido fuera de Gauss Horizon",
  ...
  grid: {
    ...
    esDeepPageJumpConfirmMessage:
      "search_after de Elasticsearch no puede saltar directamente a una página. Gauss Horizon debe obtener en orden los cursores que faltan y, al retroceder, comienza de nuevo desde la página 1. Saltar a la página {page} enviará aproximadamente {requests} consultas. Puede tardar y aumentar la carga del clúster. ¿Continuar?",
    ...
    conditionalBulkEditConfirmMessage: "Esta operación actualiza inmediatamente todas las filas que coincidan al ejecutarse, incluidas las no cargadas. Gauss Horizon no puede generar una reversión fiable para ellas.",
    ...
    queryEditUnsupported: {
      ...
      "complex-source": "Gauss Horizon no pudo identificar exactamente una tabla de destino segura para escribir este resultado.",
      ...
      "metadata-unavailable": "Gauss Horizon no pudo cargar los metadatos de la tabla, por lo que la edición de resultados está deshabilitada.",
    },
  ...
  configExport: {
    ...
    cryptoUnavailable: "La importación cifrada no está disponible en este navegador. Usa HTTPS, localhost o Gauss Horizon Desktop.",
  ...
  ai: {
    ...
    codexMcpRequiredTitle: "Se requiere Gauss Horizon MCP Server",
    codexMcpRequiredDescription: "Codex CLI usa Gauss Horizon MCP Server para acceder al esquema de la base de datos y a las herramientas de consulta. Instálalo antes de usar Codex en el asistente de IA.",
    ...
    codexCliEnvReservedName: "{name} lo administra Gauss Horizon para MCP Server y no se puede configurar aquí.",
    ...
    cliErrors: {
      ...
      claudeCodeEnvReserved: "Se sobrescribió una variable MCP administrada por Gauss Horizon. Elimina las variables GAUSS_HORIZON_MCP_* de la configuración del proveedor.",
      ...
      claudeCodeMcpConfigInvalid: "Claude Code no pudo leer o analizar la configuración MCP de Gauss Horizon. Comprueba la versión y la ruta del ejecutable de Claude Code CLI.",
      gaussHorizonMcpMissing: "No se encontró una instalación compatible de Gauss Horizon MCP Server. Comprueba Configuración > MCP y vuelve a instalarla o actualizarla.",
      claudeCodeMcpStartupFailed: "Claude Code cargó la configuración MCP, pero no pudo iniciar Gauss Horizon MCP Server. Comprueba Configuración > MCP y los detalles siguientes.",
      claudeCodeCommandLineTooLong: "Windows rechazó el comando de Claude Code porque era demasiado largo. Actualiza Gauss Horizon y vuelve a intentarlo con el archivo MCP generado.",
      ...
      piAgentEnvReserved: "Se sobrescribió una variable de Pi o MCP administrada por Gauss Horizon. Elimina GAUSS_HORIZON_PI_* y GAUSS_HORIZON_MCP_* de la configuración.",
      ...
      piAgentMcpStartupFailed: "Pi no pudo iniciar el puente MCP de Gauss Horizon. Comprueba Configuración > MCP y los detalles siguientes.",
      ...
      openCodeEnvReserved: "Se intentó sobrescribir una variable administrada por OpenCode o Gauss Horizon. Elimina las variables de control OPENCODE y GAUSS_HORIZON_MCP_* de la configuración.",
      ...
      openCodeMcpStartupFailed: "OpenCode no pudo iniciar el servidor Gauss Horizon MCP con ámbito restringido. Revisa Ajustes > MCP y los detalles siguientes.",
      ...
      cursorEnvReserved: "Se intentó sobrescribir una variable administrada por Cursor o Gauss Horizon. Elimina CURSOR_CONFIG_DIR, CURSOR_DATA_DIR y GAUSS_HORIZON_MCP_* de la configuración.",
      cursorNotAuthenticated: "Cursor CLI no está autenticado. Ejecuta `agent login` en una terminal y vuelve a intentarlo.",
      cursorMcpStartupFailed: "Cursor no pudo iniciar el servidor Gauss Horizon MCP con ámbito restringido. Revisa Ajustes > MCP y los detalles siguientes.",
      ...
      grokCliEnvReserved: "Se sobrescribió una variable MCP gestionada por Gauss Horizon. Elimina las variables GAUSS_HORIZON_MCP_* de la configuración del proveedor.",
      grokCliNotAuthenticated: "Grok CLI no está autenticado. Ejecuta `grok login` en una terminal e inténtalo de nuevo.",
      grokCliMcpStartupFailed: "Grok cargó la configuración MCP pero no pudo iniciar Gauss Horizon MCP Server. Revisa Ajustes > MCP y los diagnósticos siguientes.",
      grokCliCommandLineTooLong: "Windows rechazó el comando de Grok CLI porque era demasiado largo. Actualiza Gauss Horizon y vuelve a intentarlo con el archivo de prompt generado.",
      ...
      codeBuddyEnvReserved: "Se sobrescribió una variable MCP gestionada por Gauss Horizon. Elimina las variables GAUSS_HORIZON_MCP_* de la configuración del proveedor.",
      ...
      codeBuddyMcpConfigInvalid: "CodeBuddy Code no pudo leer la configuración temporal de Gauss Horizon MCP. Revisa los diagnósticos siguientes.",
      codeBuddyMcpStartupFailed: "CodeBuddy Code cargó la configuración MCP pero no pudo iniciar Gauss Horizon MCP Server. Revisa Ajustes > MCP y los diagnósticos siguientes.",
      ...
      qoderEnvReserved: "Se sobrescribió una variable de entorno MCP administrada por Gauss Horizon. Elimina las variables GAUSS_HORIZON_MCP_* de la configuración del proveedor.",
      ...
      qoderMcpConfigInvalid: "Qoder CLI no pudo leer la configuración MCP temporal de Gauss Horizon. Comprueba la versión de Qoder CLI y los diagnósticos siguientes.",
      qoderMcpStartupFailed: "Qoder CLI cargó la configuración MCP, pero no pudo iniciar Gauss Horizon MCP Server. Comprueba Configuración > MCP y los diagnósticos siguientes.",
    ...
    closeWithRunsDescription: "Salir de Gauss Horizon interrumpirá {count} tarea(s) de AI en ejecución o en cola. También puedes cerrar este diálogo y dejar que terminen.",
    ...
    productionWriteBlocked: "La IA no puede ejecutar cambios de datos o esquema en una base de datos de producción. Revisa este SQL y ejecútalo manualmente en Gauss Horizon.",
    ...
    htmlCopyRiskBody: "Este HTML fue generado por IA. Abrirlo fuera de Gauss Horizon puede ejecutar scripts y acceder a la red.",
    htmlCopyRiskAccept: "Copiar de todos modos",
    htmlCopyRiskRemember: "No volver a preguntar en esta sesión",
    htmlCopyRiskToast: "Copiado. Este HTML generado por IA puede ejecutar scripts o acceder a la red si se abre fuera de Gauss Horizon.",
    ...
    customHeadersReserved: "Gauss Horizon administra esta cabecera: {name}",
  ...
  contextMenu: {
    ...
    parameterDefaultHint: "Cuando DEFAULT está marcado, Gauss Horizon omite ese argumento para que la base de datos use el valor predeterminado.",
  ...
  etcd: {
    ...
    dashboard: {
      ...
      metricsUnavailableHint: "El estado del clúster sigue disponible. Gauss Horizon solicita /metrics directamente al endpoint de etcd actual; comprueba que la URL resultante sea accesible desde Gauss Horizon.",
  ...
  sqlParameters: {
    ...
    description: "Completa valores para marcadores de plantilla SQL. Gauss Horizon los reemplaza antes de ejecutar el SQL.",
    name: "Parámetro",
    syntax: "Sintaxis",
    type: "Tipo",
    value: "Valor",
  ...
  settings: {
    ...
    uiFontAppDefault: "Predeterminada de Gauss Horizon",
    ...
    iconThemeDefaultDescription: "Usar el icono de color de Gauss Horizon.",
    iconThemeBlack: "Negro",
    iconThemeBlackDescription: "Usa el logo negro de Gauss Horizon en la aplicación.",
    ...
    showTrayIconDescription: "Si está desactivado, no se muestra el icono, pero cerrar la ventana sigue ocultando Gauss Horizon en segundo plano como antes.",
    quitOnClose: "Salir al cerrar la ventana",
    quitOnCloseDescription: "Si está activado, al pulsar el botón de cerrar Gauss Horizon se cierra por completo en lugar de ocultarse en la bandeja.",
    ...
    closeActionQuit: "Salir de Gauss Horizon",
    ...
    duckDbWorkerProcessIsolationDescription: "Ejecuta las consultas de DuckDB en un proceso worker independiente. Si una consulta larga no responde a la cancelación, Gauss Horizon puede detener el proceso worker para liberar el bloqueo del archivo de base de datos.",
    duckDbWorkerMaxProcesses: "Workers concurrentes máximos de DuckDB",
    duckDbWorkerMaxProcessesDescription: "Limita cuántos procesos worker de DuckDB puede ejecutar Gauss Horizon al mismo tiempo. Rango: 1-16. Predeterminado: 4.",
    duckDbWorkerProcessIsolationRestartRequired: "Reinicia Gauss Horizon para que este cambio surta efecto.",
    restartGaussHorizon: "Reiniciar Gauss Horizon",
    restartGaussHorizonFailed: "No se pudo reiniciar Gauss Horizon: {error}",
    ...
    openTabsRestoreModeDescription: "Elige cómo Gauss Horizon restaura las pestañas que estaban abiertas la última vez.",
    ...
    syncWebDavDescription: "Sube o restaura una instantánea de Gauss Horizon, incluida la biblioteca SQL guardada, desde almacenamiento compatible con WebDAV.",
    syncWebDavWebDescription: "En modo Web, el servidor Gauss Horizon accede a WebDAV sin las restricciones CORS del navegador. Las contraseñas guardadas permanecen en la instancia Gauss Horizon actual.",
    ...
    syncRememberWebDavPasswordDescription: "La contraseña se cifra y se guarda solo en la instancia Gauss Horizon actual. No se sincroniza a WebDAV ni reemplaza la contraseña de sync.",
    syncRemotePath: "Ruta remota",
    syncRemotePathDescription: "Gauss Horizon creará las carpetas padre faltantes al subir.",
    syncSecretNotice: "De forma predeterminada, Gauss Horizon solo sincroniza detalles de conexión y ajustes. Las contraseñas de base de datos, SSH, proxy, cadenas de conexión y API keys de IA quedan locales.",
    syncSecrets: "Sincronizar secretos cifrados",
    syncSecretsDescription: "Al activarlo, Gauss Horizon cifra contraseñas de base de datos, contraseñas SSH y API keys de IA antes de subirlas a WebDAV.",
    syncSecretsPassphrase: "Contraseña de sync",
    syncSecretsPassphraseDescription: "Esta contraseña solo se usa para cifrar y restaurar datos sensibles. Se cifra en la instancia Gauss Horizon actual; vuelve a ingresarla en otras instancias.",
    syncTest: "Probar",
    syncUpload: "Subir",
    ...
    syncAutoUploadDescription: "Se ejecuta mientras Gauss Horizon está abierto. Las descargas aún requieren confirmación manual para evitar reemplazar SQL guardado localmente.",
    ...
    syncDownloadConfirm: "¿Descargar y aplicar la instantánea remota de Gauss Horizon? Se reemplazarán metadatos locales y SQL guardado.",
    apply: "Aplicar",
    ...
    appCloseUnsavedTabsModeDescription: "Elige qué ocurre al salir de Gauss Horizon con pestañas SQL que tienen ediciones sin guardar.",
    appCloseUnsavedTabsModePrompt: "Preguntar si guardar",
    appCloseUnsavedTabsModeKeepDrafts: "Salir y conservar borradores",
    appCloseUnsavedTabsModeHint: 'Los borradores se conservan como pestañas sin guardar y se restauran la próxima vez que inicies Gauss Horizon. Requiere que "Restaurar pestañas al iniciar" no esté en "No conservar pestañas".',
    appCloseDraftPersistFailed: "Gauss Horizon no pudo guardar los borradores de las pestañas abiertas, por lo que se canceló la salida. Comprueba el espacio en disco y los permisos de los archivos, y vuelve a intentarlo. Detalles: {message}",
    ...
    sqlVariableSyntaxDescription: "Elige qué sintaxis de variables y marcadores sustituye Gauss Horizon antes de ejecutar SQL, por tipo de base de datos. Todas están habilitadas de forma predeterminada.",
    ...
    jdbcPlugin: "Plugin JDBC de Gauss Horizon",
    ...
    mcpTitle: "MCP Server",
    mcpDescription: "Comprueba la instalación y versión de Gauss Horizon MCP Server para Claude Code, Cursor y otros agentes.",
    ...
    mcpConfigOptionsHint:
      "Gauss Horizon controla de forma central el acceso a conexiones y los permisos de ejecución para todos los clientes MCP. La configuración generada solo contiene los parámetros de ejecución necesarios para iniciar el servidor MCP y conectarlo a esta instancia de Gauss Horizon, sin variables de permisos ni de ámbito de conexión.",
    mcpScopeConnection: "Conexiones permitidas para MCP",
    mcpScopeConnectionDescription: "Gauss Horizon solo expone a MCP las conexiones seleccionadas. Los cambios se aplican a todos los clientes MCP.",
    ...
    mcpExecutionModeReadOnlyDescription: "Solo permite solicitudes que Gauss Horizon clasifica como lecturas; bloquea las escrituras reconocidas y los cambios de conexión. Los permisos de la cuenta de base de datos siguen siendo el límite de seguridad final.",
    ...
    mcpCapabilityDescription: "Estas son operaciones representativas; las solicitudes que Gauss Horizon no puede clasificar de forma fiable requieren acceso completo.",
    ...
    mcpDetectionTiming: "Gauss Horizon comprueba automáticamente al abrir esta página; usa Comprobar de nuevo para actualizar.",
    mcpNpmBoundary: "Gauss Horizon solo comprueba y explica el estado de MCP; la instalación y actualización siguen usando npm.",
    ...
    mcpDatabaseScopePermissionNote: "El alcance seleccionado no cambia los permisos de bases de datos que la conexión ya tiene en Gauss Horizon.",
    ...
    mcpHttpServiceDescription: "Desactivado por defecto. Al activarlo, Gauss Horizon Desktop aloja el servicio; la configuración de arriba se aplica al servicio de escucha real solo después de guardar.",
    ...
    mcpHttpErrorPortInUse: "El puerto ya está ocupado por otra aplicación. Gauss Horizon reinicia su propio servicio MCP al guardar; cierra la otra aplicación que usa el puerto o elige otro puerto.",
    ...
    mcpToolOpenTable: "Abrir tabla en Gauss Horizon",
    mcpToolExecuteAndShow: "Ejecutar y mostrar en Gauss Horizon",
    ...
    supportInfoAppVersion: "Versión de Gauss Horizon",
    ...
    changelogOpenWebsite: "Ver repositorio",
    ...
    syncSnippetMigrateLegacyConfirm: "Gauss Horizon creará primero un reemplazo cifrado y después eliminará permanentemente el fragmento heredado de texto sin cifrar {id}. Esta acción no se puede deshacer. ¿Continuar?",
  ...
  driverStore: {
    ...
    jreDirRemoveFailedWindows:
      "No se pudo eliminar el directorio JRE antiguo: {path}\nCausas posibles:\n  - un proceso gauss-horizon Agent / java sigue usando el directorio\n  - el antivirus lo está analizando\nCierre cualquier proceso que pueda estar usando el directorio, o reinicie gauss-horizon e inténtelo de nuevo.\n(error original: {error})",
    ...
    offlineExportDescription: "Selecciona los drivers Agent administrados por Gauss Horizon que se incluirán. El paquete solo es compatible con la plataforma actual.",
    ...
    offlineExportNoDrivers: "No hay drivers Agent administrados por Gauss Horizon que se puedan exportar.",
    ...
    offlineExportSecurityHint: "Solo se incluyen artefactos administrados por Gauss Horizon y los JRE necesarios. Se excluyen rutas locales, configuraciones y drivers externos.",
    ...
    offlineExportUnavailable_unmanagedInstall: "El artefacto no está registrado como una instalación administrada por Gauss Horizon.",
    ...
    offlineExportUnavailable_missingManagedJre: "El JRE administrado por Gauss Horizon requerido no está instalado.",
    offlineExportUnavailable_invalidManagedJre: "El JRE administrado por Gauss Horizon requerido no es válido o no es seguro.",
    refresh: "Actualizar",
    javaRuntime: "Runtime Java",
    javaRuntimeManaged: "JRE administrado por Gauss Horizon",
    ...
    localInstallHint: "Para entornos sin acceso a internet: en otro equipo con conexión, descarga el gauss-horizon-jdbc-plugin-*.zip oficial desde la página de Releases de Gauss Horizon en GitHub, transfiérelo a esta máquina y selecciónalo; no se necesita acceso a la red en este equipo.",
    runtimeDrivers: "Runtime",
    pluginsTab: "Plugins",
    pluginContributionsTitle: "Contribuciones de frontend de plugins",
    pluginContributionsDescription: "Los plugins instalados pueden describir formularios de conexión y otras contribuciones de UI sin inyectar código en la ventana principal de Gauss Horizon.",
    noInstalledPlugins: "No hay plugins instalados",
  ...
  nacos: {
    ...
    namespaceIdPlaceholder: "Déjalo vacío para que Gauss Horizon genere un UUID",
    ...
    nacosDetectAccessibleNamespacesHint: "Gauss Horizon verifica el acceso de lectura a configuraciones y servicios antes de ofrecer namespaces para {name}.",
    ...
    nacosV3ConsoleManagedNamespacesHint: "Esta conexión usa la API Console de Nacos 3 (normalmente el puerto 8080). Introduce un nombre o ID de namespace; Gauss Horizon convierte el nombre al ID real cuando puede leer el directorio.",
    ...
    persistentInstanceHint: "Gauss Horizon no registra instancias efímeras porque no puede mantener sus latidos.",
  ...
  databaseBackup: {
    ...
    runtimeRequirement: "Gauss Horizon ejecutará copias de seguridad programadas cuando esté abierto, incluso cuando esté minimizado en la bandeja.",
    ...
    fileNamePatternHint: "Usa {'{'}schedule{'}'}, {'{'}date{'}'}, {'{'}timestamp{'}'}, {'{'}database{'}'} y {'{'}runId{'}'}. Gauss Horizon agrega el valor {'{'}database{'}'} si falta y añade la extensión automáticamente.",
  ...
  mqExchanges: {
    ...
    namePlaceholder: "p. ej. gauss-horizon-events",
    cancel: "Cancelar",
    create: "Crear",
    bind: "Vincular",
    bindDialogTitle: "Vincular a {name}",
    queueNamePlaceholder: "p. ej. gauss-horizon-queue",
    exchangeNamePlaceholder: "p. ej. gauss-horizon-events",
