...
export default withEnglishFallback({
  ...
  pluginPlatform: {
    ...
    localInstallDescription: "Instala un .chiron-horizonp firmado obtenido fuera del marketplace. Chiron Horizon verifica automáticamente la integridad y la firma del repositorio.",
  ...
  updates: {
    ...
    portableAutomaticUpdate: "Chiron Horizon descargará el ZIP portable firmado, reemplazará solo Chiron Horizon.exe después de salir y se reiniciará automáticamente. portable.chiron-horizon y data se conservarán.",
  ...
  ai: {
    ...
    cliErrors: {
      ...
      chironHorizonMcpMissing: "No se encontró una instalación compatible de Chiron Horizon MCP Server. Comprueba Configuración > MCP y vuelve a instalarla o actualizarla.",
  ...
  driverStore: {
    ...
    jreDirRemoveFailedWindows:
      "No se pudo eliminar el directorio JRE antiguo: {path}\nCausas posibles:\n  - un proceso chiron-horizon Agent / java sigue usando el directorio\n  - el antivirus lo está analizando\nCierre cualquier proceso que pueda estar usando el directorio, o reinicie chiron-horizon e inténtelo de nuevo.\n(error original: {error})",
