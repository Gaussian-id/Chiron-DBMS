...
export default {
  chiron: {
    ...
    resultsHint: "Run a ChironQL statement or browse a collection to view results.",
    ...
    sessionHint: "One ChironQL statement per request. The collection selector supplies context; HTTP USE does not persist. SQL transactions are not supported.",
  ...
  settings: {
    ...
    iconThemeBlackDescription: "Retain the legacy Black preference with Gaussian branding.",
    iconThemeBlackDescriptionMac: "Retain the legacy Black preference with Gaussian branding; the menu bar follows the system.",
    ...
    project: "Project",
    openSource: "Upstream DBX repository",
    officialDocs: "Upstream DBX docs",
