...
export default {
  ...
  pluginPlatform: {
    ...
    localInstallDescription: "Install a signed .chiron-horizonp obtained outside the marketplace. Chiron Horizon verifies package integrity and repository signatures automatically.",
  ...
  updates: {
    ...
    portableAutomaticUpdate: "Chiron Horizon will download the signed portable ZIP, replace only Chiron Horizon.exe after exit, and restart automatically. portable.chiron-horizon and data will be kept.",
  ...
  welcome: {
    chironTagline: "Your database workbench",
  ...
  ai: {
    ...
    cliErrors: {
      ...
      chironHorizonMcpMissing: "A compatible Chiron Horizon MCP Server installation was not found. Check Settings > MCP, then reinstall or update it.",
  ...
  structureEditor: {
    ...
    geometryEmptyTypeHint: "Empty geometry type equals GEOMETRY (any sub-type); chiron-horizon emits geometry(GEOMETRY, SRID).",
  ...
  settings: {
    ...
    uiFontAppDefault: "Chiron Default (Poppins)",
    ...
    themePaletteChiron: "Chiron Horizon",
    ...
    iconThemeDefaultDescription: "Use the Chiron Horizon app icon.",
    iconThemeBlack: "Black",
    iconThemeBlackDescription: "Use the Black Chiron Horizon artwork, independently of the light or dark theme.",
    iconThemeBlackDescriptionMac: "Use the Black Chiron Horizon artwork, independently of the light or dark theme.",
    ...
    updateNotificationsEnabledDescription: "Automatic updates and release downloads are unavailable in Chiron Horizon 0.1.0.",
    ...
    project: "Project",
    openSource: "Upstream Chiron Horizon repository",
    officialDocs: "Upstream Chiron Horizon docs",
