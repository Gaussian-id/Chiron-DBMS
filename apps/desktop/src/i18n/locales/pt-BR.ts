...
export default withEnglishFallback({
  ...
  pluginPlatform: {
    ...
    centerDescription: "Descubra recursos opcionais do Gauss Horizon em um marketplace unificado e gerencie separadamente plugins instalados e repositórios.",
    ...
    localInstallDescription: "Instale um .gauss-horizonp assinado obtido fora do marketplace. O Gauss Horizon verifica automaticamente a integridade e a assinatura do repositório.",
    repositoriesTitle: "Repositórios de plugins",
    repositoriesDescription: "A fonte oficial é gerenciada pelo Gauss Horizon. Repositórios próprios ou de terceiros usam as configurações de confiança do repositório.",
    ...
    allowUnsignedDevelopmentPackageDescription: "Afeta apenas a instalação manual de .gauss-horizonp e nunca reduz a verificação do marketplace oficial.",
    installPackage: "Instalar .gauss-horizonp",
    dropToInstall: "Solte para instalar o pacote do plugin",
    dropInstallHint: "Você também pode soltar um arquivo .gauss-horizonp nesta página",
    packageFileType: "Pacote de plugin do Gauss Horizon",
    ...
    noInstalledPluginsDescription: "Instale um .gauss-horizonp assinado ou permita explicitamente pacotes não assinados para desenvolvimento local.",
  ...
  externalSqlFile: {
    modifiedTitle: "Arquivo alterado fora do Gauss Horizon",
    ...
    deletedDescription: "{path} foi excluído ou movido fora do Gauss Horizon. O conteúdo do editor continua disponível.",
  ...
  updates: {
    ...
    availableMessage: "Gauss Horizon {latest} está disponível. Você está usando {current}.",
    upToDate: "O Gauss Horizon está atualizado ({version}).",
    ...
    downloadStarted: "Baixando o Gauss Horizon {version} em segundo plano.",
    activeTasksBlockUpdate: "Há {count} tarefa(s) em execução. Aguarde a conclusão antes de atualizar o Gauss Horizon.",
    portableAutomaticUpdate: "O Gauss Horizon baixará o ZIP portátil assinado, substituirá apenas o Gauss Horizon.exe após sair e reiniciará automaticamente. O portable.gauss-horizon e os dados serão mantidos.",
    ...
    readyToInstall: "Gauss Horizon {version} está pronto para instalar.",
    installNow: "Instalar agora",
    installedReadyToRestart: "O Gauss Horizon foi atualizado. Reinicie para concluir.",
  ...
  sidebar: {
    ...
    importGaussHorizon: "Importar Configuração Gauss Horizon",
  ...
  sqlLibrary: {
    ...
    storageHelp: "O conteúdo da Biblioteca SQL é salvo nos dados do aplicativo Gauss Horizon, não como arquivos .sql independentes no disco.\nPara usá-lo no sistema de arquivos, exporte a Biblioteca SQL.",
  ...
  connection: {
    ...
    rememberPasswordSaveFailed: "Conectado, mas o Gauss Horizon não conseguiu lembrar a senha: {message}",
    ...
    oracleTnsPathHint: "O caminho é lido pelo backend do Gauss Horizon/Oracle Agent. No desktop é local; no Web e Docker pertence ao servidor.",
    ...
    nacosWebConsoleUrlHint: "Opcional. Abre o console Nacos no navegador. O Nacos 3 requer seu endereço de console web separado; o navegador precisa de acesso direto e não reutiliza túneis ou autenticação de API do Gauss Horizon.",
    ...
    gaussdbConnectionModeNativeHint: "Usa o protocolo compatível com PostgreSQL integrado ao Gauss Horizon para os modos A/PG/Oracle do GaussDB.",
    ...
    agentJavaTooOld: "Este driver requer Java 21. Use o JRE 21 gerenciado pelo Gauss Horizon ou selecione um executável Java 21 no Gerenciador de Drivers.",
    ...
    jdbcPluginHint: "Instale primeiro o plugin JDBC do Gauss Horizon e depois importe o JAR do driver JDBC do fornecedor do banco de dados.",
    ...
    kafkaKerberosKeytabPlaceholder: "Caminho na máquina do Gauss Horizon Agent, por exemplo /etc/security/keytabs/user.keytab",
    kafkaKerberosKrb5ConfPlaceholder: "Opcional, caminho na máquina do Gauss Horizon Agent, por exemplo /etc/krb5.conf",
    kafkaKerberosPathHint: "Os caminhos do keytab e do krb5.conf são lidos pelo Gauss Horizon Agent e devem existir na máquina onde o Gauss Horizon Agent é executado; os arquivos não são enviados do navegador atual.",
    ...
    sqliteWorkerPlacementSessionHint: "O Gauss Horizon envia o worker via SSH para o host de arquivos e exclui o arquivo remoto ao desconectar. Adequado para uso temporário.",
    sqliteWorkerPlacementPersistHint: "O Gauss Horizon envia o worker via SSH para o host de arquivos e o mantém lá após a desconexão. Ele não é excluído automaticamente.",
    sqliteWorkerPlacementPreplacedHint: "Faça você mesmo o upload do worker para o host de arquivos e informe o caminho absoluto do arquivo. O Gauss Horizon não fará upload nem excluirá automaticamente, mas verificará se o arquivo corresponde a esta versão do Desktop.",
    ...
    sshWorkerUploadConsentMessage: "O Gauss Horizon precisa copiar um worker do SQLite de curta duração para {host}:{port}. Esta é uma ação privilegiada. Revise o caminho de destino e o digest antes de permitir o envio.",
  ...
  editor: {
    ...
    unsavedChangesBatchCloseMultipleMessage: '{count} abas SQL que você está fechando têm alterações não salvas. O Gauss Horizon está mostrando "{title}" no momento. Salvar antes de continuar?',
    unsavedChangesAppCloseMessage: '"{title}" tem alterações SQL não salvas que serão perdidas se você sair do Gauss Horizon. Salvar antes de sair?',
    unsavedChangesAppCloseMultipleMessage: '{count} abas SQL têm alterações não salvas. O Gauss Horizon está mostrando "{title}" no momento. Serão perdidas se você sair do Gauss Horizon. Salvar antes de sair?',
  ...
  tabs: {
    ...
    externalFileMissing: "Excluído ou movido fora do Gauss Horizon",
  ...
  grid: {
    ...
    esDeepPageJumpConfirmMessage:
      "O search_after do Elasticsearch não pode ir diretamente para uma página. O Gauss Horizon precisa buscar os cursores ausentes em ordem e, ao voltar, reinicia pela página 1. Ir para a página {page} deve enviar cerca de {requests} consultas. Isso pode demorar e aumentar a carga do cluster. Continuar?",
    ...
    conditionalBulkEditConfirmMessage: "Esta operação atualiza imediatamente todas as linhas correspondentes no momento da execução, incluindo linhas não carregadas. O Gauss Horizon não pode gerar uma reversão confiável.",
    ...
    queryEditUnsupported: {
      ...
      "complex-source": "O Gauss Horizon não conseguiu identificar exatamente uma tabela de destino segura para gravar este resultado.",
      ...
      "metadata-unavailable": "O Gauss Horizon não conseguiu carregar os metadados da tabela, portanto a edição do resultado está desabilitada.",
    },
  ...
  configExport: {
    ...
    cryptoUnavailable: "A importação criptografada não está disponível neste contexto do navegador. Use HTTPS, localhost ou Gauss Horizon Desktop.",
  ...
  ai: {
    ...
    codexMcpRequiredTitle: "Gauss Horizon MCP Server obrigatório",
    codexMcpRequiredDescription: "O Codex CLI usa o Gauss Horizon MCP Server para acessar o schema do banco e as ferramentas de consulta. Instale-o antes de usar o Codex no assistente de AI.",
    ...
    codexCliEnvReservedName: "{name} é gerenciada pelo Gauss Horizon para o MCP Server e não pode ser definida aqui.",
    ...
    cliErrors: {
      ...
      claudeCodeEnvReserved: "Uma variável MCP gerenciada pelo Gauss Horizon foi sobrescrita. Remova as variáveis GAUSS_HORIZON_MCP_* da configuração do provedor.",
      ...
      claudeCodeMcpConfigInvalid: "O Claude Code não conseguiu ler ou analisar a configuração MCP do Gauss Horizon. Verifique a versão e o caminho do executável do Claude Code CLI.",
      gaussHorizonMcpMissing: "Uma instalação compatível do Gauss Horizon MCP Server não foi encontrada. Verifique Configurações > MCP e reinstale ou atualize.",
      claudeCodeMcpStartupFailed: "O Claude Code carregou a configuração MCP, mas não conseguiu iniciar o Gauss Horizon MCP Server. Verifique Configurações > MCP e os detalhes abaixo.",
      claudeCodeCommandLineTooLong: "O Windows rejeitou o comando do Claude Code porque era muito longo. Atualize o Gauss Horizon e tente novamente com o arquivo MCP gerado.",
      ...
      piAgentEnvReserved: "Uma variável Pi ou MCP gerenciada pelo Gauss Horizon foi sobrescrita. Remova GAUSS_HORIZON_PI_* e GAUSS_HORIZON_MCP_* da configuração.",
      ...
      piAgentMcpStartupFailed: "O Pi não conseguiu iniciar a ponte MCP do Gauss Horizon. Verifique Configurações > MCP e os detalhes abaixo.",
      ...
      openCodeEnvReserved: "Uma variável gerenciada pelo OpenCode ou Gauss Horizon foi sobrescrita. Remova as variáveis de controle OPENCODE e GAUSS_HORIZON_MCP_* da configuração.",
      ...
      openCodeMcpStartupFailed: "O OpenCode não conseguiu iniciar o servidor Gauss Horizon MCP com escopo restrito. Verifique Configurações > MCP e os detalhes abaixo.",
      ...
      cursorEnvReserved: "Uma variável gerenciada pelo Cursor ou Gauss Horizon foi sobrescrita. Remova CURSOR_CONFIG_DIR, CURSOR_DATA_DIR e GAUSS_HORIZON_MCP_* da configuração.",
      cursorNotAuthenticated: "O Cursor CLI não está autenticado. Execute `agent login` no terminal e tente novamente.",
      cursorMcpStartupFailed: "O Cursor não conseguiu iniciar o servidor Gauss Horizon MCP com escopo restrito. Verifique Configurações > MCP e os detalhes abaixo.",
      ...
      grokCliEnvReserved: "Uma variável MCP gerenciada pelo Gauss Horizon foi sobrescrita. Remova as variáveis GAUSS_HORIZON_MCP_* da configuração do provedor.",
      grokCliNotAuthenticated: "Grok CLI não está autenticado. Execute `grok login` em um terminal e tente novamente.",
      grokCliMcpStartupFailed: "O Grok carregou a configuração MCP, mas não conseguiu iniciar o Gauss Horizon MCP Server. Verifique Configurações > MCP e os detalhes abaixo.",
      grokCliCommandLineTooLong: "O Windows rejeitou o comando do Grok CLI porque era muito longo. Atualize o Gauss Horizon e tente novamente com o arquivo de prompt gerado.",
      ...
      codeBuddyEnvReserved: "Uma variável MCP gerenciada pelo Gauss Horizon foi sobrescrita. Remova as variáveis GAUSS_HORIZON_MCP_* da configuração do provedor.",
      ...
      codeBuddyMcpConfigInvalid: "O CodeBuddy Code não conseguiu ler a configuração temporária do Gauss Horizon MCP. Verifique os detalhes abaixo.",
      codeBuddyMcpStartupFailed: "O CodeBuddy Code carregou a configuração MCP, mas não conseguiu iniciar o Gauss Horizon MCP Server. Verifique Configurações > MCP e os detalhes abaixo.",
      ...
      qoderEnvReserved: "Uma variável de ambiente MCP gerenciada pelo Gauss Horizon foi sobrescrita. Remova as variáveis GAUSS_HORIZON_MCP_* da configuração do provedor.",
      ...
      qoderMcpConfigInvalid: "O Qoder CLI não conseguiu ler a configuração MCP temporária do Gauss Horizon. Verifique a versão do Qoder CLI e os detalhes abaixo.",
      qoderMcpStartupFailed: "O Qoder CLI carregou a configuração MCP, mas não conseguiu iniciar o Gauss Horizon MCP Server. Verifique Configurações > MCP e os detalhes abaixo.",
    ...
    closeWithRunsDescription: "Sair do Gauss Horizon interromperá {count} tarefa(s) de AI em execução ou na fila. Você também pode fechar esta caixa de diálogo e deixá-las terminar.",
    ...
    productionWriteBlocked: "A IA não pode executar alterações de dados ou esquema em um banco de dados de produção. Revise este SQL e execute-o manualmente no Gauss Horizon.",
    ...
    htmlCopyRiskBody: "Este HTML foi gerado por IA. Abri-lo fora do Gauss Horizon pode executar scripts e acessar a rede.",
    htmlCopyRiskAccept: "Copiar mesmo assim",
    htmlCopyRiskRemember: "Não perguntar novamente nesta sessão",
    htmlCopyRiskToast: "Copiado. Este HTML gerado por IA pode executar scripts ou acessar a rede quando aberto fora do Gauss Horizon.",
    ...
    customHeadersReserved: "Este cabeçalho é gerenciado pelo Gauss Horizon: {name}",
  ...
  contextMenu: {
    ...
    parameterDefaultHint: "Quando DEFAULT está marcado, o Gauss Horizon omite esse argumento para que o banco de dados use o padrão do procedimento.",
  ...
  etcd: {
    ...
    dashboard: {
      ...
      metricsUnavailableHint: "O estado do cluster continua disponível. O Gauss Horizon solicita /metrics diretamente ao endpoint etcd atual; confirme se a URL resultante pode ser acessada pelo aplicativo Gauss Horizon.",
  ...
  sqlParameters: {
    ...
    description: "Preencha valores para marcadores de template SQL. O Gauss Horizon substitui antes de executar o SQL.",
    name: "Parâmetro",
    syntax: "Sintaxe",
    type: "Tipo",
    value: "Valor",
  ...
  settings: {
    ...
    uiFontAppDefault: "Padrão do Gauss Horizon",
    ...
    iconThemeDefaultDescription: "Usar o ícone colorido do app Gauss Horizon.",
    iconThemeBlack: "Preto",
    iconThemeBlackDescription: "Use o logo preto da Gauss Horizon no app.",
    ...
    showTrayIconDescription: "Quando desativado, nenhum ícone é exibido, mas fechar a janela ainda oculta o Gauss Horizon em segundo plano como antes.",
    quitOnClose: "Sair ao fechar a janela",
    quitOnCloseDescription: "Quando ativado, o botão de fechar encerra o Gauss Horizon completamente em vez de minimizar para a bandeja.",
    ...
    closeActionQuit: "Sair do Gauss Horizon",
    ...
    duckDbWorkerProcessIsolationDescription: "Executa consultas DuckDB em um processo worker separado. Se uma consulta longa não responder ao cancelamento, o Gauss Horizon pode encerrar o processo worker para liberar o bloqueio do arquivo de banco de dados.",
    duckDbWorkerMaxProcesses: "Máximo de workers simultâneos do DuckDB",
    duckDbWorkerMaxProcessesDescription: "Limita quantos processos worker do DuckDB o Gauss Horizon pode executar ao mesmo tempo. Intervalo: 1-16. Padrão: 4.",
    duckDbWorkerProcessIsolationRestartRequired: "Reinicie o Gauss Horizon para que esta alteração entre em vigor.",
    restartGaussHorizon: "Reiniciar Gauss Horizon",
    restartGaussHorizonFailed: "Falha ao reiniciar o Gauss Horizon: {error}",
    ...
    openTabsRestoreModeDescription: "Escolha como o Gauss Horizon restaura as abas que estavam abertas na última vez.",
    ...
    syncWebDavDescription: "Envie ou restaure um snapshot do Gauss Horizon, incluindo a biblioteca SQL salva, a partir de um serviço de armazenamento compatível com WebDAV.",
    syncWebDavWebDescription: "No modo Web, o servidor Gauss Horizon acessa o WebDAV sem as restrições de CORS do navegador. As senhas salvas permanecem na instância Gauss Horizon atual.",
    ...
    syncRememberWebDavPasswordDescription: "A senha é criptografada e armazenada apenas na instância Gauss Horizon atual. Ela não é sincronizada para o WebDAV e não substitui a senha de sincronização.",
    syncRemotePath: "Caminho remoto do snapshot",
    syncRemotePathDescription: "O Gauss Horizon criará as pastas pai ausentes ao enviar.",
    syncSecretNotice: "Por padrão, o Gauss Horizon sincroniza apenas detalhes de conexão e configurações. Senhas de banco de dados, senhas SSH, senhas de proxy, strings de conexão e chaves de API de IA permanecem locais.",
    syncSecrets: "Sincronizar segredos criptografados",
    syncSecretsDescription: "Quando ativado, o Gauss Horizon criptografa senhas de banco de dados, senhas SSH e chaves de API de IA antes de enviá-las para o WebDAV.",
    syncSecretsPassphrase: "Senha de sincronização",
    syncSecretsPassphraseDescription: "Esta senha é usada apenas para criptografar e restaurar dados sensíveis. Ela é criptografada na instância Gauss Horizon atual; digite-a novamente em outras instâncias.",
    syncTest: "Testar",
    syncUpload: "Enviar",
    syncDownload: "Baixar",
    ...
    syncAutoUploadDescription: "Executa enquanto o Gauss Horizon está aberto. Downloads ainda exigem confirmação manual para evitar substituir SQL salvos localmente.",
    ...
    syncDownloadConfirm: "Baixar e aplicar o snapshot remoto do Gauss Horizon? Os metadados locais e os SQL salvos serão substituídos.",
    apply: "Aplicar",
    ...
    appCloseUnsavedTabsModeDescription: "Escolha o que acontece ao sair do Gauss Horizon com abas SQL contendo edições não salvas.",
    appCloseUnsavedTabsModePrompt: "Perguntar se deseja salvar",
    appCloseUnsavedTabsModeKeepDrafts: "Sair e manter rascunhos",
    appCloseUnsavedTabsModeHint: 'Os rascunhos são mantidos como abas não salvas e restaurados na próxima vez que você iniciar o Gauss Horizon. Requer que "Restaurar abas ao iniciar" não esteja definido como "Não manter abas".',
    appCloseDraftPersistFailed: "O Gauss Horizon não conseguiu salvar os rascunhos das abas abertas, então a saída foi cancelada. Verifique o espaço em disco e as permissões dos arquivos e tente novamente. Detalhes: {message}",
    ...
    sqlVariableSyntaxDescription: "Escolha quais sintaxes de variáveis e espaços reservados o Gauss Horizon substitui antes de executar SQL, por tipo de banco de dados. Todas ativadas por padrão.",
    ...
    jdbcPlugin: "Plugin JDBC do Gauss Horizon",
    ...
    mcpDescription: "Verifique a instalação e a versão do Servidor MCP do Gauss Horizon usado pelo Claude Code, Cursor e outros agentes.",
    ...
    mcpConfigOptionsHint:
      "O Gauss Horizon controla centralmente o acesso às conexões e as permissões de execução para todos os clientes MCP. A configuração gerada contém apenas os parâmetros de execução necessários para iniciar o servidor MCP e conectá-lo a esta instância do Gauss Horizon, sem variáveis de permissão ou escopo de conexão.",
    mcpScopeConnection: "Conexões permitidas para MCP",
    mcpScopeConnectionDescription: "O Gauss Horizon expõe ao MCP apenas as conexões selecionadas. As alterações se aplicam a todos os clientes MCP.",
    ...
    mcpExecutionModeReadOnlyDescription: "Permite apenas solicitações classificadas pelo Gauss Horizon como leitura; bloqueia gravações reconhecidas e alterações de conexão. As permissões da conta do banco continuam sendo o limite de segurança final.",
    ...
    mcpCapabilityDescription: "Estas são operações representativas; solicitações que o Gauss Horizon não consegue classificar com segurança exigem acesso completo.",
    ...
    mcpDetectionTiming: "O Gauss Horizon verifica automaticamente quando esta página é aberta; use Verificar novamente para atualizar.",
    mcpNpmBoundary: "O Gauss Horizon apenas verifica e explica o status do MCP; a instalação e as atualizações ainda são feitas pelo npm.",
    ...
    mcpDatabaseScopePermissionNote: "O escopo selecionado não altera as permissões de bancos que a conexão já tem no Gauss Horizon.",
    ...
    mcpHttpServiceDescription: "Desativado por padrão. Quando ativado, o Gauss Horizon Desktop hospeda o serviço; a configuração acima só é aplicada ao serviço de escuta real após salvar.",
    ...
    mcpHttpErrorPortInUse: "A porta já está em uso por outro aplicativo. O Gauss Horizon reinicia o próprio serviço MCP ao salvar; feche o outro aplicativo que usa a porta ou escolha outra porta.",
    ...
    mcpToolOpenTable: "Abrir tabela no Gauss Horizon",
    mcpToolExecuteAndShow: "Executar e mostrar no Gauss Horizon",
    ...
    supportInfoAppVersion: "Versão do Gauss Horizon",
    ...
    changelogOpenWebsite: "Ver repositório",
    ...
    syncSnippetMigrateLegacyConfirm: "O Gauss Horizon criará primeiro uma substituição criptografada e depois excluirá permanentemente o snippet legado em texto simples {id}. Esta ação não pode ser desfeita. Continuar?",
  ...
  driverStore: {
    ...
    jreDirRemoveFailedWindows:
      "Não foi possível remover o diretório JRE antigo: {path}\nCausas possíveis:\n  - um processo gauss-horizon Agent / java ainda está usando o diretório\n  - o antivírus está analisando o diretório\nFeche qualquer processo que possa estar usando o diretório, ou reinicie o gauss-horizon e tente novamente.\n(erro original: {error})",
    ...
    offlineExportDescription: "Selecione os drivers Agent gerenciados pelo Gauss Horizon que serão incluídos. O pacote é compatível apenas com a plataforma atual.",
    ...
    offlineExportNoDrivers: "Nenhum driver Agent gerenciado pelo Gauss Horizon elegível está instalado.",
    ...
    offlineExportSecurityHint: "Somente artefatos gerenciados pelo Gauss Horizon e as JRE necessárias são incluídos. Caminhos locais, configurações e drivers externos são excluídos.",
    ...
    offlineExportUnavailable_unmanagedInstall: "O artefato não está registrado como uma instalação gerenciada pelo Gauss Horizon.",
    ...
    offlineExportUnavailable_missingManagedJre: "A JRE gerenciada pelo Gauss Horizon necessária não está instalada.",
    offlineExportUnavailable_invalidManagedJre: "A JRE gerenciada pelo Gauss Horizon necessária é inválida ou insegura.",
    refresh: "Atualizar",
    javaRuntime: "Runtime do Java",
    javaRuntimeManaged: "JRE gerenciada pelo Gauss Horizon",
    ...
    localInstallHint: "Para ambientes sem acesso à internet: em outro computador com internet, baixe o gauss-horizon-jdbc-plugin-*.zip oficial na página de Releases do Gauss Horizon no GitHub, transfira-o para esta máquina e selecione-o — nenhum acesso à rede é necessário aqui.",
    runtimeDrivers: "Runtime",
    pluginsTab: "Plugins",
    pluginContributionsTitle: "Contribuições de frontend de plugins",
    pluginContributionsDescription: "Plugins instalados podem descrever formulários de conexão e outras contribuições de UI sem injetar código na janela principal do Gauss Horizon.",
    noInstalledPlugins: "Nenhum plugin instalado",
  ...
  nacos: {
    ...
    namespaceIdPlaceholder: "Deixe vazio para o Gauss Horizon gerar um UUID",
    ...
    nacosDetectAccessibleNamespacesHint: "O Gauss Horizon verifica a leitura de configurações e serviços antes de oferecer namespaces para {name}.",
    ...
    nacosV3ConsoleManagedNamespacesHint: "Esta conexao usa a API Console do Nacos 3 (normalmente a porta 8080). Informe um nome ou ID de namespace; o Gauss Horizon converte o nome no ID real quando consegue ler o diretorio.",
    ...
    persistentInstanceHint: "O Gauss Horizon não registra instâncias efêmeras porque não consegue manter seus heartbeats.",
  ...
  databaseBackup: {
    ...
    runtimeRequirement: "O Gauss Horizon executará backups agendados quando estiver aberto, inclusive quando minimizado na bandeja.",
    ...
    fileNamePatternHint: "Use {'{'}schedule{'}'}, {'{'}date{'}'}, {'{'}timestamp{'}'}, {'{'}database{'}'} e {'{'}runId{'}'}. O Gauss Horizon acrescenta o valor {'{'}database{'}'} ausente e adiciona a extensão automaticamente.",
  ...
  mqExchanges: {
    ...
    namePlaceholder: "ex.: gauss-horizon-events",
    cancel: "Cancelar",
    create: "Criar",
    bind: "Vincular",
    bindDialogTitle: "Vincular a {name}",
    queueNamePlaceholder: "ex.: gauss-horizon-queue",
    exchangeNamePlaceholder: "ex.: gauss-horizon-events",
