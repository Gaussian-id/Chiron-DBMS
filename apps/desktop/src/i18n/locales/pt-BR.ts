...
export default withEnglishFallback({
  ...
  pluginPlatform: {
    ...
    localInstallDescription: "Instale um .chiron-horizonp assinado obtido fora do marketplace. O Chiron Horizon verifica automaticamente a integridade e a assinatura do repositório.",
  ...
  updates: {
    ...
    portableAutomaticUpdate: "O Chiron Horizon baixará o ZIP portátil assinado, substituirá apenas o Chiron Horizon.exe após sair e reiniciará automaticamente. O portable.chiron-horizon e os dados serão mantidos.",
  ...
  ai: {
    ...
    cliErrors: {
      ...
      chironHorizonMcpMissing: "Uma instalação compatível do Chiron Horizon MCP Server não foi encontrada. Verifique Configurações > MCP e reinstale ou atualize.",
  ...
  driverStore: {
    ...
    jreDirRemoveFailedWindows:
      "Não foi possível remover o diretório JRE antigo: {path}\nCausas possíveis:\n  - um processo chiron-horizon Agent / java ainda está usando o diretório\n  - o antivírus está analisando o diretório\nFeche qualquer processo que possa estar usando o diretório, ou reinicie o chiron-horizon e tente novamente.\n(erro original: {error})",
