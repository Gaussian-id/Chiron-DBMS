...
export default withEnglishFallback({
  ...
  pluginPlatform: {
    ...
    centerDescription: "Descubra recursos opcionais do Chiron Horizon em um marketplace unificado e gerencie separadamente plugins instalados e repositórios.",
    ...
    marketplaceGuideDescription: "Para problemas ou sugestões sobre um plugin, abra uma issue no repositório do próprio plugin (use o link do repositório de origem no cartão); o repositório principal do Chiron Horizon trata apenas de problemas do próprio aplicativo.",
    ...
    localInstallDescription: "Instale um .chiron-horizonp assinado obtido fora do marketplace a partir de um arquivo local ou URL. O Chiron Horizon verifica automaticamente a integridade e a assinatura.",
    repositoriesTitle: "Repositórios de plugins",
    repositoriesDescription: "A fonte oficial é gerenciada pelo Chiron Horizon. Repositórios próprios ou de terceiros usam as configurações de confiança do repositório.",
    ...
    pluginDevelopmentDocsDescription: "Saiba como desenvolver, empacotar e publicar plugins do Chiron Horizon no marketplace.",
    ...
    allowUnsignedDevelopmentPackageDescription: "Afeta apenas a instalação manual de .chiron-horizonp e nunca reduz a verificação do marketplace oficial.",
    ...
    dropInstallHint: "Você também pode soltar um arquivo .chiron-horizonp nesta página",
    packageFileType: "Pacote de plugin do Chiron Horizon",
    ...
    noInstalledPluginsDescription: "Instale um .chiron-horizonp assinado ou permita explicitamente pacotes não assinados para desenvolvimento local.",
  ...
  externalSqlFile: {
    modifiedTitle: "Arquivo alterado fora do Chiron Horizon",
    ...
    deletedDescription: "{path} foi excluído ou movido fora do Chiron Horizon. O conteúdo do editor continua disponível.",
  ...
  updates: {
    ...
    availableMessage: "Chiron Horizon {latest} está disponível. Você está usando {current}.",
    upToDate: "O Chiron Horizon está atualizado ({version}).",
    ...
    downloadStarted: "Baixando o Chiron Horizon {version} em segundo plano.",
    activeTasksBlockUpdate: "Há {count} tarefa(s) em execução. Aguarde a conclusão antes de atualizar o Chiron Horizon.",
    portableAutomaticUpdate: "O Chiron Horizon baixará o ZIP portátil assinado, substituirá apenas o Chiron Horizon.exe após sair e reiniciará automaticamente. O portable.chiron_horizon e os dados serão mantidos.",
    ...
    readyToInstall: "Chiron Horizon {version} está pronto para instalar.",
    installNow: "Instalar agora",
    installedReadyToRestart: "O Chiron Horizon foi atualizado. Reinicie para concluir.",
  ...
  sidebar: {
    ...
    importChironHorizon: "Importar Configuração Chiron Horizon",
  ...
  sqlLibrary: {
    ...
    storageHelp: "O conteúdo da Biblioteca SQL é salvo nos dados do aplicativo Chiron Horizon, não como arquivos .sql independentes no disco.\nPara usá-lo no sistema de arquivos, exporte a Biblioteca SQL.",
  ...
  connection: {
    ...
    rememberPasswordSaveFailed: "Conectado, mas o Chiron Horizon não conseguiu lembrar a senha: {message}",
    ...
    oracleTnsPathHint: "O caminho é lido pelo backend do Chiron Horizon/Oracle Agent. No desktop é local; no Web e Docker pertence ao servidor.",
    ...
    nacosWebConsoleUrlHint: "Opcional. Abre o console Nacos no navegador. O Nacos 3 requer seu endereço de console web separado; o navegador precisa de acesso direto e não reutiliza túneis ou autenticação de API do Chiron Horizon.",
    ...
    gaussdbConnectionModeNativeHint: "Usa o protocolo compatível com PostgreSQL integrado ao Chiron Horizon para os modos A/PG/Oracle do GaussDB.",
    ...
    agentJavaTooOld: "Este driver requer Java 21. Use o JRE 21 gerenciado pelo Chiron Horizon ou selecione um executável Java 21 no Gerenciador de Drivers.",
    ...
    jdbcPluginHint: "Instale primeiro o plugin JDBC do Chiron Horizon e depois importe o JAR do driver JDBC do fornecedor do banco de dados.",
    ...
    kafkaKerberosKeytabPlaceholder: "Caminho na máquina do Chiron Horizon Agent, por exemplo /etc/security/keytabs/user.keytab",
    kafkaKerberosKrb5ConfPlaceholder: "Opcional, caminho na máquina do Chiron Horizon Agent, por exemplo /etc/krb5.conf",
    kafkaKerberosPathHint: "Os caminhos do keytab e do krb5.conf são lidos pelo Chiron Horizon Agent e devem existir na máquina onde o Chiron Horizon Agent é executado; os arquivos não são enviados do navegador atual.",
    ...
    sqliteWorkerPlacementSessionHint: "O Chiron Horizon envia o worker via SSH para o host de arquivos e exclui o arquivo remoto ao desconectar. Adequado para uso temporário.",
    sqliteWorkerPlacementPersistHint: "O Chiron Horizon envia o worker via SSH para o host de arquivos e o mantém lá após a desconexão. Ele não é excluído automaticamente.",
    sqliteWorkerPlacementPreplacedHint: "Faça você mesmo o upload do worker para o host de arquivos e informe o caminho absoluto do arquivo. O Chiron Horizon não fará upload nem excluirá automaticamente, mas verificará se o arquivo corresponde a esta versão do Desktop.",
    ...
    sshWorkerUploadConsentMessage: "O Chiron Horizon precisa copiar um worker do SQLite de curta duração para {host}:{port}. Esta é uma ação privilegiada. Revise o caminho de destino e o digest antes de permitir o envio.",
  ...
  editor: {
    ...
    unsavedChangesBatchCloseMultipleMessage: '{count} abas SQL que você está fechando têm alterações não salvas. O Chiron Horizon está mostrando "{title}" no momento. Salvar antes de continuar?',
    unsavedChangesAppCloseMessage: '"{title}" tem alterações SQL não salvas que serão perdidas se você sair do Chiron Horizon. Salvar antes de sair?',
    unsavedChangesAppCloseMultipleMessage: '{count} abas SQL têm alterações não salvas. O Chiron Horizon está mostrando "{title}" no momento. Serão perdidas se você sair do Chiron Horizon. Salvar antes de sair?',
  ...
  tabs: {
    ...
    externalFileMissing: "Excluído ou movido fora do Chiron Horizon",
  ...
  grid: {
    ...
    esDeepPageJumpConfirmMessage:
      "O search_after do Elasticsearch não pode ir diretamente para uma página. O Chiron Horizon precisa buscar os cursores ausentes em ordem e, ao voltar, reinicia pela página 1. Ir para a página {page} deve enviar cerca de {requests} consultas. Isso pode demorar e aumentar a carga do cluster. Continuar?",
    ...
    conditionalBulkEditConfirmMessage: "Esta operação atualiza imediatamente todas as linhas correspondentes no momento da execução, incluindo linhas não carregadas. O Chiron Horizon não pode gerar uma reversão confiável.",
    ...
    queryEditUnsupported: {
      ...
      "complex-source": "O Chiron Horizon não conseguiu identificar exatamente uma tabela de destino segura para gravar este resultado.",
      ...
      "metadata-unavailable": "O Chiron Horizon não conseguiu carregar os metadados da tabela, portanto a edição do resultado está desabilitada.",
    },
  ...
  configExport: {
    ...
    cryptoUnavailable: "A importação criptografada não está disponível neste contexto do navegador. Use HTTPS, localhost ou Chiron Horizon Desktop.",
  ...
  ai: {
    ...
    codexMcpRequiredTitle: "Chiron Horizon MCP Server obrigatório",
    codexMcpRequiredDescription: "O Codex CLI usa o Chiron Horizon MCP Server para acessar o schema do banco e as ferramentas de consulta. Instale-o antes de usar o Codex no assistente de AI.",
    ...
    codexCliEnvReservedName: "{name} é gerenciada pelo Chiron Horizon para o MCP Server e não pode ser definida aqui.",
    ...
    cliErrors: {
      ...
      claudeCodeEnvReserved: "Uma variável MCP gerenciada pelo Chiron Horizon foi sobrescrita. Remova as variáveis CHIRON_HORIZON_MCP_* da configuração do provedor.",
      ...
      claudeCodeMcpConfigInvalid: "O Claude Code não conseguiu ler ou analisar a configuração MCP do Chiron Horizon. Verifique a versão e o caminho do executável do Claude Code CLI.",
      chiron_horizonMcpMissing: "Uma instalação compatível do Chiron Horizon MCP Server não foi encontrada. Verifique Configurações > MCP e reinstale ou atualize.",
      claudeCodeMcpStartupFailed: "O Claude Code carregou a configuração MCP, mas não conseguiu iniciar o Chiron Horizon MCP Server. Verifique Configurações > MCP e os detalhes abaixo.",
      claudeCodeCommandLineTooLong: "O Windows rejeitou o comando do Claude Code porque era muito longo. Atualize o Chiron Horizon e tente novamente com o arquivo MCP gerado.",
      ...
      piAgentEnvReserved: "Uma variável Pi ou MCP gerenciada pelo Chiron Horizon foi sobrescrita. Remova CHIRON_HORIZON_PI_* e CHIRON_HORIZON_MCP_* da configuração.",
      ...
      piAgentMcpStartupFailed: "O Pi não conseguiu iniciar a ponte MCP do Chiron Horizon. Verifique Configurações > MCP e os detalhes abaixo.",
      ...
      openCodeEnvReserved: "Uma variável gerenciada pelo OpenCode ou Chiron Horizon foi sobrescrita. Remova as variáveis de controle OPENCODE e CHIRON_HORIZON_MCP_* da configuração.",
      ...
      openCodeMcpStartupFailed: "O OpenCode não conseguiu iniciar o servidor Chiron Horizon MCP com escopo restrito. Verifique Configurações > MCP e os detalhes abaixo.",
      ...
      cursorEnvReserved: "Uma variável gerenciada pelo Cursor ou Chiron Horizon foi sobrescrita. Remova CURSOR_CONFIG_DIR, CURSOR_DATA_DIR e CHIRON_HORIZON_MCP_* da configuração.",
      cursorNotAuthenticated: "O Cursor CLI não está autenticado. Execute `agent login` no terminal e tente novamente.",
      cursorMcpStartupFailed: "O Cursor não conseguiu iniciar o servidor Chiron Horizon MCP com escopo restrito. Verifique Configurações > MCP e os detalhes abaixo.",
      ...
      grokCliEnvReserved: "Uma variável MCP gerenciada pelo Chiron Horizon foi sobrescrita. Remova as variáveis CHIRON_HORIZON_MCP_* da configuração do provedor.",
      grokCliNotAuthenticated: "Grok CLI não está autenticado. Execute `grok login` em um terminal e tente novamente.",
      grokCliMcpStartupFailed: "O Grok carregou a configuração MCP, mas não conseguiu iniciar o Chiron Horizon MCP Server. Verifique Configurações > MCP e os detalhes abaixo.",
      grokCliCommandLineTooLong: "O Windows rejeitou o comando do Grok CLI porque era muito longo. Atualize o Chiron Horizon e tente novamente com o arquivo de prompt gerado.",
      ...
      codeBuddyEnvReserved: "Uma variável MCP gerenciada pelo Chiron Horizon foi sobrescrita. Remova as variáveis CHIRON_HORIZON_MCP_* da configuração do provedor.",
      ...
      codeBuddyMcpConfigInvalid: "O CodeBuddy Code não conseguiu ler a configuração temporária do Chiron Horizon MCP. Verifique os detalhes abaixo.",
      codeBuddyMcpStartupFailed: "O CodeBuddy Code carregou a configuração MCP, mas não conseguiu iniciar o Chiron Horizon MCP Server. Verifique Configurações > MCP e os detalhes abaixo.",
      ...
      qoderEnvReserved: "Uma variável de ambiente MCP gerenciada pelo Chiron Horizon foi sobrescrita. Remova as variáveis CHIRON_HORIZON_MCP_* da configuração do provedor.",
      ...
      qoderMcpConfigInvalid: "O Qoder CLI não conseguiu ler a configuração MCP temporária do Chiron Horizon. Verifique a versão do Qoder CLI e os detalhes abaixo.",
      qoderMcpStartupFailed: "O Qoder CLI carregou a configuração MCP, mas não conseguiu iniciar o Chiron Horizon MCP Server. Verifique Configurações > MCP e os detalhes abaixo.",
    ...
    closeWithRunsDescription: "Sair do Chiron Horizon interromperá {count} tarefa(s) de AI em execução ou na fila. Você também pode fechar esta caixa de diálogo e deixá-las terminar.",
    ...
    productionWriteBlocked: "A IA não pode executar alterações de dados ou esquema em um banco de dados de produção. Revise este SQL e execute-o manualmente no Chiron Horizon.",
    ...
    htmlCopyRiskBody: "Este HTML foi gerado por IA. Abri-lo fora do Chiron Horizon pode executar scripts e acessar a rede.",
    htmlCopyRiskAccept: "Copiar mesmo assim",
    htmlCopyRiskRemember: "Não perguntar novamente nesta sessão",
    htmlCopyRiskToast: "Copiado. Este HTML gerado por IA pode executar scripts ou acessar a rede quando aberto fora do Chiron Horizon.",
    ...
    customHeadersReserved: "Este cabeçalho é gerenciado pelo Chiron Horizon: {name}",
  ...
  contextMenu: {
    ...
    parameterDefaultHint: "Quando DEFAULT está marcado, o Chiron Horizon omite esse argumento para que o banco de dados use o padrão do procedimento.",
  ...
  etcd: {
    ...
    dashboard: {
      ...
      metricsUnavailableHint: "O estado do cluster continua disponível. O Chiron Horizon solicita /metrics diretamente ao endpoint etcd atual; confirme se a URL resultante pode ser acessada pelo aplicativo Chiron Horizon.",
  ...
  sqlParameters: {
    ...
    description: "Preencha valores para marcadores de template SQL. O Chiron Horizon substitui antes de executar o SQL.",
    name: "Parâmetro",
    syntax: "Sintaxe",
    type: "Tipo",
    value: "Valor",
  ...
  settings: {
    ...
    uiFontAppDefault: "Padrão do Chiron Horizon",
    ...
    iconThemeDefaultDescription: "Usar o ícone colorido do app Chiron Horizon.",
    iconThemeBlack: "Preto",
    iconThemeBlackDescription: "Use o logo preto da Chiron Horizon no app.",
    ...
    showTrayIconDescription: "Quando desativado, nenhum ícone é exibido, mas fechar a janela ainda oculta o Chiron Horizon em segundo plano como antes.",
    quitOnClose: "Sair ao fechar a janela",
    quitOnCloseDescription: "Quando ativado, o botão de fechar encerra o Chiron Horizon completamente em vez de minimizar para a bandeja.",
    ...
    closeActionQuit: "Sair do Chiron Horizon",
    ...
    duckDbWorkerProcessIsolationDescription: "Executa consultas DuckDB em um processo worker separado. Se uma consulta longa não responder ao cancelamento, o Chiron Horizon pode encerrar o processo worker para liberar o bloqueio do arquivo de banco de dados.",
    duckDbWorkerMaxProcesses: "Máximo de workers simultâneos do DuckDB",
    duckDbWorkerMaxProcessesDescription: "Limita quantos processos worker do DuckDB o Chiron Horizon pode executar ao mesmo tempo. Intervalo: 1-16. Padrão: 4.",
    duckDbWorkerProcessIsolationRestartRequired: "Reinicie o Chiron Horizon para que esta alteração entre em vigor.",
    restartChironHorizon: "Reiniciar Chiron Horizon",
    restartChironHorizonFailed: "Falha ao reiniciar o Chiron Horizon: {error}",
    ...
    openTabsRestoreModeDescription: "Escolha como o Chiron Horizon restaura as abas que estavam abertas na última vez.",
    ...
    syncWebDavDescription: "Envie ou restaure um snapshot do Chiron Horizon, incluindo a biblioteca SQL salva, a partir de um serviço de armazenamento compatível com WebDAV.",
    syncWebDavWebDescription: "No modo Web, o servidor Chiron Horizon acessa o WebDAV sem as restrições de CORS do navegador. As senhas salvas permanecem na instância Chiron Horizon atual.",
    ...
    syncRememberWebDavPasswordDescription: "A senha é criptografada e armazenada apenas na instância Chiron Horizon atual. Ela não é sincronizada para o WebDAV e não substitui a senha de sincronização.",
    syncRemotePath: "Caminho remoto do snapshot",
    syncRemotePathDescription: "O Chiron Horizon criará as pastas pai ausentes ao enviar.",
    syncSecretNotice: "Por padrão, o Chiron Horizon sincroniza apenas detalhes de conexão e configurações. Senhas de banco de dados, senhas SSH, senhas de proxy, strings de conexão e chaves de API de IA permanecem locais.",
    syncSecrets: "Sincronizar segredos criptografados",
    syncSecretsDescription: "Quando ativado, o Chiron Horizon criptografa senhas de banco de dados, senhas SSH e chaves de API de IA antes de enviá-las para o WebDAV.",
    syncSecretsPassphrase: "Senha de sincronização",
    syncSecretsPassphraseDescription: "Esta senha é usada apenas para criptografar e restaurar dados sensíveis. Ela é criptografada na instância Chiron Horizon atual; digite-a novamente em outras instâncias.",
    syncTest: "Testar",
    syncUpload: "Enviar",
    syncDownload: "Baixar",
    ...
    syncAutoUploadDescription: "Executa enquanto o Chiron Horizon está aberto. Downloads ainda exigem confirmação manual para evitar substituir SQL salvos localmente.",
    ...
    syncDownloadConfirm: "Baixar e aplicar o snapshot remoto do Chiron Horizon? Os metadados locais e os SQL salvos serão substituídos.",
    apply: "Aplicar",
    ...
    appCloseUnsavedTabsModeDescription: "Escolha o que acontece ao sair do Chiron Horizon com abas SQL contendo edições não salvas.",
    appCloseUnsavedTabsModePrompt: "Perguntar se deseja salvar",
    appCloseUnsavedTabsModeKeepDrafts: "Sair e manter rascunhos",
    appCloseUnsavedTabsModeHint: 'Os rascunhos são mantidos como abas não salvas e restaurados na próxima vez que você iniciar o Chiron Horizon. Requer que "Restaurar abas ao iniciar" não esteja definido como "Não manter abas".',
    appCloseDraftPersistFailed: "O Chiron Horizon não conseguiu salvar os rascunhos das abas abertas, então a saída foi cancelada. Verifique o espaço em disco e as permissões dos arquivos e tente novamente. Detalhes: {message}",
    ...
    sqlVariableSyntaxDescription: "Escolha quais sintaxes de variáveis e espaços reservados o Chiron Horizon substitui antes de executar SQL, por tipo de banco de dados. Todas ativadas por padrão.",
    ...
    jdbcPlugin: "Plugin JDBC do Chiron Horizon",
    ...
    mcpDescription: "Verifique a instalação e a versão do Servidor MCP do Chiron Horizon usado pelo Claude Code, Cursor e outros agentes.",
    ...
    mcpConfigOptionsHint:
      "O Chiron Horizon controla centralmente o acesso às conexões e as permissões de execução para todos os clientes MCP. A configuração gerada contém apenas os parâmetros de execução necessários para iniciar o servidor MCP e conectá-lo a esta instância do Chiron Horizon, sem variáveis de permissão ou escopo de conexão.",
    mcpScopeConnection: "Conexões permitidas para MCP",
    mcpScopeConnectionDescription: "O Chiron Horizon expõe ao MCP apenas as conexões selecionadas. As alterações se aplicam a todos os clientes MCP.",
    ...
    mcpExecutionModeReadOnlyDescription: "Permite apenas solicitações classificadas pelo Chiron Horizon como leitura; bloqueia gravações reconhecidas e alterações de conexão. As permissões da conta do banco continuam sendo o limite de segurança final.",
    ...
    mcpCapabilityDescription: "Estas são operações representativas; solicitações que o Chiron Horizon não consegue classificar com segurança exigem acesso completo.",
    ...
    mcpDetectionTiming: "O Chiron Horizon verifica automaticamente quando esta página é aberta; use Verificar novamente para atualizar.",
    mcpNpmBoundary: "O Chiron Horizon apenas verifica e explica o status do MCP; a instalação e as atualizações ainda são feitas pelo npm.",
    ...
    mcpDatabaseScopePermissionNote: "O escopo selecionado não altera as permissões de bancos que a conexão já tem no Chiron Horizon.",
    ...
    mcpHttpServiceDescription: "Desativado por padrão. Quando ativado, o Chiron Horizon Desktop hospeda o serviço; a configuração acima só é aplicada ao serviço de escuta real após salvar.",
    ...
    mcpHttpErrorPortInUse: "A porta já está em uso por outro aplicativo. O Chiron Horizon reinicia o próprio serviço MCP ao salvar; feche o outro aplicativo que usa a porta ou escolha outra porta.",
    ...
    mcpToolOpenTable: "Abrir tabela no Chiron Horizon",
    mcpToolExecuteAndShow: "Executar e mostrar no Chiron Horizon",
    ...
    supportInfoAppVersion: "Versão do Chiron Horizon",
    ...
    syncSnippetMigrateLegacyConfirm: "O Chiron Horizon criará primeiro uma substituição criptografada e depois excluirá permanentemente o snippet legado em texto simples {id}. Esta ação não pode ser desfeita. Continuar?",
  ...
  driverStore: {
    ...
    jreDirRemoveFailedWindows:
      "Não foi possível remover o diretório JRE antigo: {path}\nCausas possíveis:\n  - um processo chiron_horizon Agent / java ainda está usando o diretório\n  - o antivírus está analisando o diretório\nFeche qualquer processo que possa estar usando o diretório, ou reinicie o chiron_horizon e tente novamente.\n(erro original: {error})",
    ...
    offlineExportDescription: "Selecione os drivers Agent gerenciados pelo Chiron Horizon que serão incluídos. O pacote é compatível apenas com a plataforma atual.",
    ...
    offlineExportNoDrivers: "Nenhum driver Agent gerenciado pelo Chiron Horizon elegível está instalado.",
    ...
    offlineExportSecurityHint: "Somente artefatos gerenciados pelo Chiron Horizon e as JRE necessárias são incluídos. Caminhos locais, configurações e drivers externos são excluídos.",
    ...
    offlineExportUnavailable_unmanagedInstall: "O artefato não está registrado como uma instalação gerenciada pelo Chiron Horizon.",
    ...
    offlineExportUnavailable_missingManagedJre: "A JRE gerenciada pelo Chiron Horizon necessária não está instalada.",
    offlineExportUnavailable_invalidManagedJre: "A JRE gerenciada pelo Chiron Horizon necessária é inválida ou insegura.",
    refresh: "Atualizar",
    javaRuntime: "Runtime do Java",
    javaRuntimeManaged: "JRE gerenciada pelo Chiron Horizon",
    ...
    localInstallHint: "Para ambientes sem acesso à internet: em outro computador com internet, baixe o chiron-horizon-jdbc-plugin-*.zip oficial na página de Releases do Chiron Horizon no GitHub, transfira-o para esta máquina e selecione-o — nenhum acesso à rede é necessário aqui.",
    runtimeDrivers: "Runtime",
    pluginsTab: "Plugins",
    pluginContributionsTitle: "Contribuições de frontend de plugins",
    pluginContributionsDescription: "Plugins instalados podem descrever formulários de conexão e outras contribuições de UI sem injetar código na janela principal do Chiron Horizon.",
    noInstalledPlugins: "Nenhum plugin instalado",
  ...
  nacos: {
    ...
    namespaceIdPlaceholder: "Deixe vazio para o Chiron Horizon gerar um UUID",
    ...
    nacosDetectAccessibleNamespacesHint: "O Chiron Horizon verifica a leitura de configurações e serviços antes de oferecer namespaces para {name}.",
    ...
    nacosV3ConsoleManagedNamespacesHint: "Esta conexao usa a API Console do Nacos 3 (normalmente a porta 8080). Informe um nome ou ID de namespace; o Chiron Horizon converte o nome no ID real quando consegue ler o diretorio.",
    ...
    persistentInstanceHint: "O Chiron Horizon não registra instâncias efêmeras porque não consegue manter seus heartbeats.",
  ...
  databaseBackup: {
    ...
    runtimeRequirement: "O Chiron Horizon executará backups agendados quando estiver aberto, inclusive quando minimizado na bandeja.",
    ...
    fileNamePatternHint: "Use {'{'}schedule{'}'}, {'{'}date{'}'}, {'{'}timestamp{'}'}, {'{'}database{'}'} e {'{'}runId{'}'}. O Chiron Horizon acrescenta o valor {'{'}database{'}'} ausente e adiciona a extensão automaticamente.",
  ...
  mqExchanges: {
    ...
    namePlaceholder: "ex.: chiron-horizon-events",
    cancel: "Cancelar",
    create: "Criar",
    bind: "Vincular",
    bindDialogTitle: "Vincular a {name}",
    queueNamePlaceholder: "ex.: chiron-horizon-queue",
    exchangeNamePlaceholder: "ex.: chiron-horizon-events",
