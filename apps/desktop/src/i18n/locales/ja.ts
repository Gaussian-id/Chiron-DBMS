...
export default withEnglishFallback({
  ...
  pluginPlatform: {
    ...
    localInstallDescription: "マーケットプレイス外で入手した署名済み .chiron-horizonp をインストールします。Chiron Horizon が整合性とリポジトリ署名を自動検証します。",
  ...
  updates: {
    ...
    portableAutomaticUpdate: "Chiron Horizon は署名済みのポータブル ZIP をダウンロードし、終了後に Chiron Horizon.exe のみを置き換えて自動的に再起動します。portable.chiron-horizon とデータは保持されます。",
  ...
  ai: {
    ...
    cliErrors: {
      ...
      chironHorizonMcpMissing: "互換性のあるChiron Horizon MCP Serverが見つかりません。設定 > MCPで確認し、再インストールまたは更新してください。",
  ...
  driverStore: {
    ...
    jreDirRemoveFailedWindows:
      "古い JRE ディレクトリを削除できませんでした: {path}\n考えられる原因:\n  - chiron-horizon Agent / java プロセスがディレクトリを使用中です\n  - ウイルス対策ソフトがスキャン中です\nディレクトリを使用している可能性のあるプロセスを終了するか、chiron-horizon を再起動して再試行してください。\n（元のエラー: {error}）",
