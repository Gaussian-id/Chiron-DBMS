...
export default withEnglishFallback({
  ...
  pluginPlatform: {
    ...
    localInstallDescription: "Installa un .chiron-horizonp firmato ottenuto fuori dal marketplace. Chiron Horizon verifica automaticamente integrità e firma del repository.",
  ...
  updates: {
    ...
    portableAutomaticUpdate: "Chiron Horizon scaricherà lo ZIP portatile firmato, sostituirà solo Chiron Horizon.exe dopo l'uscita e si riavvierà automaticamente. portable.chiron-horizon e i dati verranno mantenuti.",
  ...
  ai: {
    ...
    cliErrors: {
      ...
      chironHorizonMcpMissing: "Non è stata trovata un'installazione compatibile di Chiron Horizon MCP Server. Controlla Impostazioni > MCP, quindi reinstalla o aggiorna.",
  ...
  driverStore: {
    ...
    jreDirRemoveFailedWindows:
      "Impossibile rimuovere la vecchia directory JRE: {path}\nCause possibili:\n  - un processo chiron-horizon Agent / java sta ancora usando la directory\n  - l'antivirus la sta analizzando\nChiudi ogni processo che potrebbe usare la directory, oppure riavvia chiron-horizon e riprova.\n(errore originale: {error})",
