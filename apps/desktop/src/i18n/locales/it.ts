...
export default withEnglishFallback({
  ...
  pluginPlatform: {
    ...
    centerDescription: "Scopri funzionalità Gauss Horizon opzionali in un marketplace unico e gestisci separatamente plugin installati e repository.",
    ...
    localInstallDescription: "Installa un .gauss-horizonp firmato ottenuto fuori dal marketplace. Gauss Horizon verifica automaticamente integrità e firma del repository.",
    repositoriesTitle: "Repository dei plugin",
    repositoriesDescription: "La sorgente ufficiale è gestita da Gauss Horizon. I repository self-hosted o di terze parti usano le impostazioni di attendibilità del repository.",
    ...
    allowUnsignedDevelopmentPackageDescription: "Si applica solo all'installazione manuale di .gauss-horizonp e non riduce mai la verifica del marketplace ufficiale.",
    installPackage: "Installa .gauss-horizonp",
    dropToInstall: "Rilascia per installare il pacchetto del plugin",
    dropInstallHint: "Puoi anche rilasciare un file .gauss-horizonp su questa pagina",
    packageFileType: "Pacchetto plugin Gauss Horizon",
    ...
    noInstalledPluginsDescription: "Installa un .gauss-horizonp firmato oppure abilita esplicitamente i pacchetti non firmati per lo sviluppo locale.",
  ...
  externalSqlFile: {
    modifiedTitle: "File modificato esternamente a Gauss Horizon",
    ...
    deletedDescription: "{path} è stato eliminato o spostato fuori da Gauss Horizon. Il contenuto dell'editor è ancora disponibile.",
  ...
  updates: {
    ...
    availableMessage: "Gauss Horizon {latest} è disponibile. Stai usando la versione {current}.",
    upToDate: "Gauss Horizon è aggiornato ({version}).",
    ...
    downloadStarted: "Download di Gauss Horizon {version} in background in corso.",
    activeTasksBlockUpdate: "Ci sono {count} attività in esecuzione. Attendi che terminino prima di aggiornare Gauss Horizon.",
    portableAutomaticUpdate: "Gauss Horizon scaricherà lo ZIP portatile firmato, sostituirà solo Gauss Horizon.exe dopo l'uscita e si riavvierà automaticamente. portable.gauss-horizon e i dati verranno mantenuti.",
    ...
    readyToInstall: "Gauss Horizon {version} è pronto per l'installazione.",
    installNow: "Installa ora",
    installedReadyToRestart: "Gauss Horizon è stato aggiornato. Riavvia per completare.",
  ...
  sidebar: {
    ...
    importGaussHorizon: "Importa Configurazione Gauss Horizon",
  ...
  sqlLibrary: {
    title: "Libreria SQL",
    storageHelp: "Il contenuto della Libreria SQL viene salvato nei dati dell'app Gauss Horizon, non come file .sql autonomi sul disco.\nPer usarlo nel file system, esporta la Libreria SQL.",
  ...
  connection: {
    ...
    rememberPasswordSaveFailed: "Connessione riuscita, ma Gauss Horizon non ha potuto memorizzare la password: {message}",
    ...
    oracleTnsPathHint: "Il percorso viene letto dal backend Gauss Horizon/Oracle Agent. Sul desktop è locale; su Web e Docker appartiene al server.",
    ...
    nacosWebConsoleUrlHint: "Facoltativo. Apre la console Nacos nel browser. Nacos 3 richiede il proprio indirizzo della console Web separata; il browser deve avere accesso diretto e non riutilizza tunnel o autenticazione API di Gauss Horizon.",
    ...
    gaussdbConnectionModeNativeHint: "Usa il protocollo compatibile con PostgreSQL integrato in Gauss Horizon per le modalità A/PG/Oracle di GaussDB.",
    ...
    agentJavaTooOld: "Questo driver richiede Java 21. Usa il JRE 21 gestito da Gauss Horizon o seleziona un eseguibile Java 21 in Gestione Driver.",
    ...
    jdbcPluginHint: "Installa prima il plugin Gauss Horizon JDBC, quindi importa il file JAR del driver JDBC del fornitore del database.",
    ...
    kafkaKerberosKeytabPlaceholder: "Percorso sulla macchina Gauss Horizon Agent, ad esempio /etc/security/keytabs/user.keytab",
    kafkaKerberosKrb5ConfPlaceholder: "Opzionale, percorso sulla macchina Gauss Horizon Agent, ad esempio /etc/krb5.conf",
    kafkaKerberosPathHint: "I percorsi di keytab e krb5.conf vengono letti da Gauss Horizon Agent e devono esistere sulla macchina in cui è in esecuzione Gauss Horizon Agent; non vengono caricati file dal browser corrente.",
    ...
    sqliteWorkerPlacementSessionHint: "Gauss Horizon carica il worker via SSH sull'host dei file e poi elimina il file remoto alla disconnessione. Adatto all'uso temporaneo.",
    sqliteWorkerPlacementPersistHint: "Gauss Horizon carica il worker via SSH sull'host dei file e lo lascia lì dopo la disconnessione. Non viene eliminato automaticamente.",
    sqliteWorkerPlacementPreplacedHint: "Carica tu il worker sull'host dei file, poi inserisci il percorso assoluto del file. Gauss Horizon non lo caricherà né lo eliminerà automaticamente, ma verificherà che corrisponda a questa versione di Desktop.",
    ...
    sshWorkerUploadConsentMessage: "Gauss Horizon deve copiare un worker SQLite di breve durata su {host}:{port}. Si tratta di un'azione privilegiata. Controlla il percorso di destinazione e il digest prima di consentire il caricamento.",
  ...
  editor: {
    ...
    unsavedChangesBatchCloseMultipleMessage: '{count} schede SQL che stai chiudendo hanno modifiche non salvate. Gauss Horizon mostra attualmente "{title}". Salvare prima di continuare?',
    unsavedChangesAppCloseMessage: '"{title}" ha modifiche SQL non salvate che andranno perse se esci da Gauss Horizon. Salvare prima di uscire?',
    unsavedChangesAppCloseMultipleMessage: '{count} schede SQL hanno modifiche non salvate. Gauss Horizon mostra attualmente "{title}". Andranno perse se esci da Gauss Horizon. Salvare prima di uscire?',
  ...
  tabs: {
    ...
    externalFileMissing: "Eliminato o spostato fuori da Gauss Horizon",
  ...
  grid: {
    ...
    esDeepPageJumpConfirmMessage:
      "search_after di Elasticsearch non può passare direttamente a una pagina. Gauss Horizon deve recuperare in ordine i cursori mancanti e, tornando indietro, riparte dalla pagina 1. Il passaggio alla pagina {page} invierà circa {requests} query. Potrebbe richiedere tempo e aumentare il carico del cluster. Continuare?",
    ...
    conditionalBulkEditConfirmMessage: "L'operazione aggiorna immediatamente tutte le righe corrispondenti al momento dell'esecuzione, incluse quelle non caricate. Gauss Horizon non può generare un rollback affidabile.",
  ...
  configExport: {
    ...
    cryptoUnavailable: "L'importazione cifrata non è disponibile in questo contesto del browser. Usa HTTPS, localhost o Gauss Horizon Desktop.",
  ...
  ai: {
    ...
    closeWithRunsDescription: "Uscire da Gauss Horizon interromperà {count} attività di AI in esecuzione o in coda. Puoi anche chiudere questa finestra e lasciarle terminare.",
    ...
    productionWriteBlocked: "L'AI non può eseguire modifiche a dati o schema su un database di produzione. Rivedi questo SQL ed eseguilo manualmente in Gauss Horizon.",
    ...
    htmlCopyRiskBody: "Questo HTML è stato generato dall'IA. Aprirlo fuori da Gauss Horizon può eseguire script e accedere alla rete.",
    htmlCopyRiskAccept: "Copia comunque",
    htmlCopyRiskRemember: "Non chiedere più in questa sessione",
    htmlCopyRiskToast: "Copiato. Questo HTML generato dall'IA può eseguire script o accedere alla rete se aperto fuori da Gauss Horizon.",
    ...
    customHeadersReserved: "Questa intestazione è gestita da Gauss Horizon: {name}",
    ...
    codexCliEnvReservedName: "{name} è gestita da Gauss Horizon per MCP Server e non può essere impostata qui.",
    ...
    codexMcpRequiredTitle: "Gauss Horizon MCP Server richiesto",
    codexMcpRequiredDescription: "Codex CLI usa il Gauss Horizon MCP Server per accedere allo schema del database e agli strumenti di query. Installalo prima di usare Codex nell'assistente AI.",
    ...
    cliErrors: {
      ...
      claudeCodeEnvReserved: "È stata sovrascritta una variabile MCP gestita da Gauss Horizon. Rimuovi le variabili GAUSS_HORIZON_MCP_* dalla configurazione del provider.",
      claudeCodeNotAuthenticated: "Claude Code CLI non è autenticato. Esegui `claude auth login` in un terminale e riprova.",
      claudeCodeMcpConfigInvalid: "Claude Code non ha potuto leggere o analizzare la configurazione MCP di Gauss Horizon. Controlla la versione e il percorso di Claude Code CLI.",
      gaussHorizonMcpMissing: "Non è stata trovata un'installazione compatibile di Gauss Horizon MCP Server. Controlla Impostazioni > MCP, quindi reinstalla o aggiorna.",
      claudeCodeMcpStartupFailed: "Claude Code ha caricato la configurazione MCP ma non ha potuto avviare Gauss Horizon MCP Server. Controlla Impostazioni > MCP e i dettagli seguenti.",
      claudeCodeCommandLineTooLong: "Windows ha rifiutato il comando Claude Code perché troppo lungo. Aggiorna Gauss Horizon e riprova usando il file MCP generato.",
      ...
      piAgentEnvReserved: "È stata sovrascritta una variabile Pi o MCP gestita da Gauss Horizon. Rimuovi GAUSS_HORIZON_PI_* e GAUSS_HORIZON_MCP_* dalla configurazione.",
      ...
      piAgentMcpStartupFailed: "Pi non ha potuto avviare il bridge MCP Gauss Horizon. Controlla Impostazioni > MCP e i dettagli seguenti.",
      ...
      openCodeEnvReserved: "È stata sovrascritta una variabile gestita da OpenCode o Gauss Horizon. Rimuovi le variabili di controllo OPENCODE e GAUSS_HORIZON_MCP_* dalla configurazione.",
      ...
      openCodeMcpStartupFailed: "OpenCode non ha potuto avviare il server Gauss Horizon MCP con ambito limitato. Controlla Impostazioni > MCP e i dettagli seguenti.",
      ...
      cursorEnvReserved: "È stata sovrascritta una variabile gestita da Cursor o Gauss Horizon. Rimuovi CURSOR_CONFIG_DIR, CURSOR_DATA_DIR e GAUSS_HORIZON_MCP_* dalla configurazione.",
      cursorNotAuthenticated: "Cursor CLI non è autenticato. Esegui `agent login` nel terminale e riprova.",
      cursorMcpStartupFailed: "Cursor non ha potuto avviare il server Gauss Horizon MCP con ambito limitato. Controlla Impostazioni > MCP e i dettagli seguenti.",
      ...
      grokCliEnvReserved: "È stata sovrascritta una variabile MCP gestita da Gauss Horizon. Rimuovi le variabili GAUSS_HORIZON_MCP_* dalla configurazione del provider.",
      grokCliNotAuthenticated: "Grok CLI non è autenticato. Esegui `grok login` in un terminale e riprova.",
      grokCliMcpStartupFailed: "Grok ha caricato la configurazione MCP ma non ha potuto avviare Gauss Horizon MCP Server. Controlla Impostazioni > MCP e i dettagli seguenti.",
      grokCliCommandLineTooLong: "Windows ha rifiutato il comando Grok CLI perché troppo lungo. Aggiorna Gauss Horizon e riprova usando il file di prompt generato.",
      ...
      codeBuddyEnvReserved: "È stata sovrascritta una variabile MCP gestita da Gauss Horizon. Rimuovi le variabili GAUSS_HORIZON_MCP_* dalla configurazione del provider.",
      ...
      codeBuddyMcpConfigInvalid: "CodeBuddy Code non ha potuto leggere la configurazione temporanea di Gauss Horizon MCP. Controlla i dettagli seguenti.",
      codeBuddyMcpStartupFailed: "CodeBuddy Code ha caricato la configurazione MCP ma non ha potuto avviare Gauss Horizon MCP Server. Controlla Impostazioni > MCP e i dettagli seguenti.",
      ...
      qoderEnvReserved: "È stata sovrascritta una variabile di ambiente MCP gestita da Gauss Horizon. Rimuovi le variabili GAUSS_HORIZON_MCP_* dalla configurazione del provider.",
      ...
      qoderMcpConfigInvalid: "Qoder CLI non ha potuto leggere la configurazione MCP temporanea di Gauss Horizon. Controlla la versione di Qoder CLI e i dettagli seguenti.",
      qoderMcpStartupFailed: "Qoder CLI ha caricato la configurazione MCP ma non ha potuto avviare Gauss Horizon MCP Server. Controlla Impostazioni > MCP e i dettagli seguenti.",
  ...
  contextMenu: {
    ...
    parameterDefaultHint: "Quando DEFAULT è selezionato, Gauss Horizon omette quell'argomento in modo che il database utilizzi il valore predefinito della procedura.",
  ...
  etcd: {
    ...
    dashboard: {
      ...
      metricsUnavailableHint: "Lo stato del cluster resta disponibile. Gauss Horizon richiede /metrics direttamente all'endpoint etcd corrente; verifica che l'URL risultante sia raggiungibile dall'applicazione Gauss Horizon.",
  ...
  sqlParameters: {
    title: "Parametri SQL",
    description: "Compila i valori per i segnaposto del template SQL. Gauss Horizon li sostituisce prima di eseguire l'SQL.",
    name: "Parametro",
    syntax: "Sintassi",
    type: "Tipo",
    value: "Valore",
  ...
  settings: {
    ...
    uiFontAppDefault: "Predefinito Gauss Horizon",
    ...
    iconThemeDefaultDescription: "Utilizza l'icona colorata dell'app Gauss Horizon.",
    iconThemeBlack: "Nero",
    iconThemeBlackDescription: "Usa il logo Gauss Horizon nero nell'app.",
    ...
    showTrayIconDescription: "Se disattivato, non viene mostrata alcuna icona, ma la chiusura della finestra nasconderà comunque Gauss Horizon in background.",
    quitOnClose: "Esci alla chiusura della finestra",
    quitOnCloseDescription: "Se attivato, il pulsante di chiusura termina completamente Gauss Horizon invece di nasconderlo nella barra delle applicazioni.",
    ...
    closeActionQuit: "Esci da Gauss Horizon",
    ...
    duckDbWorkerProcessIsolationDescription: "Esegue le query DuckDB in un processo worker separato. Se una query lunga non risponde all'annullamento, Gauss Horizon può arrestare il processo worker per rilasciare il blocco del file di database.",
    duckDbWorkerMaxProcesses: "Worker DuckDB simultanei massimi",
    duckDbWorkerMaxProcessesDescription: "Limita quanti processi worker DuckDB Gauss Horizon può eseguire contemporaneamente. Intervallo: 1-16. Predefinito: 4.",
    duckDbWorkerProcessIsolationRestartRequired: "Riavvia Gauss Horizon affinché questa modifica abbia effetto.",
    restartGaussHorizon: "Riavvia Gauss Horizon",
    restartGaussHorizonFailed: "Impossibile riavviare Gauss Horizon: {error}",
    ...
    openTabsRestoreModeDescription: "Scegli come Gauss Horizon ripristina le schede aperte l'ultima volta.",
    ...
    syncWebDavDescription: "Carica o ripristina uno snapshot di Gauss Horizon, inclusa la libreria SQL salvata, da un servizio di archiviazione compatibile con WebDAV.",
    syncWebDavWebDescription: "In modalità Web, il server Gauss Horizon accede a WebDAV senza le limitazioni CORS del browser. Le password salvate restano nell'istanza Gauss Horizon corrente.",
    ...
    syncRememberWebDavPasswordDescription: "La password viene crittografata e memorizzata solo nell'istanza Gauss Horizon corrente. Non viene sincronizzata su WebDAV e non sostituisce la password di sincronizzazione.",
    syncRemotePath: "Percorso snapshot remoto",
    syncRemotePathDescription: "Gauss Horizon creerà le cartelle superiori mancanti durante il caricamento.",
    syncSecretNotice: "Per impostazione predefinita, Gauss Horizon sincronizza solo i dettagli e le impostazioni di connessione. Le password dei database, le password SSH, le password proxy, le stringhe di connessione e le chiavi API AI rimangono locali.",
    syncSecrets: "Sincronizza i segreti crittografati",
    syncSecretsDescription: "Se abilitato, Gauss Horizon crittografa le password del database, le password SSH e le chiavi API AI prima di caricarle su WebDAV.",
    syncSecretsPassphrase: "Password di sincronizzazione",
    syncSecretsPassphraseDescription: "Questa password viene utilizzata solo per crittografare e ripristinare i dati sensibili. È crittografata nell'istanza Gauss Horizon corrente; inseriscila di nuovo nelle altre istanze.",
    syncTest: "Verifica",
    syncUpload: "Carica",
    ...
    syncAutoUploadDescription: "Viene eseguito mentre Gauss Horizon è aperto. I download richiedono ancora conferma manuale per evitare di sostituire SQL salvati localmente.",
    ...
    syncDownloadConfirm: "Scaricare e applicare lo snapshot Gauss Horizon remoto? I metadati locali e i file SQL salvati verranno sostituiti.",
    apply: "Applica",
    ...
    appCloseUnsavedTabsModeDescription: "Scegli cosa succede quando esci da Gauss Horizon con schede SQL che contengono modifiche non salvate.",
    appCloseUnsavedTabsModePrompt: "Chiedi se salvare",
    appCloseUnsavedTabsModeKeepDrafts: "Esci e conserva le bozze",
    appCloseUnsavedTabsModeHint: 'Le bozze vengono conservate come schede non salvate e ripristinate al prossimo avvio di Gauss Horizon. Richiede che "Ripristina schede all\'avvio" non sia impostato su "Non mantenere schede".',
    appCloseDraftPersistFailed: "Gauss Horizon non ha potuto salvare le bozze delle schede aperte, quindi l'uscita è stata annullata. Controlla lo spazio su disco e i permessi dei file, quindi riprova. Dettagli: {message}",
    ...
    sqlVariableSyntaxDescription: "Scegli quali sintassi di variabili e segnaposto Gauss Horizon sostituisce prima di eseguire SQL, per tipo di database. Tutte abilitate per impostazione predefinita.",
    ...
    jdbcPlugin: "Plugin Gauss Horizon JDBC",
    ...
    mcpTitle: "Server MCP",
    mcpDescription: "Verifica l'installazione e la versione del Server Gauss Horizon MCP utilizzata da Claude Code, Cursor e altri agenti.",
    ...
    mcpConfigOptionsHint:
      "Gauss Horizon controlla centralmente l'accesso alle connessioni e i permessi di esecuzione per tutti i client MCP. La configurazione generata contiene solo i parametri di runtime necessari per avviare il server MCP e collegarlo a questa istanza Gauss Horizon, senza variabili di autorizzazione o ambito connessione.",
    mcpScopeConnection: "Connessioni consentite per MCP",
    mcpScopeConnectionDescription: "Gauss Horizon espone a MCP solo le connessioni selezionate. Le modifiche si applicano a tutti i client MCP.",
    ...
    mcpExecutionModeReadOnlyDescription: "Consente solo le richieste che Gauss Horizon classifica come letture; blocca le scritture riconosciute e le modifiche alle connessioni. I permessi dell'account del database restano il limite di sicurezza finale.",
    ...
    mcpCapabilityDescription: "Queste sono operazioni rappresentative; le richieste che Gauss Horizon non può classificare in modo affidabile richiedono l'accesso completo.",
    ...
    mcpDetectionTiming: "Gauss Horizon esegue la verifica automaticamente all'apertura di questa pagina; usa di nuovo Verifica per aggiornare.",
    mcpNpmBoundary: "Gauss Horizon verifica e spiega solo lo stato di MCP; l'installazione e gli aggiornamenti vengono comunque eseguiti tramite npm.",
    ...
    mcpDatabaseScopePermissionNote: "L'ambito selezionato non modifica le autorizzazioni database già esistenti della connessione in Gauss Horizon.",
    ...
    mcpHttpServiceDescription: "Disattivato per impostazione predefinita. Se attivato, Gauss Horizon Desktop ospita il servizio; la configurazione sopra viene applicata al servizio in ascolto solo dopo il salvataggio.",
    ...
    mcpHttpErrorPortInUse: "La porta è già usata da un'altra applicazione. Gauss Horizon riavvia il proprio servizio MCP al salvataggio; chiudi l'altra applicazione che usa la porta oppure scegli un'altra porta.",
    ...
    mcpToolOpenTable: "Apri tabella in Gauss Horizon",
    mcpToolExecuteAndShow: "Esegui e mostra in Gauss Horizon",
    ...
    supportInfoAppVersion: "Versione Gauss Horizon",
    ...
    changelogOpenWebsite: "Visualizza repository",
    ...
    syncSnippetMigrateLegacyConfirm: "Gauss Horizon creerà prima una sostituzione crittografata, quindi eliminerà definitivamente lo snippet legacy in testo semplice {id}. L'operazione non può essere annullata. Continuare?",
  ...
  driverStore: {
    ...
    jreDirRemoveFailedWindows:
      "Impossibile rimuovere la vecchia directory JRE: {path}\nCause possibili:\n  - un processo gauss-horizon Agent / java sta ancora usando la directory\n  - l'antivirus la sta analizzando\nChiudi ogni processo che potrebbe usare la directory, oppure riavvia gauss-horizon e riprova.\n(errore originale: {error})",
    ...
    offlineExportDescription: "Seleziona i driver Agent gestiti da Gauss Horizon da includere. Il pacchetto è compatibile solo con la piattaforma corrente.",
    ...
    offlineExportNoDrivers: "Non sono installati driver Agent gestiti da Gauss Horizon idonei all'esportazione.",
    ...
    offlineExportSecurityHint: "Sono inclusi solo gli artefatti gestiti da Gauss Horizon e i JRE necessari. Percorsi locali, impostazioni e driver esterni sono esclusi.",
    ...
    offlineExportUnavailable_unmanagedInstall: "L'artefatto non è registrato come installazione gestita da Gauss Horizon.",
    ...
    offlineExportUnavailable_missingManagedJre: "Il JRE gestito da Gauss Horizon richiesto non è installato.",
    offlineExportUnavailable_invalidManagedJre: "Il JRE gestito da Gauss Horizon richiesto non è valido o sicuro.",
    refresh: "Aggiorna",
    javaRuntime: "Java Runtime",
    javaRuntimeManaged: "JRE gestito da Gauss Horizon",
    ...
    localInstallHint:
      "Per ambienti completamente isolati: su un altro computer con accesso a internet, scarica il pacchetto ufficiale gauss-horizon-jdbc-plugin-*.zip dalla pagina Releases di Gauss Horizon su GitHub, trasferiscilo su questa macchina e selezionalo: non è richiesto alcun accesso alla rete su questa macchina.",
    runtimeDrivers: "Runtime",
    pluginsTab: "Plugin",
    pluginContributionsTitle: "Contributi frontend dei plugin",
    pluginContributionsDescription: "I plugin installati possono descrivere moduli di connessione e altri contributi UI senza iniettare codice nella finestra principale di Gauss Horizon.",
    noInstalledPlugins: "Nessun plugin installato",
  ...
  nacos: {
    ...
    namespaceIdPlaceholder: "Lascia vuoto per far generare a Gauss Horizon un UUID",
    ...
    nacosDetectAccessibleNamespacesHint: "Gauss Horizon verifica la lettura di configurazioni e servizi prima di proporre i namespace per {name}.",
    ...
    nacosV3ConsoleManagedNamespacesHint: "Questa connessione usa l'API Console di Nacos 3 (normalmente porta 8080). Inserisci un nome o ID namespace; Gauss Horizon converte il nome nell'ID effettivo quando puo leggere la directory.",
    ...
    persistentInstanceHint: "Gauss Horizon non registra istanze effimere perché non può mantenerne l'heartbeat.",
  ...
  databaseBackup: {
    ...
    runtimeRequirement: "I backup programmati vengono eseguiti quando Gauss Horizon è aperto, anche se ridotto a icona nella barra delle applicazioni.",
    ...
    fileNamePatternHint: "Usa {'{'}schedule{'}'}, {'{'}date{'}'}, {'{'}timestamp{'}'}, {'{'}database{'}'} e {'{'}runId{'}'}. Gauss Horizon aggiunge il valore {'{'}database{'}'} mancante e aggiunge automaticamente l'estensione.",
  ...
  mqExchanges: {
    ...
    namePlaceholder: "es. gauss-horizon-events",
    cancel: "Annulla",
    create: "Crea",
    bind: "Collega",
    bindDialogTitle: "Collega a {name}",
    queueNamePlaceholder: "es. gauss-horizon-queue",
    exchangeNamePlaceholder: "es. gauss-horizon-events",
