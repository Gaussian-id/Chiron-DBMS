...
export default withEnglishFallback({
  ...
  pluginPlatform: {
    ...
    centerDescription: "Scopri funzionalità Chiron Horizon opzionali in un marketplace unico e gestisci separatamente plugin installati e repository.",
    ...
    marketplaceGuideDescription: "Per problemi o suggerimenti su un plugin, apri una issue nel repository del plugin stesso (usa il link del repository sorgente sulla scheda); il repository principale di Chiron Horizon gestisce solo i problemi dell'applicazione.",
    ...
    localInstallDescription: "Installa un .chiron-horizonp firmato ottenuto fuori dal marketplace da un file locale o da un URL. Chiron Horizon verifica automaticamente integrità e firma.",
    repositoriesTitle: "Repository dei plugin",
    repositoriesDescription: "La sorgente ufficiale è gestita da Chiron Horizon. I repository self-hosted o di terze parti usano le impostazioni di attendibilità del repository.",
    ...
    pluginDevelopmentDocsDescription: "Scopri come sviluppare, pacchettizzare e pubblicare plugin Chiron Horizon nel marketplace.",
    ...
    allowUnsignedDevelopmentPackageDescription: "Si applica solo all'installazione manuale di .chiron-horizonp e non riduce mai la verifica del marketplace ufficiale.",
    installPackage: "Installa .chiron-horizonp",
    ...
    dropInstallHint: "Puoi anche rilasciare un file .chiron-horizonp su questa pagina",
    packageFileType: "Pacchetto plugin Chiron Horizon",
    ...
    noInstalledPluginsDescription: "Installa un .chiron-horizonp firmato oppure abilita esplicitamente i pacchetti non firmati per lo sviluppo locale.",
  ...
  externalSqlFile: {
    modifiedTitle: "File modificato esternamente a Chiron Horizon",
    ...
    deletedDescription: "{path} è stato eliminato o spostato fuori da Chiron Horizon. Il contenuto dell'editor è ancora disponibile.",
  ...
  updates: {
    ...
    availableMessage: "Chiron Horizon {latest} è disponibile. Stai usando la versione {current}.",
    upToDate: "Chiron Horizon è aggiornato ({version}).",
    ...
    downloadStarted: "Download di Chiron Horizon {version} in background in corso.",
    activeTasksBlockUpdate: "Ci sono {count} attività in esecuzione. Attendi che terminino prima di aggiornare Chiron Horizon.",
    portableAutomaticUpdate: "Chiron Horizon scaricherà lo ZIP portatile firmato, sostituirà solo Chiron Horizon.exe dopo l'uscita e si riavvierà automaticamente. portable.chiron_horizon e i dati verranno mantenuti.",
    ...
    readyToInstall: "Chiron Horizon {version} è pronto per l'installazione.",
    installNow: "Installa ora",
    installedReadyToRestart: "Chiron Horizon è stato aggiornato. Riavvia per completare.",
  ...
  sidebar: {
    ...
    importChironHorizon: "Importa Configurazione Chiron Horizon",
  ...
  sqlLibrary: {
    title: "Libreria SQL",
    storageHelp: "Il contenuto della Libreria SQL viene salvato nei dati dell'app Chiron Horizon, non come file .sql autonomi sul disco.\nPer usarlo nel file system, esporta la Libreria SQL.",
  ...
  connection: {
    ...
    rememberPasswordSaveFailed: "Connessione riuscita, ma Chiron Horizon non ha potuto memorizzare la password: {message}",
    ...
    oracleTnsPathHint: "Il percorso viene letto dal backend Chiron Horizon/Oracle Agent. Sul desktop è locale; su Web e Docker appartiene al server.",
    ...
    nacosWebConsoleUrlHint: "Facoltativo. Apre la console Nacos nel browser. Nacos 3 richiede il proprio indirizzo della console Web separata; il browser deve avere accesso diretto e non riutilizza tunnel o autenticazione API di Chiron Horizon.",
    ...
    gaussdbConnectionModeNativeHint: "Usa il protocollo compatibile con PostgreSQL integrato in Chiron Horizon per le modalità A/PG/Oracle di GaussDB.",
    ...
    agentJavaTooOld: "Questo driver richiede Java 21. Usa il JRE 21 gestito da Chiron Horizon o seleziona un eseguibile Java 21 in Gestione Driver.",
    ...
    jdbcPluginHint: "Installa prima il plugin Chiron Horizon JDBC, quindi importa il file JAR del driver JDBC del fornitore del database.",
    ...
    kafkaKerberosKeytabPlaceholder: "Percorso sulla macchina Chiron Horizon Agent, ad esempio /etc/security/keytabs/user.keytab",
    kafkaKerberosKrb5ConfPlaceholder: "Opzionale, percorso sulla macchina Chiron Horizon Agent, ad esempio /etc/krb5.conf",
    kafkaKerberosPathHint: "I percorsi di keytab e krb5.conf vengono letti da Chiron Horizon Agent e devono esistere sulla macchina in cui è in esecuzione Chiron Horizon Agent; non vengono caricati file dal browser corrente.",
    ...
    sqliteWorkerPlacementSessionHint: "Chiron Horizon carica il worker via SSH sull'host dei file e poi elimina il file remoto alla disconnessione. Adatto all'uso temporaneo.",
    sqliteWorkerPlacementPersistHint: "Chiron Horizon carica il worker via SSH sull'host dei file e lo lascia lì dopo la disconnessione. Non viene eliminato automaticamente.",
    sqliteWorkerPlacementPreplacedHint: "Carica tu il worker sull'host dei file, poi inserisci il percorso assoluto del file. Chiron Horizon non lo caricherà né lo eliminerà automaticamente, ma verificherà che corrisponda a questa versione di Desktop.",
    ...
    sshWorkerUploadConsentMessage: "Chiron Horizon deve copiare un worker SQLite di breve durata su {host}:{port}. Si tratta di un'azione privilegiata. Controlla il percorso di destinazione e il digest prima di consentire il caricamento.",
  ...
  editor: {
    ...
    unsavedChangesBatchCloseMultipleMessage: '{count} schede SQL che stai chiudendo hanno modifiche non salvate. Chiron Horizon mostra attualmente "{title}". Salvare prima di continuare?',
    unsavedChangesAppCloseMessage: '"{title}" ha modifiche SQL non salvate che andranno perse se esci da Chiron Horizon. Salvare prima di uscire?',
    unsavedChangesAppCloseMultipleMessage: '{count} schede SQL hanno modifiche non salvate. Chiron Horizon mostra attualmente "{title}". Andranno perse se esci da Chiron Horizon. Salvare prima di uscire?',
  ...
  tabs: {
    ...
    externalFileMissing: "Eliminato o spostato fuori da Chiron Horizon",
  ...
  grid: {
    ...
    conditionalBulkEditConfirmMessage: "L'operazione aggiorna immediatamente tutte le righe corrispondenti al momento dell'esecuzione, incluse quelle non caricate. Chiron Horizon non può generare un rollback affidabile.",
  ...
  configExport: {
    ...
    cryptoUnavailable: "L'importazione cifrata non è disponibile in questo contesto del browser. Usa HTTPS, localhost o Chiron Horizon Desktop.",
  ...
  ai: {
    ...
    closeWithRunsDescription: "Uscire da Chiron Horizon interromperà {count} attività di AI in esecuzione o in coda. Puoi anche chiudere questa finestra e lasciarle terminare.",
    ...
    productionWriteBlocked: "L'AI non può eseguire modifiche a dati o schema su un database di produzione. Rivedi questo SQL ed eseguilo manualmente in Chiron Horizon.",
    ...
    htmlCopyRiskBody: "Questo HTML è stato generato dall'IA. Aprirlo fuori da Chiron Horizon può eseguire script e accedere alla rete.",
    htmlCopyRiskAccept: "Copia comunque",
    htmlCopyRiskRemember: "Non chiedere più in questa sessione",
    htmlCopyRiskToast: "Copiato. Questo HTML generato dall'IA può eseguire script o accedere alla rete se aperto fuori da Chiron Horizon.",
    ...
    customHeadersReserved: "Questa intestazione è gestita da Chiron Horizon: {name}",
    ...
    codexCliEnvReservedName: "{name} è gestita da Chiron Horizon per MCP Server e non può essere impostata qui.",
    ...
    codexMcpRequiredTitle: "Chiron Horizon MCP Server richiesto",
    codexMcpRequiredDescription: "Codex CLI usa il Chiron Horizon MCP Server per accedere allo schema del database e agli strumenti di query. Installalo prima di usare Codex nell'assistente AI.",
    ...
    cliErrors: {
      ...
      claudeCodeEnvReserved: "È stata sovrascritta una variabile MCP gestita da Chiron Horizon. Rimuovi le variabili CHIRON_HORIZON_MCP_* dalla configurazione del provider.",
      claudeCodeNotAuthenticated: "Claude Code CLI non è autenticato. Esegui `claude auth login` in un terminale e riprova.",
      claudeCodeMcpConfigInvalid: "Claude Code non ha potuto leggere o analizzare la configurazione MCP di Chiron Horizon. Controlla la versione e il percorso di Claude Code CLI.",
      chiron_horizonMcpMissing: "Non è stata trovata un'installazione compatibile di Chiron Horizon MCP Server. Controlla Impostazioni > MCP, quindi reinstalla o aggiorna.",
      claudeCodeMcpStartupFailed: "Claude Code ha caricato la configurazione MCP ma non ha potuto avviare Chiron Horizon MCP Server. Controlla Impostazioni > MCP e i dettagli seguenti.",
      claudeCodeCommandLineTooLong: "Windows ha rifiutato il comando Claude Code perché troppo lungo. Aggiorna Chiron Horizon e riprova usando il file MCP generato.",
      ...
      piAgentEnvReserved: "È stata sovrascritta una variabile Pi o MCP gestita da Chiron Horizon. Rimuovi CHIRON_HORIZON_PI_* e CHIRON_HORIZON_MCP_* dalla configurazione.",
      ...
      piAgentMcpStartupFailed: "Pi non ha potuto avviare il bridge MCP Chiron Horizon. Controlla Impostazioni > MCP e i dettagli seguenti.",
      ...
      openCodeEnvReserved: "È stata sovrascritta una variabile gestita da OpenCode o Chiron Horizon. Rimuovi le variabili di controllo OPENCODE e CHIRON_HORIZON_MCP_* dalla configurazione.",
      ...
      openCodeMcpStartupFailed: "OpenCode non ha potuto avviare il server Chiron Horizon MCP con ambito limitato. Controlla Impostazioni > MCP e i dettagli seguenti.",
      ...
      cursorEnvReserved: "È stata sovrascritta una variabile gestita da Cursor o Chiron Horizon. Rimuovi CURSOR_CONFIG_DIR, CURSOR_DATA_DIR e CHIRON_HORIZON_MCP_* dalla configurazione.",
      cursorNotAuthenticated: "Cursor CLI non è autenticato. Esegui `agent login` nel terminale e riprova.",
      cursorMcpStartupFailed: "Cursor non ha potuto avviare il server Chiron Horizon MCP con ambito limitato. Controlla Impostazioni > MCP e i dettagli seguenti.",
      ...
      grokCliEnvReserved: "È stata sovrascritta una variabile MCP gestita da Chiron Horizon. Rimuovi le variabili CHIRON_HORIZON_MCP_* dalla configurazione del provider.",
      grokCliNotAuthenticated: "Grok CLI non è autenticato. Esegui `grok login` in un terminale e riprova.",
      grokCliMcpStartupFailed: "Grok ha caricato la configurazione MCP ma non ha potuto avviare Chiron Horizon MCP Server. Controlla Impostazioni > MCP e i dettagli seguenti.",
      grokCliCommandLineTooLong: "Windows ha rifiutato il comando Grok CLI perché troppo lungo. Aggiorna Chiron Horizon e riprova usando il file di prompt generato.",
      ...
      codeBuddyEnvReserved: "È stata sovrascritta una variabile MCP gestita da Chiron Horizon. Rimuovi le variabili CHIRON_HORIZON_MCP_* dalla configurazione del provider.",
      ...
      codeBuddyMcpConfigInvalid: "CodeBuddy Code non ha potuto leggere la configurazione temporanea di Chiron Horizon MCP. Controlla i dettagli seguenti.",
      codeBuddyMcpStartupFailed: "CodeBuddy Code ha caricato la configurazione MCP ma non ha potuto avviare Chiron Horizon MCP Server. Controlla Impostazioni > MCP e i dettagli seguenti.",
      ...
      qoderEnvReserved: "È stata sovrascritta una variabile di ambiente MCP gestita da Chiron Horizon. Rimuovi le variabili CHIRON_HORIZON_MCP_* dalla configurazione del provider.",
      ...
      qoderMcpConfigInvalid: "Qoder CLI non ha potuto leggere la configurazione MCP temporanea di Chiron Horizon. Controlla la versione di Qoder CLI e i dettagli seguenti.",
      qoderMcpStartupFailed: "Qoder CLI ha caricato la configurazione MCP ma non ha potuto avviare Chiron Horizon MCP Server. Controlla Impostazioni > MCP e i dettagli seguenti.",
  ...
  contextMenu: {
    ...
    parameterDefaultHint: "Quando DEFAULT è selezionato, Chiron Horizon omette quell'argomento in modo che il database utilizzi il valore predefinito della procedura.",
  ...
  etcd: {
    ...
    dashboard: {
      ...
      metricsUnavailableHint: "Lo stato del cluster resta disponibile. Chiron Horizon richiede /metrics direttamente all'endpoint etcd corrente; verifica che l'URL risultante sia raggiungibile dall'applicazione Chiron Horizon.",
  ...
  sqlParameters: {
    title: "Parametri SQL",
    description: "Compila i valori per i segnaposto del template SQL. Chiron Horizon li sostituisce prima di eseguire l'SQL.",
    name: "Parametro",
    syntax: "Sintassi",
    type: "Tipo",
    value: "Valore",
  ...
  settings: {
    ...
    uiFontAppDefault: "Predefinito Chiron Horizon",
    ...
    iconThemeDefaultDescription: "Utilizza l'icona colorata dell'app Chiron Horizon.",
    iconThemeBlack: "Nero",
    iconThemeBlackDescription: "Usa il logo Chiron Horizon nero nell'app.",
    ...
    showTrayIconDescription: "Se disattivato, non viene mostrata alcuna icona, ma la chiusura della finestra nasconderà comunque Chiron Horizon in background.",
    quitOnClose: "Esci alla chiusura della finestra",
    quitOnCloseDescription: "Se attivato, il pulsante di chiusura termina completamente Chiron Horizon invece di nasconderlo nella barra delle applicazioni.",
    ...
    closeActionQuit: "Esci da Chiron Horizon",
    ...
    duckDbWorkerProcessIsolationDescription: "Esegue le query DuckDB in un processo worker separato. Se una query lunga non risponde all'annullamento, Chiron Horizon può arrestare il processo worker per rilasciare il blocco del file di database.",
    duckDbWorkerMaxProcesses: "Worker DuckDB simultanei massimi",
    duckDbWorkerMaxProcessesDescription: "Limita quanti processi worker DuckDB Chiron Horizon può eseguire contemporaneamente. Intervallo: 1-16. Predefinito: 4.",
    duckDbWorkerProcessIsolationRestartRequired: "Riavvia Chiron Horizon affinché questa modifica abbia effetto.",
    restartChironHorizon: "Riavvia Chiron Horizon",
    restartChironHorizonFailed: "Impossibile riavviare Chiron Horizon: {error}",
    ...
    openTabsRestoreModeDescription: "Scegli come Chiron Horizon ripristina le schede aperte l'ultima volta.",
    ...
    syncWebDavDescription: "Carica o ripristina uno snapshot di Chiron Horizon, inclusa la libreria SQL salvata, da un servizio di archiviazione compatibile con WebDAV.",
    syncWebDavWebDescription: "In modalità Web, il server Chiron Horizon accede a WebDAV senza le limitazioni CORS del browser. Le password salvate restano nell'istanza Chiron Horizon corrente.",
    ...
    syncRememberWebDavPasswordDescription: "La password viene crittografata e memorizzata solo nell'istanza Chiron Horizon corrente. Non viene sincronizzata su WebDAV e non sostituisce la password di sincronizzazione.",
    syncRemotePath: "Percorso snapshot remoto",
    syncRemotePathDescription: "Chiron Horizon creerà le cartelle superiori mancanti durante il caricamento.",
    syncSecretNotice: "Per impostazione predefinita, Chiron Horizon sincronizza solo i dettagli e le impostazioni di connessione. Le password dei database, le password SSH, le password proxy, le stringhe di connessione e le chiavi API AI rimangono locali.",
    syncSecrets: "Sincronizza i segreti crittografati",
    syncSecretsDescription: "Se abilitato, Chiron Horizon crittografa le password del database, le password SSH e le chiavi API AI prima di caricarle su WebDAV.",
    syncSecretsPassphrase: "Password di sincronizzazione",
    syncSecretsPassphraseDescription: "Questa password viene utilizzata solo per crittografare e ripristinare i dati sensibili. È crittografata nell'istanza Chiron Horizon corrente; inseriscila di nuovo nelle altre istanze.",
    syncTest: "Verifica",
    syncUpload: "Carica",
    ...
    syncAutoUploadDescription: "Viene eseguito mentre Chiron Horizon è aperto. I download richiedono ancora conferma manuale per evitare di sostituire SQL salvati localmente.",
    ...
    syncDownloadConfirm: "Scaricare e applicare lo snapshot Chiron Horizon remoto? I metadati locali e i file SQL salvati verranno sostituiti.",
    apply: "Applica",
    ...
    appCloseUnsavedTabsModeDescription: "Scegli cosa succede quando esci da Chiron Horizon con schede SQL che contengono modifiche non salvate.",
    appCloseUnsavedTabsModePrompt: "Chiedi se salvare",
    appCloseUnsavedTabsModeKeepDrafts: "Esci e conserva le bozze",
    appCloseUnsavedTabsModeHint: 'Le bozze vengono conservate come schede non salvate e ripristinate al prossimo avvio di Chiron Horizon. Richiede che "Ripristina schede all\'avvio" non sia impostato su "Non mantenere schede".',
    appCloseDraftPersistFailed: "Chiron Horizon non ha potuto salvare le bozze delle schede aperte, quindi l'uscita è stata annullata. Controlla lo spazio su disco e i permessi dei file, quindi riprova. Dettagli: {message}",
    ...
    sqlVariableSyntaxDescription: "Scegli quali sintassi di variabili e segnaposto Chiron Horizon sostituisce prima di eseguire SQL, per tipo di database. Tutte abilitate per impostazione predefinita.",
    ...
    jdbcPlugin: "Plugin Chiron Horizon JDBC",
    ...
    mcpTitle: "Server MCP",
    mcpDescription: "Verifica l'installazione e la versione del Server Chiron Horizon MCP utilizzata da Claude Code, Cursor e altri agenti.",
    ...
    mcpConfigOptionsHint:
      "Chiron Horizon controlla centralmente l'accesso alle connessioni e i permessi di esecuzione per tutti i client MCP. La configurazione generata contiene solo i parametri di runtime necessari per avviare il server MCP e collegarlo a questa istanza Chiron Horizon, senza variabili di autorizzazione o ambito connessione.",
    mcpScopeConnection: "Connessioni consentite per MCP",
    mcpScopeConnectionDescription: "Chiron Horizon espone a MCP solo le connessioni selezionate. Le modifiche si applicano a tutti i client MCP.",
    ...
    mcpExecutionModeReadOnlyDescription: "Consente solo le richieste che Chiron Horizon classifica come letture; blocca le scritture riconosciute e le modifiche alle connessioni. I permessi dell'account del database restano il limite di sicurezza finale.",
    ...
    mcpCapabilityDescription: "Queste sono operazioni rappresentative; le richieste che Chiron Horizon non può classificare in modo affidabile richiedono l'accesso completo.",
    ...
    mcpDetectionTiming: "Chiron Horizon esegue la verifica automaticamente all'apertura di questa pagina; usa di nuovo Verifica per aggiornare.",
    mcpNpmBoundary: "Chiron Horizon verifica e spiega solo lo stato di MCP; l'installazione e gli aggiornamenti vengono comunque eseguiti tramite npm.",
    ...
    mcpDatabaseScopePermissionNote: "L'ambito selezionato non modifica le autorizzazioni database già esistenti della connessione in Chiron Horizon.",
    ...
    mcpHttpServiceDescription: "Disattivato per impostazione predefinita. Se attivato, Chiron Horizon Desktop ospita il servizio; la configurazione sopra viene applicata al servizio in ascolto solo dopo il salvataggio.",
    ...
    mcpHttpErrorPortInUse: "La porta è già usata da un'altra applicazione. Chiron Horizon riavvia il proprio servizio MCP al salvataggio; chiudi l'altra applicazione che usa la porta oppure scegli un'altra porta.",
    ...
    mcpToolOpenTable: "Apri tabella in Chiron Horizon",
    mcpToolExecuteAndShow: "Esegui e mostra in Chiron Horizon",
    ...
    supportInfoAppVersion: "Versione Chiron Horizon",
    ...
    syncSnippetMigrateLegacyConfirm: "Chiron Horizon creerà prima una sostituzione crittografata, quindi eliminerà definitivamente lo snippet legacy in testo semplice {id}. L'operazione non può essere annullata. Continuare?",
  ...
  driverStore: {
    ...
    jreDirRemoveFailedWindows:
      "Impossibile rimuovere la vecchia directory JRE: {path}\nCause possibili:\n  - un processo chiron_horizon Agent / java sta ancora usando la directory\n  - l'antivirus la sta analizzando\nChiudi ogni processo che potrebbe usare la directory, oppure riavvia chiron_horizon e riprova.\n(errore originale: {error})",
    ...
    offlineExportDescription: "Seleziona i driver Agent gestiti da Chiron Horizon da includere. Il pacchetto è compatibile solo con la piattaforma corrente.",
    ...
    offlineExportNoDrivers: "Non sono installati driver Agent gestiti da Chiron Horizon idonei all'esportazione.",
    ...
    offlineExportSecurityHint: "Sono inclusi solo gli artefatti gestiti da Chiron Horizon e i JRE necessari. Percorsi locali, impostazioni e driver esterni sono esclusi.",
    ...
    offlineExportUnavailable_unmanagedInstall: "L'artefatto non è registrato come installazione gestita da Chiron Horizon.",
    ...
    offlineExportUnavailable_missingManagedJre: "Il JRE gestito da Chiron Horizon richiesto non è installato.",
    offlineExportUnavailable_invalidManagedJre: "Il JRE gestito da Chiron Horizon richiesto non è valido o sicuro.",
    refresh: "Aggiorna",
    javaRuntime: "Java Runtime",
    javaRuntimeManaged: "JRE gestito da Chiron Horizon",
    ...
    localInstallHint:
      "Per ambienti completamente isolati: su un altro computer con accesso a internet, scarica il pacchetto ufficiale chiron-horizon-jdbc-plugin-*.zip dalla pagina Releases di Chiron Horizon su GitHub, trasferiscilo su questa macchina e selezionalo: non è richiesto alcun accesso alla rete su questa macchina.",
    runtimeDrivers: "Runtime",
    pluginsTab: "Plugin",
    pluginContributionsTitle: "Contributi frontend dei plugin",
    pluginContributionsDescription: "I plugin installati possono descrivere moduli di connessione e altri contributi UI senza iniettare codice nella finestra principale di Chiron Horizon.",
    noInstalledPlugins: "Nessun plugin installato",
  ...
  nacos: {
    ...
    namespaceIdPlaceholder: "Lascia vuoto per far generare a Chiron Horizon un UUID",
    ...
    nacosDetectAccessibleNamespacesHint: "Chiron Horizon verifica la lettura di configurazioni e servizi prima di proporre i namespace per {name}.",
    ...
    nacosV3ConsoleManagedNamespacesHint: "Questa connessione usa l'API Console di Nacos 3 (normalmente porta 8080). Inserisci un nome o ID namespace; Chiron Horizon converte il nome nell'ID effettivo quando puo leggere la directory.",
    ...
    persistentInstanceHint: "Chiron Horizon non registra istanze effimere perché non può mantenerne l'heartbeat.",
  ...
  databaseBackup: {
    ...
    runtimeRequirement: "I backup programmati vengono eseguiti quando Chiron Horizon è aperto, anche se ridotto a icona nella barra delle applicazioni.",
    ...
    fileNamePatternHint: "Usa {'{'}schedule{'}'}, {'{'}date{'}'}, {'{'}timestamp{'}'}, {'{'}database{'}'} e {'{'}runId{'}'}. Chiron Horizon aggiunge il valore {'{'}database{'}'} mancante e aggiunge automaticamente l'estensione.",
  ...
  mqExchanges: {
    ...
    namePlaceholder: "es. chiron-horizon-events",
    cancel: "Annulla",
    create: "Crea",
    bind: "Collega",
    bindDialogTitle: "Collega a {name}",
    queueNamePlaceholder: "es. chiron-horizon-queue",
    exchangeNamePlaceholder: "es. chiron-horizon-events",
