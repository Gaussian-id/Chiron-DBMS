...
const taggedAiCliErrorKeys: Record<string, string> = {
  ...
  gaussHorizonMcpMissing: "ai.cliErrors.gaussHorizonMcpMissing",
...
const patterns: [RegExp, string][] = [
  ...
  [/^Agent requires Java 21, but Gauss Horizon started it with an older Java runtime\. Use Gauss Horizon managed JRE 21 or select a Java 21 executable in Driver Manager\./, "connection.agentJavaTooOld"],
  ...
  // Query result export limits (crates/gauss-horizon-core/src/query_result_export.rs)
  ...
  // Driver / JRE management (crates/gauss-horizon-core/src/agent_service.rs, routes/agents.rs)
  ...
  // Message queues (crates/gauss-horizon-core/src/mq/adapters/kafka.rs)
  ...
  // Web auth rate limiting (crates/gauss-horizon-web/src/auth.rs)
