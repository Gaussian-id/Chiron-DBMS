...
const taggedAiCliErrorKeys: Record<string, string> = {
  ...
  chironHorizonMcpMissing: "ai.cliErrors.chironHorizonMcpMissing",
...
const patterns: [RegExp, string][] = [
  ...
  [/^Agent requires Java 21, but Chiron Horizon started it with an older Java runtime\. Use Chiron Horizon managed JRE 21 or select a Java 21 executable in Driver Manager\./, "connection.agentJavaTooOld"],
  ...
  // Query result export limits (crates/chiron-horizon-core/src/query_result_export.rs)
  ...
  // Driver / JRE management (crates/chiron-horizon-core/src/agent_service.rs, routes/agents.rs)
  ...
  // Message queues (crates/chiron-horizon-core/src/mq/adapters/kafka.rs)
  ...
  // Web auth rate limiting (crates/chiron-horizon-web/src/auth.rs)
