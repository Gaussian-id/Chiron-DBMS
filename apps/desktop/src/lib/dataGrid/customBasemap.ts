...
export const CUSTOM_BASEMAP_SESSION_KEY = "gauss-horizon-layer-preview-custom-basemap";
export const BASEMAP_SELECTION_SESSION_KEY = "gauss-horizon-layer-preview-selected-basemap";
