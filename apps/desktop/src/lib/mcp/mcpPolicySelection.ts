...
export const MCP_TOOL_OPTIONS = [
  { name: "gauss_horizon_list_connections", labelKey: "settings.mcpToolListConnections" },
  { name: "gauss_horizon_list_databases", labelKey: "settings.mcpToolListDatabases" },
  { name: "gauss_horizon_list_tables", labelKey: "settings.mcpToolListTables" },
  { name: "gauss_horizon_describe_table", labelKey: "settings.mcpToolDescribeTable" },
  { name: "gauss_horizon_list_routines", labelKey: "settings.mcpToolListRoutines" },
  { name: "gauss_horizon_get_routine_source", labelKey: "settings.mcpToolGetRoutineSource" },
  { name: "gauss_horizon_get_schema_context", labelKey: "settings.mcpToolGetSchemaContext" },
  { name: "gauss_horizon_execute_query", labelKey: "settings.mcpToolExecuteQuery" },
  { name: "gauss_horizon_execute_batch", labelKey: "settings.mcpToolExecuteBatch" },
  { name: "gauss_horizon_open_session", labelKey: "settings.mcpToolOpenSession" },
  { name: "gauss_horizon_close_session", labelKey: "settings.mcpToolCloseSession" },
  { name: "gauss_horizon_execute_redis_command", labelKey: "settings.mcpToolExecuteRedisCommand" },
  { name: "gauss_horizon_peek_messages", labelKey: "settings.mcpToolPeekMessages" },
  { name: "gauss_horizon_send_message", labelKey: "settings.mcpToolSendMessage" },
  { name: "gauss_horizon_add_connection", labelKey: "settings.mcpToolAddConnection" },
  { name: "gauss_horizon_duplicate_connection", labelKey: "settings.mcpToolDuplicateConnection" },
  { name: "gauss_horizon_remove_connection", labelKey: "settings.mcpToolRemoveConnection" },
  { name: "gauss_horizon_open_table", labelKey: "settings.mcpToolOpenTable" },
  { name: "gauss_horizon_execute_and_show", labelKey: "settings.mcpToolExecuteAndShow" },
] as const;
