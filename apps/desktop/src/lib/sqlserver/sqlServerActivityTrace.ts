...
export const SQLSERVER_TRACE_SESSION_PREFIX = "CHIRON_HORIZON_TRACE_";
export const SQLSERVER_TRACE_INTERNAL_MARKER = "CHIRON_HORIZON_INTERNAL_TRACE";
...
export function isValidSqlServerTraceSessionName(value: string): boolean {
  return /^CHIRON_HORIZON_TRACE_[A-Z0-9_]{3,100}$/.test(value);
}
