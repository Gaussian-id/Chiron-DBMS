...
const GAUSS_HORIZON_COMMON_SQL_KEYWORDS = [
  "PIVOT",
  "UNPIVOT",
  "EXCLUDE",
  "REPLACE",
...
export function createGaussHorizonCodeMirrorSqlDialect(langSql: CodeMirrorSqlLanguageModule, dialectName: CodeMirrorSqlDialectName = "mysql", databaseType?: DatabaseType, driverProfile?: string): SQLDialect {
  ...
  const commonKeywords = isClickHouse ? GAUSS_HORIZON_COMMON_SQL_KEYWORDS.toLowerCase() : GAUSS_HORIZON_COMMON_SQL_KEYWORDS;
