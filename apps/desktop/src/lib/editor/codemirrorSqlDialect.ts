...
const CHIRON_HORIZON_COMMON_SQL_KEYWORDS = [
  "PIVOT",
  "UNPIVOT",
  "EXCLUDE",
  "REPLACE",
...
export function createChironHorizonCodeMirrorSqlDialect(langSql: CodeMirrorSqlLanguageModule, dialectName: CodeMirrorSqlDialectName = "mysql", databaseType?: DatabaseType, driverProfile?: string): SQLDialect {
  ...
  const commonKeywords = isClickHouse ? CHIRON_HORIZON_COMMON_SQL_KEYWORDS.toLowerCase() : CHIRON_HORIZON_COMMON_SQL_KEYWORDS;
