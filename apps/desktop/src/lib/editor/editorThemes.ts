...
export const EDITOR_FONT_SIZE_CSS_VAR = "--chiron-horizon-editor-font-size";
export const EDITOR_FONT_FAMILY_CSS_VAR = "--chiron-horizon-editor-font-family";
export const SQL_TABLE_COLOR_CSS_VAR = "--chiron-horizon-sql-table-color";
const EDITOR_SELECTION_BACKGROUND_CSS_VAR = "--chiron-horizon-editor-selection-background";
...
function lucideCompletionIconMask(iconNode: LucideIconNode) {
  ...
  return {
    "--chiron-horizon-completion-icon-mask": mask,
  };
}
...
export async function loadEditorTheme(theme: EditorTheme, appAppearance: AppThemeAppearance = "dark", customColors?: CustomThemeColors, appPalette: AppThemePalette = "pearl"): Promise<Extension> {
  if (theme === "app" && appPalette === "chiron") {
        ...
        EditorView.theme(
          {
            ...
            ".cm-gutters": { backgroundColor: "var(--chiron-horizon-gutter)", color: "var(--muted-foreground)", borderColor: "var(--border)" },
...
export function buildEditorFontThemeRules(opts?: { fixedHeight?: boolean; scrollable?: boolean }, defaults?: { size?: number; family?: string }): CodeMirrorStyleSpec {
  return {
    ...
    ".cm-content": {
      ...
      // characters unpainted until something else forces a repaint (chiron-horizon#7900).
    ...
    ".cm-run-statement-marker": {
      ...
      borderRadius: "var(--chiron-horizon-radius-fixed-6)",
      boxSizing: "border-box",
      color: "transparent",
      display: "inline-flex",
      flexShrink: "0",
...
export function buildSqlCompletionThemeRules(): CodeMirrorStyleSpec {
  return {
    ".cm-tooltip.cm-tooltip-autocomplete": {
      ...
      borderRadius: "var(--chiron-horizon-radius-md)",
    ...
    ".cm-tooltip.cm-tooltip-autocomplete > ul > li": {
      alignItems: "center",
      borderRadius: "var(--chiron-horizon-radius-sm)",
      color: "var(--popover-foreground)",
      display: "flex",
    ...
    ".cm-completionIcon:before": {
      ...
      top: "0",
      position: "absolute",
      WebkitMaskImage: "var(--chiron-horizon-completion-icon-mask)",
      WebkitMaskPosition: "center",
      WebkitMaskRepeat: "no-repeat",
      WebkitMaskSize: "14px 14px",
      maskImage: "var(--chiron-horizon-completion-icon-mask)",
      maskPosition: "center",
