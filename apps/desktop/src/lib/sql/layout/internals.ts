 ...
 * output layout is not configurable enough for the default style Chiron Horizon targets:
 ...
 * `cfg.params`, which Chiron Horizon never sets — the config importer rejects that legacy
