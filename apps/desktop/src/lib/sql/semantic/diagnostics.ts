...
import { CHIRON_HORIZON_TDENGINE_TBNAME_COLUMN, isTdengineStableTableType } from "@/lib/table/tableEditing";
...
export function buildSqlSemanticDiagnostics(analysis: SqlReferenceAnalysis, schema: SqlSemanticDiagnosticSchema): SqlSemanticDiagnostic[] {
  ...
  for (const column of analysis.columns) {
    ...
    if (schema.databaseType === "tdengine" && normalizeName(column.name) === CHIRON_HORIZON_TDENGINE_TBNAME_COLUMN) {
