...
export const DATA_GRID_FONT_FAMILY_CSS_VAR = "--gauss-horizon-data-grid-font-family";
...
// Native-feeling UI option without Gauss Horizon's bundled/brand font at the front of the stack.
