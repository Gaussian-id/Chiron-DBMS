...
export const PHOENIX_JDBC_PLUGIN_NOT_INSTALLED_ERROR = "Gauss Horizon JDBC plugin is not installed. Install Apache Phoenix JDBC from the Driver Manager, then retry.";
