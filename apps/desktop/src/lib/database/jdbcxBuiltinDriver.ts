...
export const JDBCX_HIGH_PRIVILEGE_EXTENSIONS_JAVA_OPTION = "-Dgauss.horizon.jdbcx.allowHighPrivilegeExtensions=true";
const JDBCX_HIGH_PRIVILEGE_EXTENSIONS_JAVA_OPTION_PREFIX = "-Dgauss.horizon.jdbcx.allowHighPrivilegeExtensions=";
...
export function setJdbcxHighPrivilegeExtensionsEnabled(config: Pick<ConnectionConfig, "agent_java_options">, enabled: boolean): void {
  // Canonicalize this Gauss Horizon-owned option so legacy whitespace cannot diverge from backend parsing.
