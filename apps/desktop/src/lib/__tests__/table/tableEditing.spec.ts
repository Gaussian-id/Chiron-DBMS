...
describe("tableEditing", () => {
  ...
  it("keeps Xugu's internal ROWID hidden after primary-key metadata arrives", () => {
    expect(isHiddenGridColumn("xugu", CHIRON_HORIZON_ROWID_COLUMN, ["ID"], "TABLE")).toBe(true);
    expect(isHiddenGridColumn("xugu", CHIRON_HORIZON_ROWID_COLUMN, [], "TABLE")).toBe(true);
    expect(isHiddenGridColumn("xugu", CHIRON_HORIZON_ROWID_COLUMN, ["ID"], "VIEW")).toBe(false);
