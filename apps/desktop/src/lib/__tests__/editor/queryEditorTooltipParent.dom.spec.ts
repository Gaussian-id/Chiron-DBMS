...
describe("CodeMirror tooltip host", () => {
  it("keeps containers independent and removes them with each editor", () => {
    document.body.innerHTML = '<div id="root"><div data-app><div data-split-pane><div data-editor="first"></div><div data-editor="second"></div></div><div id="gauss-horizon-query-editor-tooltip-root" style="position: fixed; width: 0; height: 0; overflow: visible"></div></div></div>';
    const root = document.querySelector<HTMLElement>("#root")!;
    const splitPane = document.querySelector<HTMLElement>("[data-split-pane]")!;
    const tooltipHost = document.querySelector<HTMLElement>("#gauss-horizon-query-editor-tooltip-root")!;
