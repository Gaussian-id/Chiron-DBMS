...
const configuredBasePath = process.env.VITE_CHIRON_HORIZON_BASE_PATH || process.env.CHIRON_HORIZON_PUBLIC_BASE_PATH;
...
const backendUrl = process.env.CHIRON_HORIZON_BACKEND_URL || "http://localhost:4224";
