...
Chiron Horizon 0.1.0 is distributed from [GitHub Releases](https://github.com/Gaussian-id/Gauss-Horizon/releases). Download the asset for your platform, compare its SHA-256 with `SHA256SUMS`, then install it locally. Application auto-update and npm distribution are not enabled in this release.

## Install the desktop application

| Platform | Asset | Install |
| --- | --- | --- |
| macOS Apple Silicon | `Chiron-Horizon_0.1.0_macos-arm64.dmg` | Open the DMG and drag **Chiron Horizon** into Applications. |
| macOS Intel | `Chiron-Horizon_0.1.0_macos-x64.dmg` | Open the DMG and drag **Chiron Horizon** into Applications. |
| Windows 10/11 x64 | `Chiron-Horizon_0.1.0_windows-x64-setup.exe` | Run the NSIS installer. SmartScreen may require **More info → Run anyway**. |
| Ubuntu 22.04+ x64 | `Chiron-Horizon_0.1.0_linux-x64.deb` | Run `sudo apt install ./Chiron-Horizon_0.1.0_linux-x64.deb`. |
| Ubuntu 22.04+ x64 | `Chiron-Horizon_0.1.0_linux-x64.AppImage` | Run `chmod +x Chiron-Horizon_0.1.0_linux-x64.AppImage`, then open it. |
...
```powershell
# Windows PowerShell
Get-FileHash .\Chiron-Horizon_0.1.0_windows-x64-setup.exe -Algorithm SHA256
```
