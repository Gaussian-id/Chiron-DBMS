...
- [examples/web-api/automation.sh](https://github.com/Gaussian-id/Gauss-Horizon/tree/main/examples/web-api/automation.sh)
- [examples/docker/docker-compose.yml](https://github.com/Gaussian-id/Gauss-Horizon/tree/main/examples/docker/docker-compose.yml)
- [examples/cli/basic-workflow.sh](https://github.com/Gaussian-id/Gauss-Horizon/tree/main/examples/cli/basic-workflow.sh)
