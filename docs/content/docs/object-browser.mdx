...
Open **Object Browser** from a connection, database, or schema context menu. Chiron Horizon derives the catalog, database, and schema scope from the selected node.
...
Chiron Horizon shows the definition available from the active driver. Formatting, privileges/comments/storage properties, and direct edit support vary by database.
