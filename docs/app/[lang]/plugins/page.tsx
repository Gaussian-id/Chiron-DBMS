...
const pageMeta = {
  en: {
    title: "Plugin Center",
    description: "Browse official Chiron Horizon marketplace plugins: signed packages, versions, permissions, and one-click install URLs for the in-app plugin center.",
  },
  cn: {
    title: "插件中心",
    description: "浏览 Chiron Horizon 官方插件商店收录的插件：签名校验的安装包、版本历史、权限说明，以及可直接粘贴到客户端插件中心的安装链接。",
  },
};
