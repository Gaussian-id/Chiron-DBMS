...
const metadata = {
  en: {
    ...
    description: "Describe a Gauss Horizon problem or suggestion without a GitHub account. Review the AI-polished draft before publishing.",
  },
  cn: {
    title: "匿名提交 Issue",
    description: "无需 GitHub 账号，简短描述 Gauss Horizon 问题或建议，由 AI 整理并在你确认后公开提交。",
  },
};
