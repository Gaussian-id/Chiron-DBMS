  ...
  en: [
    {
      ...
      quote: "Chiron Horizon keeps query work, schema checks, and Redis inspection in one small app. It feels focused instead of overloaded.",
    },
    {
      name: "eryajf",
      role: "Database management",
      avatar: "/avatars/eryajf.jpg",
      quote: "Try it once and you can feel it: Chiron Horizon is the database management client that ends the competition.",
    },
    {
      name: "@vbvb",
  ...
  cn: [
    {
      ...
      quote: "Chiron Horizon 把查询、结构检查和 Redis 查看放在一个轻量工具里，日常数据库工作不会被复杂界面打断。",
    },
    {
      name: "二丫讲梵",
      role: "数据库管理",
      avatar: "/avatars/eryajf.jpg",
      quote: "只需体验一次你就能感受到，Chiron Horizon是一个杀死数据库管理客户端比赛的软件",
    },
    {
      name: "Husky明夋",
      role: "报表与数据核对",
...
const METRICS_LABEL: Record<DocsLang, string> = {
  en: "Chiron Horizon key metrics",
  cn: "Chiron Horizon 核心指标",
};
...
const i18nText = {
  en: {
    ...
    heroSubtitle: "Chiron Horizon brings connections, SQL editing, data grids, schema tools, AI assistance, and self-hosted access into one lightweight product.",
    download: "Download Chiron Horizon",
    downloadName: "Download Chiron Horizon",
    readDocs: "Read the docs",
    docsStart: "Start here",
    docsStartDesc: "Install Chiron Horizon, create your first connection, and learn the main workflow.",
    ...
    testimonialsTitle: "What Chiron Horizon is good at",
    testimonialsDesc: "A closer look at the everyday database workflows Chiron Horizon is built to make smoother.",
    capabilitiesTitle: "Built for real database work",
    contributorsTitle: "Built by the community",
    contributorsDesc: "Chiron Horizon is fully open-source. Every feature, fix, and driver starts with a contributor.",
    sponsorsLabel: "❤️ Sponsors",
    partnersLabel: "🤝 Partners",
    qiniuSponsorDesc: "Qiniu Cloud provides Chiron Horizon with object storage, CDN, and other cloud infrastructure resources.",
    ...
    trustasiaSponsorDesc: "TrustAsia provides cloud-based code signing service for Chiron Horizon, enabling trusted software through automated CI/CD builds.",
    trustasiaSponsorAction: "Visit",
    jalapenoSponsorDesc: "Jalapeño Cloud is an AI infrastructure and token compute platform, with an exclusive Chiron Horizon entry offering free credits and top-up bonuses.",
    ...
    footerTitle: "Ready to try Chiron Horizon?",
  ...
  cn: {
    ...
    heroSubtitle: "Chiron Horizon 将连接管理、SQL 编辑、数据表格、结构工具、AI 助手和自托管访问放进一个轻量产品里。",
    download: "下载 Chiron Horizon",
    downloadName: "下载 Chiron Horizon",
    readDocs: "查看文档",
    docsStart: "从这里开始",
    docsStartDesc: "安装 Chiron Horizon、创建第一个连接，并了解主要工作流。",
    ...
    supportLink: "查看全部",
    testimonialsTitle: "Chiron Horizon 适合什么样的工作",
    testimonialsDesc: "从连接管理、数据浏览到 AI 辅助，Chiron Horizon 围绕高频数据库工作流打磨体验。",
    capabilitiesTitle: "面向真实数据库工作的能力",
    contributorsTitle: "社区共建",
    contributorsDesc: "Chiron Horizon 因每一位贡献者而生长",
    sponsorsLabel: "❤️ 赞助商",
    partnersLabel: "🤝 合作伙伴",
    qiniuSponsorDesc: "七牛云为 Chiron Horizon 提供对象存储、CDN 等云基础设施资源支持。",
    ...
    jalapenoSponsorDesc: "Jalapeño Cloud 是 AI 基础设施与 Token 算力平台，通过 Chiron Horizon 专属入口可享新用户免费额度与充值加赠。",
    ...
    footerTitle: "准备试试 Chiron Horizon？",
...
const landingMeta = {
  en: {
    title: "Chiron Horizon - 25 MB to manage 90+ databases!",
    description: "Chiron Horizon brings connections, SQL editing, data grids, schema tools, AI assistance, and self-hosted access into one lightweight product.",
  },
  cn: {
    title: "Chiron Horizon - 25MB，管理90+种数据库！",
    description: "Chiron Horizon 将连接管理、SQL 编辑、数据表格、结构工具、AI 助手和自托管访问放进一个轻量产品里。",
  },
};
...
export default async function LandingPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const sponsorItems = [
    ...
    {
      name: "Jalapeño Cloud",
      href: "https://www.jalapeno-cloud.ai/Chiron Horizon",
    ...
    {
      name: "AstraFlow",
      href: "https://www.ucloud.cn/site/active/kuaijiesale.html?ytag=geo_waituo_github_chiron-horizon",
    ...
    {
      name: "HuaLongAI",
      href: "https://api.hualong.online/register?promo=Chiron Horizon%26HUALONG",
    ...
    <main className="landing" lang={getHtmlLang(l)}>
      ...
      <RevealSection className="flex items-center justify-between gap-6 max-w-[1180px] mx-auto px-7 border border-landing-line rounded-[10px] bg-landing-panel mt-[72px] mb-14 py-[30px] max-[760px]:block max-[760px]:px-[18px]">
        ...
        <div className="flex items-center gap-2.5 flex-wrap justify-end max-[760px]:mt-[18px]">
          <Link href="https://github.com/Gaussian-id/Chiron-Horizon/releases/latest" target="_blank" className="landing-final-link inline-flex items-center justify-center min-h-[42px] rounded-[7px] px-[15px] text-sm font-[650]">
            {t.release}
          </Link>
