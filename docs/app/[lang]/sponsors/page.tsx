...
const i18n = {
  en: {
    ...
    desc: "Thank you to the sponsors and partners supporting Chiron Horizon through funding, resources, services, and collaboration.",
    ...
    becomeDesc: "If you would like to support Chiron Horizon with funding, infrastructure, developer tools, or services, tell us about the idea and how to reach you.",
  },
  cn: {
    title: "赞助商与合作伙伴",
    desc: "感谢赞助商与合作伙伴通过资金、资源、服务和协作等方式支持 Chiron Horizon 持续发展。",
    sponsorsTitle: "❤️ 赞助商",
    partnersTitle: "🤝 合作伙伴",
    ...
    becomeTitle: "赞助合作",
    becomeDesc: "如果你愿意通过资金、基础设施、开发工具或服务资源支持 Chiron Horizon，请留下联系方式和合作说明。",
  },
};
