...
const i18n = {
  en: {
    ...
    desc: "Chiron Horizon connects to 90+ database engines. Native Rust drivers, MySQL/PostgreSQL-compatible profiles, and JDBC for everything else.",
  ...
  cn: {
    title: "支持的数据库",
    desc: "Chiron Horizon 支持 90+ 种数据库引擎。涵盖 Rust 原生驱动、MySQL/PostgreSQL 兼容类型和 JDBC 扩展。",
    ctaTitle: "没看到你用的数据库？",
