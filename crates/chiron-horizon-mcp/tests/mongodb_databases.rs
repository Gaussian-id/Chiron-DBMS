...
fn live_mongo_connection() -> ConnectionConfig {
    ...
    connection.host = chiron_horizon_core::legacy::var("CHIRON_HORIZON_MCP_TEST_MONGO_HOST").expect("MongoDB host");
    connection.port = chiron_horizon_core::legacy::var("CHIRON_HORIZON_MCP_TEST_MONGO_PORT")
...
async fn list_databases(
    ...
    let result = tokio::time::timeout(
        ...
        client.peer().call_tool(
            CallToolRequestParams::new("chiron_horizon_list_databases")
...
async fn mongodb_agent_discovery_keeps_one_health_check_for_a_warm_pool() {
    ...
    use chiron_horizon_mcp::ChironHorizonBackend;
...
"#,
    ...
    let storage_path = directory.path().join("chiron-horizon.db");
...
#[tokio::test]
#[ignore = "requires CHIRON_HORIZON_MCP_TEST_MONGO_HOST and CHIRON_HORIZON_MCP_TEST_MONGO_PASSWORD (root, authSource=admin)"]
