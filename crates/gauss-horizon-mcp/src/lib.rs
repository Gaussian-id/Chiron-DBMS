...
pub use backend::{ConnectionSummary, GaussHorizonBackend, LocalBackend, WebBackend};
pub use gauss_horizon_core::mongo_shell as mongo;
...
pub use server::{GaussHorizonMcpServer, McpScope};
