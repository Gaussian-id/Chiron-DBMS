// ============================================================================
// 12.4 — CLI/Tauri/gauss-horizon-web API Contract Verification
//
...
use gauss_horizon_core::data_compare::{DataComparePreparation, DataCompareSyncPlan};
use gauss_horizon_core::models::connection::DatabaseType;
use gauss_horizon_core::schema_diff::{prepare_schema_diff, SchemaDiffPreparation, SchemaDiffPreparationOptions};
use gauss_horizon_core::sql_risk::{classify_sql_risk, SqlRisk};
...
fn generate_schema_sync_sql_function_signature() {
    let _sql = gauss_horizon_core::schema_diff::generate_schema_sync_sql(
        &[],
        &[],
        &[],
        &[],
...
fn data_compare_preparation_field_names() {
    use gauss_horizon_core::data_compare::{DataCompareResult, DataCompareRow};
...
fn table_columns_result_serialization_contract() {
    use gauss_horizon_core::db::TableColumnsResult;
