...
use gauss_horizon_core::redis_ops::redis_execute_command_core;
...
async fn blocking_redis_command_does_not_block_another_connection() {
    ...
    let blocking = tokio::spawn(async move {
        redis_execute_command_core(&redis_state, &redis_id, 0, "BLPOP gauss-horizon:issue:7720:missing 1", true).await
    });
