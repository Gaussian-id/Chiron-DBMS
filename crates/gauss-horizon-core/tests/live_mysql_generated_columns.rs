...
use gauss_horizon_core::types::ColumnInfo;
...
#[tokio::test]
#[ignore = "requires GAUSS_HORIZON_LIVE_MYSQL_GENERATED_URL and GAUSS_HORIZON_LIVE_MYSQL_GENERATED_DATABASE"]
async fn live_mysql_generated_column_metadata_and_alter_preserve_expression() {
    let url = gauss_horizon_core::legacy::var("GAUSS_HORIZON_LIVE_MYSQL_GENERATED_URL")
        .expect("GAUSS_HORIZON_LIVE_MYSQL_GENERATED_URL");
    let database = gauss_horizon_core::legacy::var("GAUSS_HORIZON_LIVE_MYSQL_GENERATED_DATABASE")
        .expect("GAUSS_HORIZON_LIVE_MYSQL_GENERATED_DATABASE");
    let table = format!("gauss_horizon_generated_{}", uuid::Uuid::new_v4().simple());
