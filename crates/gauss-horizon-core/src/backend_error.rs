...
impl BackendError {
    ...
    /// Create a retryable envelope for a manual transaction session that Gauss Horizon
...
mod tests {
    ...
    fn catalog_owns_exact_code_and_message_key_pairs() {
        let cases = [
            (CatalogCode::ConnectionFailed, "Gauss Horizon-JDBC-1001", "backendErrors.jdbc.connectionFailed"),
            (CatalogCode::ConnectionInterrupted, "Gauss Horizon-JDBC-1002", "backendErrors.jdbc.connectionInterrupted"),
            (CatalogCode::TimeoutNotStarted, "Gauss Horizon-JDBC-2001", "backendErrors.jdbc.operationTimedOut"),
            (CatalogCode::TimeoutUnknown, "Gauss Horizon-JDBC-2002", "backendErrors.jdbc.operationTimedOut"),
            (
                CatalogCode::TransactionSessionExpired,
                "Gauss Horizon-TXN-1001",
                "backendErrors.transaction.sessionExpired",
            ),
            (CatalogCode::Canceled, "Gauss Horizon-JDBC-2003", "backendErrors.jdbc.operationCanceled"),
            (CatalogCode::BusyRetryLater, "Gauss Horizon-JDBC-3001", "backendErrors.jdbc.busyRetryLater"),
            (CatalogCode::RuntimeReplaced, "Gauss Horizon-JDBC-3002", "backendErrors.jdbc.runtimeReplaced"),
            (CatalogCode::SqlFailed, "Gauss Horizon-JDBC-4001", "backendErrors.jdbc.sqlFailed"),
            (CatalogCode::ProtocolFailed, "Gauss Horizon-JDBC-5001", "backendErrors.jdbc.protocolFailed"),
            (CatalogCode::ContractInvalid, "Gauss Horizon-JDBC-5002", "backendErrors.jdbc.contractInvalid"),
            (CatalogCode::JdbcLegacyFailure, "Gauss Horizon-JDBC-9001", "backendErrors.jdbc.legacyFailure"),
            (CatalogCode::LegacyBackend, "Gauss Horizon-LEGACY-0001", "backendErrors.legacy"),
        ];
    ...
    fn manual_transaction_session_expiry_is_retryable_before_execution() {
        ...
        assert_eq!(error.code(), "Gauss Horizon-TXN-1001");
    ...
    fn catalog_maps_valid_variants_and_emits_allowlisted_params() {
        let cases = [
            (
                ...
                AgentErrorStage::Request,
                AgentOperationOutcome::NotStarted,
                "Gauss Horizon-JDBC-1001",
            ),
            (
                AgentErrorCategory::Connection,
                AgentErrorStage::Execute,
                AgentOperationOutcome::Unknown,
                "Gauss Horizon-JDBC-1002",
            ),
            (
                AgentErrorCategory::Timeout,
                AgentErrorStage::Connect,
                AgentOperationOutcome::NotStarted,
                "Gauss Horizon-JDBC-2001",
            ),
            (
                AgentErrorCategory::Timeout,
                AgentErrorStage::Execute,
                AgentOperationOutcome::Unknown,
                "Gauss Horizon-JDBC-2002",
            ),
            (
                AgentErrorCategory::Canceled,
                AgentErrorStage::Cancel,
                AgentOperationOutcome::Unknown,
                "Gauss Horizon-JDBC-2003",
            ),
            (
                AgentErrorCategory::Resource,
                AgentErrorStage::Request,
                AgentOperationOutcome::NotStarted,
                "Gauss Horizon-JDBC-3001",
            ),
            (
                AgentErrorCategory::Resource,
                AgentErrorStage::Execute,
                AgentOperationOutcome::Unknown,
                "Gauss Horizon-JDBC-5002",
            ),
            (
                AgentErrorCategory::Sql,
                AgentErrorStage::Execute,
                AgentOperationOutcome::Unknown,
                "Gauss Horizon-JDBC-4001",
            ),
            (
        ...
        for (category, stage, outcome, expected_code) in cases {
            ...
            if expected_code != "Gauss Horizon-JDBC-5002" {
                assert_eq!(
    ...
    fn duckdb_worker_sql_error_preserves_worker_code_detail_and_driver_origin() {
        ...
        assert_eq!(payload["code"], "Gauss Horizon-JDBC-4001");
    ...
    fn invalid_structured_combinations_use_contract_catalog_code() {
        ...
        for (category, stage, outcome, disposition) in invalid {
            ...
            assert_eq!(envelope.code(), "Gauss Horizon-JDBC-5002");
    ...
    fn legacy_adapters_use_stable_sources() {
        ...
        assert_eq!(legacy.code(), "Gauss Horizon-JDBC-9001");
        assert_eq!(legacy.source, BackendErrorSource::JdbcAgentLegacy);
        assert_eq!(BackendError::from_legacy_backend("driver failed").code(), "Gauss Horizon-LEGACY-0001");
    }
    ...
    fn legacy_agent_envelope_keeps_multiline_database_detail() {
        let legacy = AgentCallError::Legacy {
            rpc_code: Some(-1),
            message: "ERROR: relation \"gauss_horizon_table_that_does_not_exist\" does not exist\n  Position: 15"
                .to_string(),
            hints: Default::default(),
        }
        .into_legacy_string();
        ...
        assert_eq!(error.code(), "Gauss Horizon-JDBC-9001");
        assert_eq!(
            error.detail(),
            Some("ERROR: relation \"gauss_horizon_table_that_does_not_exist\" does not exist\n  Position: 15")
        );
    }
    ...
    fn strict_marker_round_trip_keeps_catalog_code() {
        ...
        assert_eq!(BackendError::from_legacy_string(&legacy).code(), "Gauss Horizon-JDBC-1002");
    }
}
