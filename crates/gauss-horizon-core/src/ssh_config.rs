...
///
/// Jump hosts have no dedicated credentials field in Gauss Horizon's connection form,
...
mod tests {
    ...
    fn resolve_is_noop_when_host_does_not_match_any_alias() {
        ...
        let ssh = config("gauss-horizon-test-alias-that-should-never-exist-anywhere");
