...
//! ## Architecture
//! ```text
//! Gauss Horizon frontend (Vue)
//!     │ Tauri invoke
//!     ▼
//! src-tauri/src/commands/mqtt_cmd.rs  (Tauri command entry point)
//!     │
//!     ▼
//! crates/gauss-horizon-core/src/mqtt/service.rs  (shared core logic)
//!     │
//!     ▼
//! crates/gauss-horizon-core/src/mqtt/client.rs   (rumqttc client wrapper)
//!     │
//!     ▼
