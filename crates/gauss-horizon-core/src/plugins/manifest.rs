...
pub struct PluginEngines {
    #[serde(default, rename = "gauss-horizon")]
    pub gauss_horizon: String,
    #[serde(default)]
    pub host_api: String,
}
...
/// Native context-menu entry contributed to Gauss Horizon surfaces. v1 targets the
...
impl PluginManifest {
    ...
    pub fn compatibility(&self, plugin_dir: &Path, gauss_horizon_version: &str) -> PluginCompatibility {
        ...
        if self.manifest_version > 0 {
            ...
            validate_engine_requirement(
                "Gauss Horizon",
                &self.engines.gauss_horizon,
                gauss_horizon_version,
                &mut errors,
            );
...
mod tests {
    ...
    fn manifest_rejects_malformed_network_permissions() {
        ...
        let manifest: PluginManifest = serde_json::from_value(serde_json::json!({
            "manifest_version": 1,
            "id": "io.gauss.horizon.example",
            "name": "Example",
            "version": "1.0.0",
            "publisher": "example",
            "engines": { "gauss-horizon": ">=0.1.0", "host_api": "^1.0" },
    ...
    fn validates_manifest_v1_and_resolves_package_executable() {
        ...
        let manifest: PluginManifest = serde_json::from_value(serde_json::json!({
            ...
            "contributions": [{
                ...
                "id": "io.gauss.horizon.example.connection",
    ...
    fn rejects_obsolete_ui_kind_declaration() {
        ...
        let backend_error = serde_json::from_value::<PluginManifest>(serde_json::json!({
            "manifest_version": 1,
            "id": "io.gauss.horizon.backend-protocol",
            "name": "Backend protocol",
            "version": "1.0.0",
            "publisher": "example",
            "engines": { "gauss-horizon": ">=0.1.0", "host_api": "^1.0" },
            "entrypoints": { "backend": { "protocol": "gauss-horizon-jsonrpc", "executable": "bin/plugin" } }
        }))
        .unwrap_err();
    ...
    fn rejects_unknown_v1_top_level_fields_without_breaking_legacy_manifests() {
        ...
        let manifest: PluginManifest = serde_json::from_value(serde_json::json!({
            "manifest_version": 1,
            "id": "io.gauss.horizon.unknown-field",
            "name": "Unknown field",
            "version": "1.0.0",
            "publisher": "example",
            "engines": { "gauss-horizon": ">=0.1.0", "host_api": "^1.0" },
    ...
    fn rejects_legacy_runtime_declarations_in_manifest_v1() {
        ...
        let manifest: PluginManifest = serde_json::from_value(serde_json::json!({
            "manifest_version": 1,
            "id": "io.gauss.horizon.mixed-contract",
            "name": "Mixed contract",
            "version": "1.0.0",
            "publisher": "example",
            "engines": { "gauss-horizon": ">=0.1.0", "host_api": "^1.0" },
    ...
    fn legacy_manifest_remains_readable() {
        ...
        assert_eq!(manifest.backend_entrypoint().unwrap().executable, "bin/gauss-horizon-jdbc-plugin");
    }
    ...
    fn accepts_supported_connection_field_bindings() {
        ...
        let manifest: PluginManifest = serde_json::from_value(serde_json::json!({
            "manifest_version": 1,
            "id": "io.gauss.horizon.connection-bindings",
    ...
    fn rejects_unknown_connection_field_binding() {
        let error = serde_json::from_value::<PluginManifest>(serde_json::json!({
            "manifest_version": 1,
            "id": "io.gauss.horizon.invalid-binding",
    ...
    fn rejects_incompatible_field_defaults_and_missing_provider_references() {
        ...
        let manifest: PluginManifest = serde_json::from_value(serde_json::json!({
            "manifest_version": 1,
            "id": "io.gauss.horizon.invalid-contract",
    ...
    fn rejects_invalid_filesystem_root_and_missing_reference() {
        ...
        let manifest: PluginManifest = serde_json::from_value(serde_json::json!({
            "manifest_version": 1,
            "id": "io.gauss.horizon.invalid-files",
            "name": "Invalid files",
            "version": "1.0.0",
            "publisher": "example",
            "engines": { "gauss-horizon": ">=0.1.0", "host_api": "^1.0" },
