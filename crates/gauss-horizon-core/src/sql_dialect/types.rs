...
pub const GAUSS_HORIZON_ROWID_COLUMN: &str = "__GAUSS_HORIZON_ROWID";
pub const GAUSS_HORIZON_NEO4J_ELEMENT_ID_COLUMN: &str = "__GAUSS_HORIZON_ELEMENT_ID";
pub const GAUSS_HORIZON_TDENGINE_TBNAME_COLUMN: &str = "tbname";
