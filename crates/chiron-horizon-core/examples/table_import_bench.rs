...
Usage:\n  cargo run -p chiron-horizon-core --example table_import_bench --release -- [options]\n\n\
...
async fn run() -> Result<(), String> {
    ...
    let temp_dir = std::env::temp_dir().join(format!("chiron-horizon-table-import-bench-{}", uuid::Uuid::new_v4()));
