// ============================================================================
// 12.4 — CLI/Tauri/chiron-horizon-web API Contract Verification
//
...
use chiron_horizon_core::data_compare::{DataComparePreparation, DataCompareSyncPlan};
use chiron_horizon_core::models::connection::DatabaseType;
use chiron_horizon_core::schema_diff::{prepare_schema_diff, SchemaDiffPreparation, SchemaDiffPreparationOptions};
use chiron_horizon_core::sql_risk::{classify_sql_risk, SqlRisk};
use chiron_horizon_core::types::{ColumnInfo, TableInfo};
...
fn generate_schema_sync_sql_function_signature() {
    let _sql = chiron_horizon_core::schema_diff::generate_schema_sync_sql(
        &[],
        &[],
        &[],
        &[],
...
fn data_compare_preparation_field_names() {
    use chiron_horizon_core::data_compare::{DataCompareResult, DataCompareRow};
...
fn table_columns_result_serialization_contract() {
    use chiron_horizon_core::db::TableColumnsResult;
