...
use chiron_horizon_core::types::ColumnInfo;
...
#[tokio::test]
#[ignore = "requires CHIRON_HORIZON_LIVE_MYSQL_GENERATED_URL and CHIRON_HORIZON_LIVE_MYSQL_GENERATED_DATABASE"]
async fn live_mysql_generated_column_metadata_and_alter_preserve_expression() {
    let url = chiron_horizon_core::legacy::var("CHIRON_HORIZON_LIVE_MYSQL_GENERATED_URL")
        .expect("CHIRON_HORIZON_LIVE_MYSQL_GENERATED_URL");
    let database = chiron_horizon_core::legacy::var("CHIRON_HORIZON_LIVE_MYSQL_GENERATED_DATABASE")
        .expect("CHIRON_HORIZON_LIVE_MYSQL_GENERATED_DATABASE");
    let table = format!("chiron_horizon_generated_{}", uuid::Uuid::new_v4().simple());
