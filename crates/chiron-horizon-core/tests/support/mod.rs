...
pub struct DockerPostgres {
    ...
    /// provided via `CHIRON_HORIZON_TEST_POSTGRES_CONTAINER` (see
...
///
/// If `CHIRON_HORIZON_TEST_POSTGRES_CONTAINER`/`CHIRON_HORIZON_TEST_POSTGRES_PORT` are set, reuses
...
pub fn start_docker_postgres_with_server_args(name_prefix: &str, server_args: &[&str]) -> Option<DockerPostgres> {
    if let Ok(name) = chiron_horizon_core::legacy::var("CHIRON_HORIZON_TEST_POSTGRES_CONTAINER") {
        let port = chiron_horizon_core::legacy::var("CHIRON_HORIZON_TEST_POSTGRES_PORT")
            .expect("CHIRON_HORIZON_TEST_POSTGRES_PORT must accompany CHIRON_HORIZON_TEST_POSTGRES_CONTAINER")
            .parse()
            .expect("CHIRON_HORIZON_TEST_POSTGRES_PORT must be a valid port");
