...
mod tests {
    ...
    fn serializes_kv_get_put_delete_params() {
        ...
        assert_eq!(
            kv_put_params(
                "/app/name",
                KvValue { encoding: KvValueEncoding::Utf8, data: "chiron-horizon".to_string() },
                Some(42),
            ),
            serde_json::json!({
                "key": "/app/name",
    ...
    fn serializes_kv_put_options_without_changing_default_shape() {
        let value = KvValue { encoding: KvValueEncoding::Utf8, data: "chiron-horizon".to_string() };
        assert_eq!(
    ...
    fn serializes_etcd_range_and_cas_options_losslessly() {
        ...
        assert_eq!(
            ...
            serde_json::json!({
                "key": "/app/name",
                "value": { "encoding": "utf8", "data": "chiron-horizon" },
    ...
    async fn sends_credentials_only_to_the_configured_etcd_origin() {
        ...
        let server = tokio::spawn(async move {
            ...
            assert!(request
                .lines()
                .any(|line| line.eq_ignore_ascii_case("Authorization: Basic Z2F1c3MtaG9yaXpvbjpzZWNyZXQ=")));
        ...
        let metrics = collect_etcd_prometheus_metrics(&EtcdMetricsConnectionOptions {
            ...
            username: "chiron-horizon".to_string(),
