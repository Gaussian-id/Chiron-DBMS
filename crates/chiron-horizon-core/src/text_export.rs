...
"#
    ...
    html.push_str(&format!(
        "      <div class=\"meta\">{} rows &middot; {} columns &middot; {} &middot; Chiron Horizon</div>\n",
        row_count,
        col_count,
        html_escape(&now)
    ));
    ...
    html.push_str("          </tbody>\n        </table>\n      </div>\n    </div>\n");
    html.push_str("    <div class=\"ftr\">Exported by Chiron Horizon</div>\n");
    html.push_str("  </div>\n</body>\n</html>\n");
    html
}
...
mod tests {
            ...
            r#"[
  {
    ...
    fn formats_html_document_structure() {
        ...
        assert!(out.contains("Exported by Chiron Horizon"), "footer watermark");
    }
