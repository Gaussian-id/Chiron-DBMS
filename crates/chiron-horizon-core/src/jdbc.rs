...
const JDBC_PLUGIN_DOWNLOAD_URL: &str =
    "https://github.com/Gaussian-id/Chiron-Horizon/releases/download/v0.1.3/chiron-horizon-jdbc-plugin-0.1.3.zip";
...
/// desktop updater is disabled in 0.1.3, so normal status checks supply no
