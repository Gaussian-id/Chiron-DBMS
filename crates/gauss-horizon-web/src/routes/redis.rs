...
use gauss_horizon_core::db::redis_driver::RedisKeysExpiryResult;
...
pub async fn list_databases(
    ...
    let result = gauss_horizon_core::redis_ops::redis_list_databases_core(&state.app, &req.connection_id)
        .await
...
pub async fn scan_keys(
    ...
    let result = gauss_horizon_core::redis_ops::redis_scan_keys_core(
        &state.app,
        &req.connection_id,
        req.db,
        req.cursor,
...
pub async fn scan_keys_batch(
    ...
    let result = gauss_horizon_core::redis_ops::redis_scan_keys_batch_core(
        &state.app,
        &req.connection_id,
        req.db,
        req.cursor,
...
pub async fn scan_values(
    ...
    let result = gauss_horizon_core::redis_ops::redis_scan_values_core(
        &state.app,
        &req.connection_id,
        req.db,
        req.cursor,
...
pub async fn get_value(
    ...
    let result =
        gauss_horizon_core::redis_ops::redis_get_value_in_db_core(&state.app, &req.connection_id, req.db, &req.key_raw)
            .await
            .map_err(AppError::from)?;
    Ok(Json(serde_json::to_value(result).map_err(|e| AppError::from(e.to_string()))?))
}
...
pub async fn get_ttl(
    ...
    let ttl =
        gauss_horizon_core::redis_ops::redis_get_ttl_in_db_core(&state.app, &req.connection_id, req.db, &req.key_raw)
            .await
            .map_err(AppError::from)?;
    Ok(Json(ttl))
}
...
pub async fn get_stream_entries(
    ...
    let result = gauss_horizon_core::redis_ops::redis_stream_entries_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raw,
...
pub async fn get_stream_groups(
    ...
    let result = gauss_horizon_core::redis_ops::redis_stream_groups_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raw,
...
pub async fn get_stream_consumers(
    ...
    let result = gauss_horizon_core::redis_ops::redis_stream_consumers_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raw,
...
pub async fn get_stream_pending(
    ...
    let result = gauss_horizon_core::redis_ops::redis_stream_pending_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raw,
...
pub async fn load_more(
    ...
    let result = gauss_horizon_core::redis_ops::redis_load_more_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raw,
...
pub async fn set_string(
    ...
    gauss_horizon_core::redis_ops::redis_set_string_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raw,
...
pub async fn delete_key(
    ...
    gauss_horizon_core::redis_ops::redis_delete_key_in_db_core(&state.app, &req.connection_id, req.db, &req.key_raw)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn rename_key(
    ...
    gauss_horizon_core::redis_ops::redis_rename_key_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raw,
...
pub async fn hash_set(
    ...
    gauss_horizon_core::redis_ops::redis_hash_set_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raw,
...
pub async fn hash_del(
    ...
    gauss_horizon_core::redis_ops::redis_hash_del_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raw,
...
pub async fn list_push(
    ...
    let value = req.value.as_deref().unwrap_or("");
    gauss_horizon_core::redis_ops::redis_list_push_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raw,
...
pub async fn list_set(
    ...
    let value = req.value.as_deref().unwrap_or("");
    gauss_horizon_core::redis_ops::redis_list_set_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raw,
...
pub async fn list_remove(
    ...
    let index = req.index.unwrap_or(0);
    gauss_horizon_core::redis_ops::redis_list_remove_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raw,
...
pub async fn set_add(
    ...
    gauss_horizon_core::redis_ops::redis_set_add_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raw,
...
pub async fn set_remove(
    ...
    gauss_horizon_core::redis_ops::redis_set_remove_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raw,
...
pub async fn zadd(State(state): State<Arc<WebState>>, Json(req): Json<RedisZaddRequest>) -> Result<Json<()>, AppError> {
    ...
    gauss_horizon_core::redis_ops::redis_zadd_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raw,
...
pub async fn zset_update(
    ...
    let used_acl_compatibility = gauss_horizon_core::redis_ops::redis_zset_update_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raw,
...
pub async fn json_set(
    ...
    gauss_horizon_core::redis_ops::redis_json_set_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raw,
...
pub async fn check_json_module(
    ...
    let result =
        gauss_horizon_core::redis_ops::redis_check_json_module_in_db_core(&state.app, &req.connection_id, req.db)
            .await
            .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn set_ttl(
    ...
    gauss_horizon_core::redis_ops::redis_set_ttl_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raw,
...
pub async fn set_expire_at(
    ...
    gauss_horizon_core::redis_ops::redis_set_expire_at_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raw,
...
pub async fn set_keys_ttl(
    ...
    ensure_writable(&state.app, &req.connection_id, "EXPIRE").await?;
    let result = gauss_horizon_core::redis_ops::redis_set_keys_ttl_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raws,
...
pub async fn set_keys_expire_at(
    ...
    ensure_writable(&state.app, &req.connection_id, "EXPIREAT").await?;
    let result = gauss_horizon_core::redis_ops::redis_set_keys_expire_at_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raws,
...
pub async fn delete_keys(
    ...
    let result = gauss_horizon_core::redis_ops::redis_delete_keys_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raws,
...
pub async fn flush_db(
    ...
    gauss_horizon_core::redis_ops::redis_flush_db_core(&state.app, &req.connection_id, req.db)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn execute_command(
    ...
    let argv = gauss_horizon_core::db::redis_driver::parse_command_argv(&req.command)
    ...
    let centrally_approved_high_risk =
        is_mcp_request && safety == gauss_horizon_core::db::redis_driver::RedisCommandSafety::Blocked;
    ...
    if let Some(name) = gauss_horizon_core::query::connection_readonly_name(&state.app, &req.connection_id).await {
        if safety != gauss_horizon_core::db::redis_driver::RedisCommandSafety::Allowed {
            return Err(AppError::from(format!(
    ...
    let result = gauss_horizon_core::redis_ops::redis_execute_command_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.command,
...
pub async fn publish_message(
    ...
    let count = gauss_horizon_core::redis_ops::redis_publish_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.channel,
...
pub async fn slowlog_get(
    ...
    let result = gauss_horizon_core::redis_ops::redis_slowlog_get_core(
        &state.app,
        &req.connection_id,
        req.count,
        req.node_host,
...
pub async fn cluster_master_nodes(
    ...
    let result = gauss_horizon_core::redis_ops::redis_cluster_master_nodes_core(&state.app, &req.connection_id)
        .await
        .map_err(AppError::from)?;
    Ok(Json(serde_json::to_value(result).map_err(|e| AppError::from(e.to_string()))?))
}
