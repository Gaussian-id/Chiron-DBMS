...
pub struct EtcdListPrefixRequest {
    ...
    pub revision: Option<gauss_horizon_core::agent_kv::KvInt64>,
...
pub struct EtcdKeyRequest {
    pub connection_id: String,
    pub key: String,
    pub key_bytes: Option<gauss_horizon_core::agent_kv::KvValue>,
    pub revision: Option<gauss_horizon_core::agent_kv::KvInt64>,
    pub metadata_only: Option<bool>,
    pub expected_mod_revision: Option<gauss_horizon_core::agent_kv::KvInt64>,
}
...
pub struct EtcdPutRequest {
    ...
    pub lease: Option<gauss_horizon_core::agent_kv::KvInt64>,
    pub ttl: Option<i64>,
    pub preserve_lease: Option<bool>,
    pub key_bytes: Option<gauss_horizon_core::agent_kv::KvValue>,
    pub expected_mod_revision: Option<gauss_horizon_core::agent_kv::KvInt64>,
    pub expected_create_revision: Option<gauss_horizon_core::agent_kv::KvInt64>,
}
...
pub async fn supports_ttl(
    ...
    Ok(Json(
        gauss_horizon_core::agent_kv::kv_supports_ttl_core(&state.app, &req.connection_id)
            .await
...
pub struct EtcdRenameRequest {
    pub connection_id: String,
    pub request: gauss_horizon_core::agent_kv::KvRenameRequest,
}
...
pub struct EtcdHistoryRequest {
    pub connection_id: String,
    pub request: gauss_horizon_core::agent_kv::KvHistoryRequest,
}
...
pub async fn list_prefix(
    ...
    let result = gauss_horizon_core::agent_kv::kv_list_prefix_core_with_range_options(
        &state.app,
        &req.connection_id,
        &req.prefix,
        req.limit,
        req.continuation.as_deref(),
        gauss_horizon_core::agent_kv::KvRangeOptions { revision: req.revision, include_values: req.include_values },
    )
    .await
    .map_err(AppError::from)?;
    Ok(Json(result))
...
pub async fn get(
    ...
    let result = gauss_horizon_core::agent_kv::kv_get_core_with_options(
        &state.app,
        &req.connection_id,
        &req.key,
        gauss_horizon_core::agent_kv::KvGetOptions {
...
pub async fn put(
    ...
    let result = gauss_horizon_core::agent_kv::kv_put_core_with_options(
        ...
        &req.key,
        req.value,
        gauss_horizon_core::agent_kv::KvPutOptions {
            lease: req.lease,
            ttl: req.ttl,
            ...
            ..gauss_horizon_core::agent_kv::KvPutOptions::default()
        },
    )
    .await
    .map_err(AppError::from)?;
...
pub async fn delete(
    ...
    let result = gauss_horizon_core::agent_kv::kv_delete_core_with_options(
        &state.app,
        &req.connection_id,
        &req.key,
        gauss_horizon_core::agent_kv::KvDeleteOptions {
            key_bytes: req.key_bytes,
            expected_mod_revision: req.expected_mod_revision,
        },
    )
...
) -> Result<Json<gauss_horizon_core::agent_kv::KvRenameResponse>, AppError> {
    ensure_writable(&state.app, &req.connection_id, "Rename").await?;
    let result = gauss_horizon_core::agent_kv::kv_rename_core(&state.app, &req.connection_id, req.request)
        .await
        .map_err(AppError::from)?;
    Ok(Json(result))
}
...
) -> Result<Json<gauss_horizon_core::agent_kv::KvHistoryResponse>, AppError> {
    let result = gauss_horizon_core::agent_kv::kv_history_core(&state.app, &req.connection_id, req.request)
        .await
        .map_err(AppError::from)?;
    Ok(Json(result))
}
...
) -> Result<Json<gauss_horizon_core::agent_kv::KvStatusResponse>, AppError> {
    let result =
        gauss_horizon_core::agent_kv::kv_status_core(&state.app, &req.connection_id).await.map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub struct EtcdCompactRequest {
    pub connection_id: String,
    pub revision: gauss_horizon_core::agent_kv::KvInt64,
...
pub struct EtcdWatchStartRouteRequest {
    pub connection_id: String,
    pub request: gauss_horizon_core::agent_kv::EtcdWatchStartRequest,
}
#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
...
pub struct EtcdPreflightRouteRequest {
    pub connection_id: String,
    pub request: gauss_horizon_core::agent_kv::EtcdPreflightRequest,
}

pub async fn preflight(
    State(state): State<Arc<WebState>>,
    Json(req): Json<EtcdPreflightRouteRequest>,
) -> Result<Json<gauss_horizon_core::agent_kv::EtcdPreflightResponse>, AppError> {
    ensure_writable(&state.app, &req.connection_id, "Dangerous etcd operation").await?;
    Ok(Json(
        gauss_horizon_core::agent_kv::etcd_preflight_core(&state.app, &req.connection_id, req.request)
            .await
            .map_err(AppError::from)?,
    ))
}
...
pub async fn compact(
    ...
    .map_err(AppError::from)?;
    Ok(Json(
        gauss_horizon_core::agent_kv::etcd_compact_core(&state.app, &req.connection_id, req.revision)
            .await
            .map_err(AppError::from)?,
    ))
}
...
pub async fn defrag(
...
) -> Result<Json<gauss_horizon_core::agent_kv::EtcdDefragResponse>, AppError> {
    ...
    .map_err(AppError::from)?;
    Ok(Json(
        gauss_horizon_core::agent_kv::etcd_defrag_core(&state.app, &req.connection_id, req.endpoints)
            .await
            .map_err(AppError::from)?,
    ))
}
...
) -> Result<Json<gauss_horizon_core::agent_kv::EtcdWatchStartResponse>, AppError> {
    Ok(Json(
        gauss_horizon_core::agent_kv::etcd_watch_start_core(&state.app, &req.connection_id, req.request)
            .await
            .map_err(AppError::from)?,
    ))
}
...
) -> Result<Json<gauss_horizon_core::agent_kv::EtcdWatchPollResponse>, AppError> {
    Ok(Json(
        gauss_horizon_core::agent_kv::etcd_watch_poll_core(&state.app, &req.connection_id, &req.watch_id)
            .await
            .map_err(AppError::from)?,
    ))
}
pub async fn watch_stop(
    ...
    Ok(Json(
        gauss_horizon_core::agent_kv::etcd_watch_stop_core(&state.app, &req.connection_id, &req.watch_id)
            .await
            .map_err(AppError::from)?,
    ))
}
...
) -> Result<Json<gauss_horizon_core::agent_kv::EtcdLeaseListResponse>, AppError> {
    Ok(Json(
...
pub async fn lease_call(
    ...
    Ok(Json(
        gauss_horizon_core::agent_kv::etcd_lease_call_core(&state.app, &req.connection_id, method, req.params)
            .await
            .map_err(AppError::from)?,
    ))
}
pub async fn auth_call(
    ...
    Ok(Json(
        gauss_horizon_core::agent_kv::etcd_auth_call_core(&state.app, &req.connection_id, method, req.params)
            .await
            .map_err(AppError::from)?,
    ))
}
