...
pub struct ExecuteQueryRequest {
    ...
    pub execution_mode: Option<gauss_horizon_core::query::QueryExecutionMode>,
}
...
pub struct FindStatementAtCursorRequest {
    ...
    pub database_type: Option<gauss_horizon_core::models::connection::DatabaseType>,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct PrepareQueryPaginationExecutionPlanRequest {
    pub options: gauss_horizon_core::query_result_sql::QueryPaginationExecutionPlanOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildSortedQuerySqlRequest {
    pub options: gauss_horizon_core::query_result_sql::SortedQuerySqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildExplainSqlRequest {
    pub options: gauss_horizon_core::query_execution_sql::ExplainSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDroppedFilePreviewSqlRequest {
    pub options: gauss_horizon_core::query_execution_sql::DroppedFilePreviewSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildTableSelectSqlRequest {
    pub options: gauss_horizon_core::sql_dialect::TableDataSelectSqlOptions,
    #[serde(default)]
...
pub struct BuildDatabaseSearchSqlRequest {
    pub options: gauss_horizon_core::database_search_sql::DatabaseSearchSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildSearchResultWhereRequest {
    pub options: gauss_horizon_core::database_search_sql::SearchResultWhereOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildRenameObjectSqlRequest {
    pub options: gauss_horizon_core::db_admin_sql::RenameObjectSqlOptions,
}
...
pub struct BuildCreateDatabaseSqlRequest {
    pub options: gauss_horizon_core::db_admin_sql::CreateDatabaseSqlOptions,
}
...
pub struct BuildDuckDbAttachDatabaseSqlRequest {
    pub options: gauss_horizon_core::db_admin_sql::DuckDbAttachDatabaseSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildSqliteAttachDatabaseSqlRequest {
    pub options: gauss_horizon_core::db_admin_sql::SqliteAttachDatabaseSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDropObjectSqlRequest {
    pub options: gauss_horizon_core::db_admin_sql::DropObjectSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildTableAdminSqlRequest {
    pub options: gauss_horizon_core::db_admin_sql::TableAdminSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildVacuumTableSqlRequest {
    pub options: gauss_horizon_core::db_admin_sql::VacuumTableSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildMysqlAutoIncrementSqlRequest {
    pub options: gauss_horizon_core::db_admin_sql::MysqlAutoIncrementSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDropTableChildObjectSqlRequest {
    pub options: gauss_horizon_core::db_admin_sql::DropTableChildObjectSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDatabaseNameSqlRequest {
    pub options: gauss_horizon_core::db_admin_sql::DatabaseNameSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildSchemaNameSqlRequest {
    pub options: gauss_horizon_core::db_admin_sql::SchemaNameSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDatabasePropertyEditSqlRequest {
    pub options: gauss_horizon_core::db_admin_sql::DatabasePropertyEditSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDuplicateTableStructureSqlRequest {
    pub options: gauss_horizon_core::db_admin_sql::DuplicateTableStructureSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildCopyTableDataSqlRequest {
    pub options: gauss_horizon_core::db_admin_sql::CopyTableDataSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildExecutableObjectSourceRequest {
    pub input: gauss_horizon_core::object_source_sql::EditableObjectSourceSqlInput,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildRoutineRenameObjectSourceRequest {
    pub input: gauss_horizon_core::object_source_sql::RoutineRenameObjectSourceInput,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildViewDdlRequest {
    pub input: gauss_horizon_core::object_source_sql::BuildViewDdlInput,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildTableStructureSqlRequest {
    pub options: gauss_horizon_core::table_structure_sql::TableStructureSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildTableOwnerChangeSqlRequest {
    pub options: gauss_horizon_core::table_structure_sql::TableOwnerChangeSqlOptions,
}
...
pub struct BuildSingleColumnAlterSqlRequest {
    pub options: gauss_horizon_core::table_structure_sql::SingleColumnAlterSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct PrepareDataGridSaveRequest {
    pub options: gauss_horizon_core::data_grid_sql::DataGridSaveStatementOptions,
    #[serde(default)]
...
pub struct ExtractDataGridSelectionRequest {
    pub request: gauss_horizon_core::data_grid_extractors::DataGridExtractRequest,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDataGridCopyUpdateStatementsRequest {
    pub options: gauss_horizon_core::data_grid_sql::DataGridCopyUpdateStatementOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDataGridCopyInsertStatementRequest {
    pub options: gauss_horizon_core::data_grid_sql::DataGridCopyInsertStatementOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDmlChangePreviewSqlRequest {
    pub options: gauss_horizon_core::dml_preview_sql::DmlChangePreviewSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDataGridContextFilterConditionRequest {
    pub options: gauss_horizon_core::data_grid_sql::DataGridContextFilterConditionOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDataGridColumnValueFilterConditionRequest {
    pub options: gauss_horizon_core::data_grid_sql::DataGridColumnValueFilterConditionOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDataGridColumnValuesFilterConditionRequest {
    pub options: gauss_horizon_core::data_grid_sql::DataGridColumnValuesFilterConditionOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDataGridColumnDistinctValuesSqlRequest {
    pub options: gauss_horizon_core::data_grid_sql::DataGridColumnDistinctValuesSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDataGridCountSqlRequest {
    pub options: gauss_horizon_core::data_grid_sql::DataGridCountSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDataGridConditionalUpdateSqlRequest {
    pub options: gauss_horizon_core::data_grid_sql::DataGridConditionalUpdateSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildHiveTablePropertiesSqlRequest {
    pub options: gauss_horizon_core::data_grid_sql::HiveTablePropertiesSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildExportInsertStatementsRequest {
    pub options: gauss_horizon_core::database_export::BuildExportInsertStatementsOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildExportSqlInsertRequest {
    pub options: gauss_horizon_core::database_export::BuildExportSqlInsertOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDatabaseSqlExportRequest {
    pub options: gauss_horizon_core::database_export::BuildDatabaseSqlExportOptions,
}
...
) -> Result<Json<gauss_horizon_core::db::QueryResult>, AppError> {
...
pub async fn execute_conditional_update(
    ...
    let cancel_token = registered.token();
    let response_timeout = gauss_horizon_core::query::query_timeout_duration(req.timeout_secs);
        ...
        Some(timeout) => match tokio::time::timeout(timeout, result_rx).await {
            ...
            Err(_) => {
                return Err(AppError::from(
                    gauss_horizon_core::query::QueryExecutionError::Timeout(format!(
...
pub async fn execute_multi(
    ...
    let result = gauss_horizon_core::query::execute_multi_core_with_options_for_client_typed(
        &state.app,
        &req.connection_id,
        &database,
        &req.sql,
...
fn execute_multi_response(
    result: Vec<gauss_horizon_core::query::ExecuteMultiResult>,
    core_ms: u128,
) -> Result<Response, AppError> {
...
pub async fn execute_batch(
    ...
    let result = gauss_horizon_core::query::execute_statements(
        &state.app,
        &req.connection_id,
        &database,
        &req.statements,
...
pub async fn cancel_conditional_update(
    State(state): State<Arc<WebState>>,
    Json(req): Json<CancelRequest>,
) -> Json<gauss_horizon_core::query_cancel::CancellationWaitResult> {
...
pub async fn close_query_session(
    ...
    let closed = gauss_horizon_core::query::close_query_session(
        &state.app,
        &req.connection_id,
        &req.database,
        &req.session_id,
...
pub async fn execute_script(
    ...
    let statements = db_type
        .map(|db_type| gauss_horizon_core::sql::split_sql_statements_for_database(&req.sql, db_type))
        .unwrap_or_else(|| gauss_horizon_core::sql::split_sql_statements(&req.sql));
    let result = gauss_horizon_core::query::execute_statements(
        &state.app,
        &req.connection_id,
        &req.database,
...
pub async fn execute_in_transaction(
    ...
    let result = gauss_horizon_core::query::execute_statements_in_transaction(
        &state.app,
        &req.connection_id,
        &req.database,
        &req.statements,
...
pub async fn execute_script_with_2pc(
    State(state): State<Arc<WebState>>,
    Json(req): Json<ExecuteBatchRequest>,
) -> Result<Json<gauss_horizon_core::query::SchemaDiffDeployResult>, AppError> {
    ...
    let result = gauss_horizon_core::query::execute_schema_diff_deploy(
        &state.app,
        &req.connection_id,
        &req.database,
        &req.statements,
...
fn schema_diff_deploy_may_have_changed_schema(result: &gauss_horizon_core::query::SchemaDiffDeployResult) -> bool {
...
) -> Result<Json<gauss_horizon_core::sql_analysis::SqlReferenceAnalysis>, AppError> {
    gauss_horizon_core::sql_analysis::analyze_sql_references(&req.sql, req.dialect.as_deref())
        .map(Json)
        .map_err(AppError::from)
}
...
pub async fn find_statement_at_cursor(Json(req): Json<FindStatementAtCursorRequest>) -> Json<String> {
    Json(
        req.database_type
            .map(|db_type| {
                gauss_horizon_core::sql::find_statement_at_cursor_for_database(&req.sql, req.cursor_pos, db_type)
            })
            .unwrap_or_else(|| gauss_horizon_core::sql::find_statement_at_cursor(&req.sql, req.cursor_pos)),
    )
}

pub async fn prepare_query_pagination_execution_plan(
    Json(req): Json<PrepareQueryPaginationExecutionPlanRequest>,
) -> Json<gauss_horizon_core::query_result_sql::QueryPaginationExecutionPlan> {
    Json(gauss_horizon_core::query_result_sql::build_query_pagination_execution_plan(req.options))
}

pub async fn build_sorted_query_sql(
    Json(req): Json<BuildSortedQuerySqlRequest>,
) -> Json<gauss_horizon_core::query_result_sql::QuerySqlBuildResult> {
    Json(gauss_horizon_core::query_result_sql::build_sorted_query_sql(req.options))
}

pub async fn build_explain_sql(
    Json(req): Json<BuildExplainSqlRequest>,
) -> Json<gauss_horizon_core::query_execution_sql::ExplainSqlBuildResult> {
    Json(gauss_horizon_core::query_execution_sql::build_explain_sql(req.options))
}
...
pub async fn get_explain_info(
    ...
    let plan = gauss_horizon_core::agent_explain::get_agent_explain_info_core(
        &state.app,
        &req.connection_id,
...
pub async fn build_create_user_sql(Json(req): Json<BuildCreateUserSqlRequest>) -> Result<Json<String>, AppError> {
    Ok(Json(gauss_horizon_core::db_admin_sql::build_create_user_sql(&req.username, &req.password, &req.tablespace)))
}

pub async fn build_dropped_file_preview_sql(
    Json(req): Json<BuildDroppedFilePreviewSqlRequest>,
) -> Json<Option<String>> {
    Json(gauss_horizon_core::query_execution_sql::build_dropped_file_preview_sql(req.options))
}

pub async fn build_table_select_sql(Json(req): Json<BuildTableSelectSqlRequest>) -> Json<String> {
    Json(gauss_horizon_core::sql_dialect::build_table_data_select_sql_with_database(
        req.options,
...
) -> Json<Option<gauss_horizon_core::database_search_sql::DatabaseSearchSql>> {
    Json(gauss_horizon_core::database_search_sql::build_database_search_sql(req.options))
}

pub async fn build_search_result_where(Json(req): Json<BuildSearchResultWhereRequest>) -> Json<String> {
    Json(gauss_horizon_core::database_search_sql::build_search_result_where(req.options))
}

pub async fn build_rename_object_sql(Json(req): Json<BuildRenameObjectSqlRequest>) -> Result<Json<String>, AppError> {
    gauss_horizon_core::db_admin_sql::build_rename_object_sql(req.options).map(Json).map_err(AppError::from)
}
...
pub async fn build_rename_database_preflight_sql(
    ...
    gauss_horizon_core::db_admin_sql::build_rename_database_preflight_sql(req.database_type, &req.database_name)
        .map(Json)
        .map_err(AppError::from)
}
...
pub async fn build_executable_object_source_sql(
    ...
    gauss_horizon_core::object_source_sql::build_executable_object_source_sql(req.input)
        .map(Json)
        .map_err(AppError::from)
}

pub async fn build_editable_object_source(Json(req): Json<BuildExecutableObjectSourceRequest>) -> Json<String> {
    Json(gauss_horizon_core::object_source_sql::build_editable_object_source(req.input))
}

pub async fn build_routine_rename_object_source_statements(
    Json(req): Json<BuildRoutineRenameObjectSourceRequest>,
) -> Result<Json<Vec<String>>, AppError> {
    gauss_horizon_core::object_source_sql::build_routine_rename_object_source_statements(req.input)
        .map(Json)
        .map_err(AppError::from)
}

pub async fn build_view_ddl_sql(Json(req): Json<BuildViewDdlRequest>) -> Json<String> {
    Json(gauss_horizon_core::object_source_sql::build_view_ddl_sql(req.input))
}

pub async fn build_table_structure_change_sql(
    Json(req): Json<BuildTableStructureSqlRequest>,
) -> Json<gauss_horizon_core::table_structure_sql::TableStructureSqlResult> {
    Json(gauss_horizon_core::table_structure_sql::build_table_structure_change_sql(req.options))
}

pub async fn build_table_owner_change_sql(
    Json(req): Json<BuildTableOwnerChangeSqlRequest>,
) -> Json<gauss_horizon_core::table_structure_sql::TableStructureSqlResult> {
    Json(gauss_horizon_core::table_structure_sql::build_table_owner_change_sql(req.options))
}

pub async fn preview_sqlite_table_structure_change(
    State(state): State<Arc<WebState>>,
    Json(req): Json<PreviewSqliteTableStructureChangeRequest>,
) -> Result<Json<gauss_horizon_core::table_structure_sql::SqliteTableStructurePreview>, AppError> {
...
pub async fn build_create_table_sql(
    ...
    Json(gauss_horizon_core::table_structure_sql::build_create_table_sql(req.options))
}

pub async fn build_single_column_alter_sql(
    Json(req): Json<BuildSingleColumnAlterSqlRequest>,
) -> Json<gauss_horizon_core::table_structure_sql::TableStructureSqlResult> {
    Json(gauss_horizon_core::table_structure_sql::build_single_column_alter_sql(req.options))
}

pub async fn analyze_editable_query_editability(
    Json(req): Json<AnalyzeEditableQueryRequest>,
) -> Json<gauss_horizon_core::sql_editability::QueryEditability> {
    Json(gauss_horizon_core::sql_editability::analyze_editable_query_editability(&req.sql))
}

pub async fn prepare_data_grid_save(
    Json(req): Json<PrepareDataGridSaveRequest>,
) -> Json<gauss_horizon_core::data_grid_sql::DataGridSavePreparation> {
    Json(gauss_horizon_core::data_grid_sql::prepare_data_grid_save_for_driver_profile(
        req.options,
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Selection extracted successfully", body = gauss_horizon_core::data_grid_extractors::DataGridExtractResult),
        (status = 400, description = "Invalid selection or extractor configuration", body = gauss_horizon_core::data_grid_extractors::DataGridExtractError),
        ...
        (status = 500, description = "Extractor worker failed", body = gauss_horizon_core::data_grid_extractors::DataGridExtractError)
    ),
    tag = "data-grid"
)]
pub async fn extract_data_grid_selection(
    ...
    Json<gauss_horizon_core::data_grid_extractors::DataGridExtractResult>,
    (axum::http::StatusCode, Json<gauss_horizon_core::data_grid_extractors::DataGridExtractError>),
> {
    tokio::task::spawn_blocking(move || {
        gauss_horizon_core::data_grid_extractors::extract_data_grid_selection(req.request)
    })
    .await
    .map_err(|error| {
        let error = gauss_horizon_core::data_grid_extractors::DataGridExtractError::new(
...
pub async fn build_data_grid_copy_update_statements(
    ...
    Json(gauss_horizon_core::data_grid_sql::build_data_grid_copy_update_statements(req.options))
}

pub async fn build_data_grid_copy_insert_statement(
    Json(req): Json<BuildDataGridCopyInsertStatementRequest>,
) -> Json<Option<String>> {
    Json(gauss_horizon_core::data_grid_sql::build_data_grid_copy_insert_statement(req.options))
}

pub async fn build_dml_change_preview_sql(
    Json(req): Json<BuildDmlChangePreviewSqlRequest>,
) -> Result<Json<gauss_horizon_core::dml_preview_sql::DmlChangePreviewSqlResult>, (axum::http::StatusCode, Json<String>)>
{
    gauss_horizon_core::dml_preview_sql::build_dml_change_preview_sql(req.options)
        .map(Json)
...
pub async fn build_database_sql_export(
    ...
    gauss_horizon_core::database_export::build_database_sql_export(options).map(Json).map_err(AppError::from)
}
...
mod tests {
    ...
    async fn test_web_state() -> (Arc<WebState>, std::path::PathBuf) {
        let dir = std::env::temp_dir().join(format!("gauss-horizon-web-query-test-{}", uuid::Uuid::new_v4()));
    ...
    fn deploy_result(status: &str, statement_count: usize) -> gauss_horizon_core::query::SchemaDiffDeployResult {
    ...
    async fn execute_multi_response_preserves_nested_original_error_detail() {
        let result = gauss_horizon_core::query::ExecuteMultiResult {
            ...
            error: Some(gauss_horizon_core::backend_error::BackendError::from_sql_detail(
        ...
        assert_eq!(response.headers()["x-gauss-horizon-core-ms"], "17");
        assert!(response.headers()["x-gauss-horizon-serialize-ms"].to_str().unwrap().parse::<u128>().is_ok());
        ...
        assert_eq!(payload[0]["error"]["code"], "Gauss Horizon-JDBC-4001");
