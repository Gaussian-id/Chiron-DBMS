...
//!
//! Mirrors the desktop command layer, sharing the same `gauss_horizon_core::mq::service::*_core`
...
async fn ensure_writable(
    ...
    if let Some(name) = gauss_horizon_core::query::connection_readonly_name(app, conn_id).await {
...
) -> Result<Json<gauss_horizon_core::mq::MqClusterInfo>, AppError> {
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result = gauss_horizon_core::mq::service::mq_test_connection_core(&state.app, &req.connection_id)
        .await
...
pub async fn list_tenants(
    ...
    headers: HeaderMap,
    Json(req): Json<ConnReq>,
) -> Result<Json<Vec<gauss_horizon_core::mq::TenantInfo>>, AppError> {
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result = gauss_horizon_core::mq::service::mq_list_tenants_core(&state.app, &req.connection_id)
        .await
        .map_err(AppError::from)?;
    Ok(Json(result))
}
...
) -> Result<Json<gauss_horizon_core::mq::TenantInfo>, AppError> {
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result = gauss_horizon_core::mq::service::mq_get_tenant_core(&state.app, &req.connection_id, &req.name)
        .await
        .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn create_tenant(
    ...
    gauss_horizon_core::mq::service::mq_create_tenant_core(&state.app, &req.connection_id, &req.name, req.config)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn update_tenant(
    ...
    gauss_horizon_core::mq::service::mq_update_tenant_core(&state.app, &req.connection_id, &req.name, req.config)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn delete_tenant(
    ...
    gauss_horizon_core::mq::service::mq_delete_tenant_core(&state.app, &req.connection_id, &req.name, req.force)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
) -> Result<Json<Vec<gauss_horizon_core::mq::NamespaceInfo>>, AppError> {
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result = gauss_horizon_core::mq::service::mq_list_namespaces_core(&state.app, &req.connection_id, &req.tenant)
        .await
        .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn create_namespace(
    ...
    gauss_horizon_core::mq::service::mq_create_namespace_core(&state.app, &req.connection_id, req.ns, req.config)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn delete_namespace(
    ...
    gauss_horizon_core::mq::service::mq_delete_namespace_core(&state.app, &req.connection_id, req.ns, req.force)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn get_namespace_policies(
    ...
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result =
        gauss_horizon_core::mq::service::mq_get_namespace_policies_core(&state.app, &req.connection_id, req.ns)
            .await
            .map_err(AppError::from)?;
    Ok(Json(result))
}
...
) -> Result<Json<Vec<gauss_horizon_core::mq::TopicInfo>>, AppError> {
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result = gauss_horizon_core::mq::service::mq_list_topics_core(&state.app, &req.connection_id, req.ns, req.opts)
        .await
        .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn create_topic(
    ...
    gauss_horizon_core::mq::service::mq_create_topic_core(&state.app, &req.connection_id, req.topic, req.partitions)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn delete_topic(
    ...
    gauss_horizon_core::mq::service::mq_delete_topic_core(&state.app, &req.connection_id, req.topic, req.force)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn update_partitions(
    ...
    gauss_horizon_core::mq::service::mq_update_partitions_core(
        &state.app,
        &req.connection_id,
        req.topic,
        req.partitions,
...
) -> Result<Json<gauss_horizon_core::mq::TopicStats>, AppError> {
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result = gauss_horizon_core::mq::service::mq_get_topic_stats_core(&state.app, &req.connection_id, req.topic)
        .await
        .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn get_topic_internal_stats(
    ...
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result =
        gauss_horizon_core::mq::service::mq_get_topic_internal_stats_core(&state.app, &req.connection_id, req.topic)
            .await
            .map_err(AppError::from)?;
    Ok(Json(result))
}
...
) -> Result<Json<Vec<gauss_horizon_core::mq::MqExchangeInfo>>, AppError> {
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result = gauss_horizon_core::mq::service::mq_list_exchanges_core(&state.app, &req.connection_id, req.ns)
        .await
...
pub async fn delete_exchange(
    ...
    gauss_horizon_core::mq::service::mq_delete_exchange_core(&state.app, &req.connection_id, req.ns, &req.name)
        .await
        .map_err(AppError::internal)?;
    Ok(Json(()))
}
...
) -> Result<Json<Vec<gauss_horizon_core::mq::MqBindingInfo>>, AppError> {
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result = gauss_horizon_core::mq::service::mq_list_bindings_core(
        &state.app,
        &req.connection_id,
        req.ns,
        req.exchange,
...
pub async fn bind_queue(
    ...
    gauss_horizon_core::mq::service::mq_bind_core(&state.app, &req.connection_id, req.ns, req.binding)
        .await
        .map_err(AppError::internal)?;
    Ok(Json(()))
}
...
pub async fn unbind_queue(
    ...
    gauss_horizon_core::mq::service::mq_unbind_core(&state.app, &req.connection_id, req.ns, req.binding)
        .await
        .map_err(AppError::internal)?;
    Ok(Json(()))
}
...
pub async fn list_subscriptions(
    ...
    headers: HeaderMap,
    Json(req): Json<TopicReq>,
) -> Result<Json<Vec<gauss_horizon_core::mq::SubscriptionInfo>>, AppError> {
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result = gauss_horizon_core::mq::service::mq_list_subscriptions_core(&state.app, &req.connection_id, req.topic)
        .await
        .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn enrich_subscriptions(
    ...
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result =
        gauss_horizon_core::mq::service::mq_enrich_subscriptions_core(&state.app, &req.connection_id, req.topic)
            .await
            .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn get_kafka_consumer_group_snapshot(
    ...
    headers: HeaderMap,
    Json(req): Json<ConnReq>,
) -> Result<Json<gauss_horizon_core::mq::KafkaConsumerGroupSnapshot>, AppError> {
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result =
        gauss_horizon_core::mq::service::mq_get_kafka_consumer_group_snapshot_core(&state.app, &req.connection_id)
            .await
            .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn create_subscription(
    ...
    gauss_horizon_core::mq::service::mq_create_subscription_core(
        &state.app,
        &req.connection_id,
        req.topic,
        req.sub,
...
pub async fn delete_subscription(
    ...
    gauss_horizon_core::mq::service::mq_delete_subscription_core(
        &state.app,
        &req.connection_id,
        req.topic,
        req.sub,
...
pub async fn skip_messages(
    ...
    gauss_horizon_core::mq::service::mq_skip_messages_core(
        &state.app,
        &req.connection_id,
        req.topic,
        req.sub,
...
pub async fn reset_cursor(
    ...
    gauss_horizon_core::mq::service::mq_reset_cursor_core(&state.app, &req.connection_id, req.topic, req.sub, req.pos)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn clear_backlog(
    ...
    gauss_horizon_core::mq::service::mq_clear_backlog_core(&state.app, &req.connection_id, req.topic, req.sub)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn get_consumer_group_config(
    ...
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result = gauss_horizon_core::mq::service::mq_get_consumer_group_config_core(
        &state.app,
        &req.connection_id,
        req.group_id,
    )
...
pub async fn alter_consumer_group_config(
    ...
    gauss_horizon_core::mq::service::mq_alter_consumer_group_config_core(
        &state.app,
        &req.connection_id,
        req.group_id,
        req.config,
...
) -> Result<Json<gauss_horizon_core::mq::PeekMessagesResult>, AppError> {
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result = gauss_horizon_core::mq::service::mq_peek_messages_core(
        &state.app,
        &req.connection_id,
        req.topic,
        req.sub,
...
pub async fn expire_messages(
    ...
    gauss_horizon_core::mq::service::mq_expire_messages_core(
        &state.app,
        &req.connection_id,
        req.topic,
        req.sub,
...
pub async fn list_producers(
    ...
    headers: HeaderMap,
    Json(req): Json<TopicReq>,
) -> Result<Json<Vec<gauss_horizon_core::mq::ProducerInfo>>, AppError> {
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result = gauss_horizon_core::mq::service::mq_list_producers_core(&state.app, &req.connection_id, req.topic)
        .await
        .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn list_consumers(
    ...
    headers: HeaderMap,
    Json(req): Json<SubscriptionReq>,
) -> Result<Json<Vec<gauss_horizon_core::mq::ConsumerInfo>>, AppError> {
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result =
        gauss_horizon_core::mq::service::mq_list_consumers_core(&state.app, &req.connection_id, req.topic, req.sub)
            .await
            .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn unload_topic(
    ...
    gauss_horizon_core::mq::service::mq_unload_topic_core(&state.app, &req.connection_id, req.topic)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
) -> Result<Json<Vec<gauss_horizon_core::mq::MqClientConnectionInfo>>, AppError> {
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result =
        gauss_horizon_core::mq::service::mq_list_client_connections_core(&state.app, &req.connection_id, req.ns)
            .await
            .map_err(AppError::internal)?;
    Ok(Json(result))
}
...
) -> Result<Json<Vec<gauss_horizon_core::mq::MqChannelInfo>>, AppError> {
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result = gauss_horizon_core::mq::service::mq_list_client_channels_core(
        &state.app,
        &req.connection_id,
        req.ns,
        req.connection,
...
pub async fn close_client_connection(
    ...
    gauss_horizon_core::mq::service::mq_close_client_connection_core(&state.app, &req.connection_id, req.ns, &req.name)
        .await
        .map_err(AppError::internal)?;
    Ok(Json(()))
}
...
pub async fn set_publish_rate(
    ...
    gauss_horizon_core::mq::service::mq_set_publish_rate_core(&state.app, &req.connection_id, req.scope, req.rate)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn set_dispatch_rate(
    ...
    gauss_horizon_core::mq::service::mq_set_dispatch_rate_core(&state.app, &req.connection_id, req.scope, req.rate)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn set_subscribe_rate(
    ...
    gauss_horizon_core::mq::service::mq_set_subscribe_rate_core(&state.app, &req.connection_id, req.scope, req.rate)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn set_backlog_quota(
    ...
    gauss_horizon_core::mq::service::mq_set_backlog_quota_core(&state.app, &req.connection_id, req.scope, req.quota)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn set_retention(
    ...
    gauss_horizon_core::mq::service::mq_set_retention_core(&state.app, &req.connection_id, req.scope, req.retention)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn get_effective_policies(
    ...
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result =
        gauss_horizon_core::mq::service::mq_get_effective_policies_core(&state.app, &req.connection_id, req.scope)
            .await
            .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn grant_permission(
    ...
    gauss_horizon_core::mq::service::mq_grant_permission_core(
        &state.app,
        &req.connection_id,
        req.scope,
        req.role,
...
pub async fn revoke_permission(
    ...
    gauss_horizon_core::mq::service::mq_revoke_permission_core(&state.app, &req.connection_id, req.scope, req.role)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn list_permissions(
    ...
    headers: HeaderMap,
    Json(req): Json<PolicyScopeReq>,
) -> Result<Json<gauss_horizon_core::mq::PermissionMap>, AppError> {
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result = gauss_horizon_core::mq::service::mq_list_permissions_core(&state.app, &req.connection_id, req.scope)
        .await
        .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn list_users(
    ...
    headers: HeaderMap,
    Json(req): Json<ConnReq>,
) -> Result<Json<Vec<gauss_horizon_core::mq::MqUserInfo>>, AppError> {
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result = gauss_horizon_core::mq::service::mq_list_users_core(&state.app, &req.connection_id)
        .await
        .map_err(AppError::internal)?;
    Ok(Json(result))
}
...
pub async fn delete_user(
    ...
    gauss_horizon_core::mq::service::mq_delete_user_core(&state.app, &req.connection_id, &req.name)
        .await
        .map_err(AppError::internal)?;
    Ok(Json(()))
}
...
) -> Result<Json<Vec<gauss_horizon_core::mq::MqVhostPermission>>, AppError> {
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let ns = user_permission_ns(req.virtual_host, req.all_vhosts);
    let mut permissions =
        gauss_horizon_core::mq::service::mq_list_user_permissions_core(&state.app, &req.connection_id, ns)
            .await
            .map_err(AppError::internal)?;
...
pub async fn revoke_user_permission(
    ...
    let ns = user_permission_ns(Some(req.virtual_host), None);
    gauss_horizon_core::mq::service::mq_revoke_user_permission_core(&state.app, &req.connection_id, ns, &req.user)
        .await
        .map_err(AppError::internal)?;
    Ok(Json(()))
}
...
) -> Result<Json<Vec<gauss_horizon_core::mq::MqPolicyInfo>>, AppError> {
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let ns = user_permission_ns(req.virtual_host, req.all_vhosts);
    let result = gauss_horizon_core::mq::service::mq_list_policies_core(&state.app, &req.connection_id, ns)
        .await
        .map_err(AppError::internal)?;
    Ok(Json(result))
}
...
pub async fn set_policy(
    ...
    gauss_horizon_core::mq::service::mq_set_policy_core(&state.app, &req.connection_id, ns, policy)
        .await
        .map_err(AppError::internal)?;
    Ok(Json(()))
}
...
pub async fn delete_policy(
    ...
    let ns = user_permission_ns(Some(req.virtual_host), None);
    gauss_horizon_core::mq::service::mq_delete_policy_core(&state.app, &req.connection_id, ns, &req.name)
        .await
        .map_err(AppError::internal)?;
    Ok(Json(()))
}
...
pub async fn get_overview(
    ...
    headers: HeaderMap,
    Json(req): Json<ConnReq>,
) -> Result<Json<gauss_horizon_core::mq::MqOverviewInfo>, AppError> {
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result = gauss_horizon_core::mq::service::mq_get_overview_core(&state.app, &req.connection_id)
        .await
        .map_err(AppError::internal)?;
    Ok(Json(result))
}
...
pub async fn list_nodes(
    ...
    headers: HeaderMap,
    Json(req): Json<ConnReq>,
) -> Result<Json<Vec<gauss_horizon_core::mq::MqNodeInfo>>, AppError> {
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result = gauss_horizon_core::mq::service::mq_list_nodes_core(&state.app, &req.connection_id)
        .await
        .map_err(AppError::internal)?;
    Ok(Json(result))
}
...
pub async fn issue_token(
...
) -> Result<Json<gauss_horizon_core::mq::MqIssuedToken>, AppError> {
    ...
    let result = gauss_horizon_core::mq::service::mq_issue_token_core(&state.app, &req.connection_id, req.req)
        .await
        .map_err(AppError::from)?;
    Ok(Json(result))
}
...
) -> Result<Json<Vec<gauss_horizon_core::mq::MqTokenRecord>>, AppError> {
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result =
        gauss_horizon_core::mq::service::mq_list_token_records_core(&state.app, &req.connection_id, req.subject)
            .await
            .map_err(AppError::from)?;
    Ok(Json(result))
}
...
) -> Result<Json<gauss_horizon_core::mq::BacklogStats>, AppError> {
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result =
        gauss_horizon_core::mq::service::mq_get_backlog_core(&state.app, &req.connection_id, req.topic, req.sub)
            .await
            .map_err(AppError::from)?;
    Ok(Json(result))
}
...
) -> Result<Json<gauss_horizon_core::mq::ClusterInfo>, AppError> {
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result = gauss_horizon_core::mq::service::mq_get_cluster_info_core(&state.app, &req.connection_id)
        .await
        .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn get_topic_route(
    ...
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result = gauss_horizon_core::mq::service::mq_get_topic_route_core(&state.app, &req.connection_id, req.topic)
        .await
        .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn alter_topic_config(
    ...
    gauss_horizon_core::mq::service::mq_alter_topic_config_core(&state.app, &req.connection_id, req.topic, req.configs)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn skip_topic_accumulation(
    ...
    let result =
        gauss_horizon_core::mq::service::mq_skip_topic_accumulation_core(&state.app, &req.connection_id, req.topic)
            .await
            .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn view_message(
    ...
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result =
        gauss_horizon_core::mq::service::mq_view_message_core(&state.app, &req.connection_id, req.topic, req.msg_id)
            .await
            .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn query_messages_by_key(
    ...
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result = gauss_horizon_core::mq::service::mq_query_messages_by_key_core(
        &state.app,
        &req.connection_id,
        req.topic,
        req.key,
...
pub async fn query_messages_by_topic(
    ...
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result = gauss_horizon_core::mq::service::mq_query_messages_by_topic_core(
        &state.app,
        &req.connection_id,
        req.topic,
        req.begin,
...
pub async fn query_message_trace(
    ...
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let result = gauss_horizon_core::mq::service::mq_query_message_trace_core(
        &state.app,
        &req.connection_id,
        req.msg_id,
        req.trace_topic,
...
pub async fn raw_request(
...
) -> Result<Json<gauss_horizon_core::mq::MqRawResponse>, AppError> {
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    ...
    let result = gauss_horizon_core::mq::service::mq_raw_request_core(&state.app, &req.connection_id, req.req)
        .await
        .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn send_message(
...
) -> Result<Json<gauss_horizon_core::mq::SendMessageResponse>, AppError> {
    ...
    let result = gauss_horizon_core::mq::service::mq_send_message_core(&state.app, &req.connection_id, req.req)
        .await
        .map_err(AppError::from)?;
    Ok(Json(result))
}
...
mod tests {
    ...
    use gauss_horizon_core::storage::{McpGlobalPolicy, Storage};
    ...
    async fn test_web_state() -> (Arc<WebState>, std::path::PathBuf) {
        let dir = std::env::temp_dir().join(format!("gauss-horizon-web-mq-policy-test-{}", uuid::Uuid::new_v4()));
    ...
    fn mcp_headers() -> HeaderMap {
        ...
        headers.insert("x-gauss-horizon-mcp-request", HeaderValue::from_static("1"));
        headers
    }
    ...
    fn exchange_req(connection_id: &str) -> CreateExchangeReq {
        CreateExchangeReq {
            ...
            ns: gauss_horizon_core::mq::NamespaceRef { tenant: "_rabbitmq".to_string(), namespace: "/".to_string() },
            name: "demo".to_string(),
