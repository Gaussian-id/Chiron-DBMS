use gauss_horizon_core::db::ssh_prompt::{SshHostKeyNotice, SshPromptAnswer, SshPromptEnvelope, SshPromptRequest};
use serde::Serialize;
...
pub fn install_web_ssh_prompt_bridge(hub: Arc<SshPromptHub>) {
    ...
    gauss_horizon_core::db::ssh_prompt::install_ssh_prompt_gateway(prompt_tx);
    ...
    gauss_horizon_core::db::ssh_prompt::install_ssh_notice_gateway(notice_tx);
