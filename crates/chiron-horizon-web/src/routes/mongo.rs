...
) -> Result<Json<chiron_horizon_core::mongo_shell::MongoCommand>, AppError> {
    chiron_horizon_core::mongo_shell::parse(&req.source).map(Json).map_err(AppError::from)
}
...
pub async fn list_databases(
    ...
    let result = chiron_horizon_core::mongo_ops::mongo_list_databases_core(&state.app, &req.connection_id)
        .await
...
pub async fn list_collections(
    ...
    let result = chiron_horizon_core::mongo_ops::mongo_list_collections_core(&state.app, &req.connection_id, &database)
        .await
        .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn create_database(
    ...
    chiron_horizon_core::mongo_ops::mongo_create_database_core(&state.app, &req.connection_id, &req.database)
        .await
        .map_err(AppError::from)?;
...
pub async fn drop_database(
    ...
    chiron_horizon_core::mongo_ops::mongo_drop_database_core(&state.app, &req.connection_id, &database)
        .await
        .map_err(AppError::from)?;
    Ok(Json(serde_json::json!({ "ok": true })))
}
...
pub async fn drop_collection(
    ...
    chiron_horizon_core::mongo_ops::mongo_drop_collection_core(
        &state.app,
        &req.connection_id,
        &database,
        &req.collection,
...
pub async fn clone_collection(
...
) -> Result<Json<chiron_horizon_core::db::mongo_driver::MongoCloneCollectionResult>, AppError> {
    let database = super::mcp_policy::resolve_database(&state, &headers, &req.connection_id, &req.database).await?;
    ...
    let result = chiron_horizon_core::mongo_ops::mongo_clone_collection_core(
        &state.app,
        &req.connection_id,
        &database,
...
pub async fn explain_find(
    ...
    let result = run_cancellable(
        &state,
        req.execution_id.clone(),
        chiron_horizon_core::mongo_ops::mongo_explain_find_core(
            &state.app,
            &req.connection_id,
            &database,
            &req.collection,
...
pub async fn server_version(
    ...
    let result = run_cancellable(
        &state,
        req.execution_id.clone(),
        chiron_horizon_core::mongo_ops::mongo_server_version_core(&state.app, &req.connection_id, &database),
    )
    .await?;
    Ok(Json(serde_json::to_value(result).map_err(|e| AppError::from(e.to_string()))?))
}
...
pub async fn list_index_specs(
    ...
    headers: HeaderMap,
    Json(req): Json<MongoCollectionNameRequest>,
) -> Result<Json<Vec<chiron_horizon_core::db::mongo_driver::MongoIndexSpec>>, AppError> {
    super::mcp_policy::ensure_scope(&state, &headers, &req.connection_id).await?;
    let database = super::mcp_policy::resolve_database(&state, &headers, &req.connection_id, &req.database).await?;
    let result = chiron_horizon_core::mongo_ops::mongo_list_index_specs_core(
        &state.app,
        &req.connection_id,
        &database,
        &req.collection,
...
pub async fn run_command(
    ...
    let result = run_cancellable(
        &state,
        req.execution_id.clone(),
        chiron_horizon_core::mongo_ops::mongo_run_command_core(
            &state.app,
            &req.connection_id,
            &database,
            &req.command_json,
...
pub async fn drop_indexes(
    ...
    let result = chiron_horizon_core::mongo_ops::mongo_drop_indexes_core(
        &state.app,
        &req.connection_id,
        &database,
        &req.collection,
...
pub async fn insert_document(
    ...
    let result = chiron_horizon_core::document_ops::insert_document_core(
        &state.app,
        &req.connection_id,
        &req.database,
        &req.collection,
...
pub async fn insert_documents(
    ...
    ensure_writable(&state.app, &req.connection_id, "Insert").await?;
    let result = chiron_horizon_core::mongo_ops::mongo_insert_documents_core(
        &state.app,
        &req.connection_id,
        &database,
        &req.collection,
...
pub async fn update_documents(
    ...
    ensure_writable(&state.app, &req.connection_id, "Update").await?;
    let result = chiron_horizon_core::mongo_ops::mongo_update_documents_core(
        &state.app,
        &req.connection_id,
        &database,
        &req.collection,
...
pub async fn replace_document(
    ...
    let result = chiron_horizon_core::mongo_ops::mongo_replace_document_core(
        &state.app,
        &req.connection_id,
        &database,
        &req.collection,
...
pub async fn bulk_write(
...
) -> Result<Json<chiron_horizon_core::db::mongo_driver::MongoBulkWriteResult>, AppError> {
    let database = super::mcp_policy::resolve_database(&state, &headers, &req.connection_id, &req.database).await?;
    let command = chiron_horizon_core::mongo_shell::MongoCommand::BulkWrite {
    ...
    let result = chiron_horizon_core::mongo_ops::mongo_bulk_write_core(
        &state.app,
        &req.connection_id,
        &database,
        &req.collection,
...
pub async fn find_one_and_update(
    ...
    ensure_writable(&state.app, &req.connection_id, "Update").await?;
    let result = chiron_horizon_core::mongo_ops::mongo_find_one_and_update_core(
        &state.app,
        &req.connection_id,
        &database,
        &req.collection,
...
pub async fn find_one_and_replace(
    ...
    ensure_writable(&state.app, &req.connection_id, "Update").await?;
    let result = chiron_horizon_core::mongo_ops::mongo_find_one_and_replace_core(
        &state.app,
        &req.connection_id,
        &database,
        &req.collection,
...
pub async fn find_one_and_delete(
    ...
    let result = chiron_horizon_core::mongo_ops::mongo_find_one_and_delete_core(
        &state.app,
        &req.connection_id,
        &database,
        &req.collection,
...
pub async fn delete_document(
    ...
    ensure_writable(&state.app, &req.connection_id, "Delete").await?;
    let result = chiron_horizon_core::document_ops::delete_document_core(
        &state.app,
        &req.connection_id,
        &req.database,
        &req.collection,
...
pub async fn delete_documents(
    ...
    ensure_writable(&state.app, &req.connection_id, "Delete").await?;
    let result = chiron_horizon_core::mongo_ops::mongo_delete_documents_core(
        &state.app,
        &req.connection_id,
        &database,
        &req.collection,
