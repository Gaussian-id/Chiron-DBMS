    ...
    F: Future<Output = Result<T, String>>,
{
    ...
    if let Some(query) = registered.as_ref() {
        ...
        tokio::select! {
            biased;
            _ = token.cancelled() => Err(AppError::from(chiron_horizon_core::query::canceled_error())),
...
pub struct ElasticsearchIndexMetadataRequest {
    pub connection_id: String,
    pub index: String,
    pub kind: chiron_horizon_core::document_ops::ElasticsearchIndexMetadataKind,
}
...
pub struct MeilisearchBatchSaveRequest {
    pub connection_id: String,
    pub collection: String,
    pub updates: Vec<chiron_horizon_core::db::meilisearch_driver::MeilisearchDocumentUpdate>,
...
pub struct MeilisearchKeyCreateRequest {
    pub connection_id: String,
    pub input: chiron_horizon_core::db::meilisearch_driver::MeilisearchKeyCreateInput,
}
...
pub struct MeilisearchKeyUpdateRequest {
    pub connection_id: String,
    pub uid: String,
    pub input: chiron_horizon_core::db::meilisearch_driver::MeilisearchKeyUpdateInput,
}
...
pub struct MeilisearchTaskListRequest {
    pub connection_id: String,
    pub input: chiron_horizon_core::db::meilisearch_driver::MeilisearchTaskListInput,
}
...
pub struct MeilisearchTaskMutationRequest {
    pub connection_id: String,
    pub selector: chiron_horizon_core::db::meilisearch_driver::MeilisearchTaskSelector,
}
...
pub async fn list_databases(
    ...
    let result = chiron_horizon_core::document_ops::list_databases_core(&state.app, &req.connection_id)
        .await
...
) -> Result<Json<Vec<chiron_horizon_core::document_ops::CollectionInfo>>, AppError> {
    let result =
        chiron_horizon_core::document_ops::list_collections_core(&state.app, &req.connection_id, &req.database)
            .await
            .map_err(AppError::from)?;
    Ok(Json(result))
}
...
) -> Result<Json<chiron_horizon_core::db::document_result::DocumentQueryResult>, AppError> {
...
) -> Result<Json<chiron_horizon_core::db::dynamodb_driver::DynamoDbTableDescription>, AppError> {
    let result =
        chiron_horizon_core::document_ops::describe_dynamodb_table_core(&state.app, &req.connection_id, &req.table)
            .await
            .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn elasticsearch_get_index_metadata(
    ...
    let result = chiron_horizon_core::document_ops::elasticsearch_get_index_metadata_core(
        &state.app,
        &req.connection_id,
        &req.index,
        req.kind,
...
) -> Result<Json<chiron_horizon_core::db::elasticsearch_driver::ElasticsearchDeleteByQueryResult>, AppError> {
    ensure_writable(&state.app, &req.connection_id, "Delete all documents").await?;
    let result = chiron_horizon_core::document_ops::elasticsearch_delete_all_documents_core(
        &state.app,
        &req.connection_id,
        &req.index,
    )
...
pub async fn update_document(
    ...
    let result = chiron_horizon_core::document_ops::update_document_core(
        &state.app,
        &req.connection_id,
        &req.database,
        &req.collection,
...
pub async fn delete_document(
    ...
    let result = chiron_horizon_core::document_ops::delete_document_core_with_type(
        &state.app,
        &req.connection_id,
        &req.database,
        &req.collection,
...
pub async fn save_meilisearch_batch(
    ...
    let result = chiron_horizon_core::document_ops::save_meilisearch_document_batch_core(
        &state.app,
        &req.connection_id,
        &req.collection,
        &req.updates,
...
) -> Result<Json<chiron_horizon_core::db::meilisearch_driver::MeilisearchSearchResult>, AppError> {
    let result = chiron_horizon_core::document_ops::meilisearch_search_documents_core(
        &state.app,
        &req.connection_id,
        &req.index,
        req.q.as_deref(),
...
) -> Result<Json<chiron_horizon_core::db::meilisearch_driver::MeilisearchDocumentPage>, AppError> {
    let result = chiron_horizon_core::document_ops::meilisearch_fetch_document_page_core(
        &state.app,
        &req.connection_id,
        &req.index,
        req.filter.as_deref(),
...
pub async fn meilisearch_get_document(
    ...
    let result = chiron_horizon_core::document_ops::meilisearch_get_document_core(
        &state.app,
        &req.connection_id,
        &req.index,
        &req.id,
...
pub async fn meilisearch_get_settings(
    ...
    let result = chiron_horizon_core::document_ops::meilisearch_get_index_settings_core(
        &state.app,
        &req.connection_id,
        &req.index,
    )
...
pub async fn meilisearch_update_settings(
    ...
    chiron_horizon_core::document_ops::meilisearch_update_index_settings_core(
        &state.app,
        &req.connection_id,
        &req.index,
        &req.settings,
...
pub async fn meilisearch_get_stats(
    ...
    let result =
        chiron_horizon_core::document_ops::meilisearch_get_index_stats_core(&state.app, &req.connection_id, &req.index)
            .await
            .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn meilisearch_get_overview(
    State(state): State<Arc<WebState>>,
    Json(req): Json<MeilisearchIndexRequest>,
) -> Result<Json<chiron_horizon_core::db::meilisearch_driver::MeilisearchIndexOverview>, AppError> {
    let result = chiron_horizon_core::document_ops::meilisearch_get_index_overview_core(
        &state.app,
        &req.connection_id,
        &req.index,
    )
...
pub async fn meilisearch_delete_index(
    ...
    chiron_horizon_core::document_ops::meilisearch_delete_index_core(&state.app, &req.connection_id, &req.index)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn meilisearch_delete_all_documents(
    ...
    ensure_writable(&state.app, &req.connection_id, "Delete all documents").await?;
    chiron_horizon_core::document_ops::meilisearch_delete_all_documents_core(
        &state.app,
        &req.connection_id,
        &req.index,
    )
...
) -> Result<Json<chiron_horizon_core::db::meilisearch_driver::MeilisearchSystemOverview>, AppError> {
    let result =
        chiron_horizon_core::document_ops::meilisearch_get_system_overview_core(&state.app, &req.connection_id)
            .await
            .map_err(AppError::from)?;
    Ok(Json(result))
}
...
) -> Result<Json<chiron_horizon_core::db::meilisearch_driver::MeilisearchKeyPage>, AppError> {
    let result = chiron_horizon_core::document_ops::meilisearch_list_keys_core(
        &state.app,
        &req.connection_id,
...
) -> Result<Json<chiron_horizon_core::db::meilisearch_driver::MeilisearchKeyListItem>, AppError> {
    let result = chiron_horizon_core::document_ops::meilisearch_get_key_core(&state.app, &req.connection_id, &req.uid)
        .await
        .map_err(AppError::from)?;
    Ok(Json(result))
}
...
) -> Result<Json<chiron_horizon_core::db::meilisearch_driver::MeilisearchCreatedKey>, AppError> {
    ensure_writable(&state.app, &req.connection_id, "Create API key").await?;
    let result =
        chiron_horizon_core::document_ops::meilisearch_create_key_core(&state.app, &req.connection_id, &req.input)
            .await
            .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn meilisearch_update_key(
    ...
    let result = chiron_horizon_core::document_ops::meilisearch_update_key_core(
        &state.app,
        &req.connection_id,
        &req.uid,
        &req.input,
...
pub async fn meilisearch_delete_key(
    ...
    chiron_horizon_core::document_ops::meilisearch_delete_key_core(&state.app, &req.connection_id, &req.uid)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
) -> Result<Json<chiron_horizon_core::db::meilisearch_driver::MeilisearchTaskPage>, AppError> {
    let result = chiron_horizon_core::document_ops::meilisearch_get_tasks_core(
        &state.app,
        &req.connection_id,
        &req.input.selector,
        req.input.from,
...
) -> Result<Json<chiron_horizon_core::db::meilisearch_driver::MeilisearchTask>, AppError> {
    let result = chiron_horizon_core::document_ops::meilisearch_get_task_core(
        &state.app,
        &req.connection_id,
        req.uid,
...
) -> Result<Json<chiron_horizon_core::db::meilisearch_driver::MeilisearchEnqueuedTaskSummary>, AppError> {
    ensure_writable(&state.app, &req.connection_id, "Cancel tasks").await?;
    let result =
        chiron_horizon_core::document_ops::meilisearch_cancel_tasks_core(&state.app, &req.connection_id, &req.selector)
            .await
            .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn meilisearch_delete_tasks(
    ...
    let result =
        chiron_horizon_core::document_ops::meilisearch_delete_tasks_core(&state.app, &req.connection_id, &req.selector)
            .await
            .map_err(AppError::from)?;
    Ok(Json(result))
}
...
) -> Result<Json<Vec<chiron_horizon_core::document_ops::MongoGridFsFileInfo>>, AppError> {
    let result = chiron_horizon_core::document_ops::list_gridfs_files_core(
        &state.app,
        &req.connection_id,
        &req.database,
        &req.bucket,
...
) -> Result<Json<Vec<chiron_horizon_core::document_ops::MongoGridFsBucketInfo>>, AppError> {
    let result = chiron_horizon_core::document_ops::list_gridfs_buckets_core(
        &state.app,
        &req.connection_id,
        &req.database,
        req.filter.as_deref(),
...
pub async fn create_gridfs_bucket(
    ...
    chiron_horizon_core::document_ops::create_gridfs_bucket_core(
        &state.app,
        &req.connection_id,
        &req.database,
        &req.bucket,
...
pub async fn delete_gridfs_bucket(
    ...
    chiron_horizon_core::document_ops::delete_gridfs_bucket_core(
        &state.app,
        &req.connection_id,
        &req.database,
        &req.bucket,
...
pub async fn download_gridfs_file(
    ...
    let result = chiron_horizon_core::document_ops::download_gridfs_file_core(
        &state.app,
        &req.connection_id,
        &req.database,
        &req.bucket,
...
pub async fn upload_gridfs_file(
    ...
    let result = chiron_horizon_core::document_ops::upload_gridfs_file_core(
        &state.app,
        &connection_id,
        &database,
        &bucket,
...
pub async fn delete_gridfs_file(
    ...
    chiron_horizon_core::document_ops::delete_gridfs_file_core(
        &state.app,
        &req.connection_id,
        &req.database,
        &req.bucket,
