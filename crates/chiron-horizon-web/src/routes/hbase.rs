...
pub async fn get_table_schema(
    ...
    let result = chiron_horizon_core::hbase_ops::get_table_schema_core(
        &state.app,
...
pub async fn scan_rows(
    ...
    let result = chiron_horizon_core::hbase_ops::scan_rows_core(
        &state.app,
        &request.connection_id,
        &request.namespace,
        &request.table,
...
pub async fn get_row(
    ...
    let result = chiron_horizon_core::hbase_ops::get_row_core(
        &state.app,
        &request.connection_id,
        &request.namespace,
        &request.table,
...
pub async fn put_row(
    ...
    chiron_horizon_core::hbase_ops::put_row_core(
        &state.app,
        &request.connection_id,
        &request.namespace,
        &request.table,
...
pub async fn create_table(
    ...
    chiron_horizon_core::hbase_ops::create_table_core(
        &state.app,
        &request.connection_id,
        &request.namespace,
        &request.table,
...
pub async fn delete_table(
    ...
    chiron_horizon_core::hbase_ops::delete_table_core(
        &state.app,
        &request.connection_id,
        &request.namespace,
        &request.table,
