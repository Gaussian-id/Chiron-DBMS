...
) -> Result<Json<chiron_horizon_core::nacos::NacosConnectionInfo>, AppError> {
    let result = chiron_horizon_core::nacos::service::nacos_test_connection_core(
        &state.app,
        &req.connection_id,
        req.force_refresh,
    )
...
pub async fn list_namespaces(
    State(state): State<Arc<WebState>>,
    Json(req): Json<ConnReq>,
) -> Result<Json<Vec<chiron_horizon_core::nacos::NacosNamespaceInfo>>, AppError> {
    let result = chiron_horizon_core::nacos::service::nacos_list_namespaces_core(&state.app, &req.connection_id)
        .await
        .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn sidebar_snapshot(
    State(state): State<Arc<WebState>>,
    Json(req): Json<ConnReq>,
) -> Result<Json<chiron_horizon_core::nacos::NacosNamespaceSidebarSnapshot>, AppError> {
    let result = chiron_horizon_core::nacos::service::nacos_sidebar_snapshot_core(&state.app, &req.connection_id)
        .await
        .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn create_namespace(
    ...
    chiron_horizon_core::nacos::service::nacos_create_namespace_core(&state.app, &req.connection_id, req.req)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn update_namespace(
    ...
    chiron_horizon_core::nacos::service::nacos_update_namespace_core(&state.app, &req.connection_id, req.req)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn delete_namespace(
    ...
    chiron_horizon_core::nacos::service::nacos_delete_namespace_core(&state.app, &req.connection_id, req.namespace_id)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
) -> Result<Json<chiron_horizon_core::nacos::NacosConfigList>, AppError> {
    let result =
        chiron_horizon_core::nacos::service::nacos_list_configs_core(&state.app, &req.connection_id, req.query)
            .await
            .map_err(AppError::from)?;
    Ok(Json(result))
}
...
) -> Result<Json<chiron_horizon_core::nacos::NacosConfigItem>, AppError> {
    let result = chiron_horizon_core::nacos::service::nacos_get_config_core(&state.app, &req.connection_id, req.key)
        .await
        .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn publish_config(
    ...
    chiron_horizon_core::nacos::service::nacos_publish_config_core(&state.app, &req.connection_id, req.req)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn delete_config(
    ...
    chiron_horizon_core::nacos::service::nacos_delete_config_core(&state.app, &req.connection_id, req.key)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
) -> Result<Json<chiron_horizon_core::nacos::NacosConfigHistoryList>, AppError> {
    let result =
        chiron_horizon_core::nacos::service::nacos_list_config_history_core(&state.app, &req.connection_id, req.query)
            .await
            .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn get_config_history(
    ...
    let result =
        chiron_horizon_core::nacos::service::nacos_get_config_history_core(&state.app, &req.connection_id, req.key)
            .await
            .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn rollback_config(
    ...
    chiron_horizon_core::nacos::service::nacos_rollback_config_core(&state.app, &req.connection_id, req.req)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn get_rnacos_console_captcha(
    State(state): State<Arc<WebState>>,
    Json(req): Json<ConnReq>,
) -> Result<Json<chiron_horizon_core::nacos::NacosRNacosConsoleCaptcha>, AppError> {
    let result =
        chiron_horizon_core::nacos::service::nacos_get_rnacos_console_captcha_core(&state.app, &req.connection_id)
            .await
            .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn login_rnacos_console(
    ...
    chiron_horizon_core::nacos::service::nacos_login_rnacos_console_core(&state.app, &req.connection_id, req.captcha)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
) -> Result<Json<chiron_horizon_core::nacos::NacosUserList>, AppError> {
    let result = chiron_horizon_core::nacos::service::nacos_list_users_core(&state.app, &req.connection_id, req.query)
        .await
        .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn create_user(
    ...
    chiron_horizon_core::nacos::service::nacos_create_user_core(&state.app, &req.connection_id, req.req)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn update_user(
    ...
    chiron_horizon_core::nacos::service::nacos_update_user_core(&state.app, &req.connection_id, req.req)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn delete_user(
    ...
    chiron_horizon_core::nacos::service::nacos_delete_user_core(&state.app, &req.connection_id, req.username)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
) -> Result<Json<chiron_horizon_core::nacos::NacosRoleList>, AppError> {
    let result =
        chiron_horizon_core::nacos::service::nacos_list_role_bindings_core(&state.app, &req.connection_id, req.query)
            .await
            .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn assign_role(
    ...
    chiron_horizon_core::nacos::service::nacos_assign_role_core(&state.app, &req.connection_id, req.binding)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn remove_role(
    ...
    chiron_horizon_core::nacos::service::nacos_remove_role_core(&state.app, &req.connection_id, req.binding)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn access_snapshot(
    State(state): State<Arc<WebState>>,
    Json(req): Json<ConnReq>,
) -> Result<Json<chiron_horizon_core::nacos::NacosAccessControlSnapshot>, AppError> {
    let result = chiron_horizon_core::nacos::service::nacos_access_snapshot_core(&state.app, &req.connection_id)
        .await
        .map_err(AppError::from)?;
    Ok(Json(result))
}
...
) -> Result<Json<chiron_horizon_core::nacos::NacosAccessOperationResult>, AppError> {
    let result =
        chiron_horizon_core::nacos::service::nacos_start_access_operation_core(&state.app, &req.connection_id, req.req)
            .await
            .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn get_access_operation(
    ...
    let result = chiron_horizon_core::nacos::service::nacos_get_access_operation_core(
        &state.app,
        &req.connection_id,
        &req.operation_id,
    )
...
pub async fn retry_access_operation(
    ...
    let result = chiron_horizon_core::nacos::service::nacos_retry_access_operation_core(
        &state.app,
        &req.connection_id,
        req.retry,
    )
...
pub async fn undo_access_operation(
    ...
    let result = chiron_horizon_core::nacos::service::nacos_undo_access_operation_core(
        &state.app,
        &req.connection_id,
        &req.operation_id,
    )
...
) -> Result<Json<chiron_horizon_core::nacos::NacosServiceList>, AppError> {
    let result =
        chiron_horizon_core::nacos::service::nacos_list_services_core(&state.app, &req.connection_id, req.query)
            .await
            .map_err(AppError::from)?;
    Ok(Json(result))
}
...
) -> Result<Json<Vec<chiron_horizon_core::nacos::NacosInstanceInfo>>, AppError> {
    let result =
        chiron_horizon_core::nacos::service::nacos_list_instances_core(&state.app, &req.connection_id, req.query)
            .await
            .map_err(AppError::from)?;
    Ok(Json(result))
}
...
) -> Result<Json<chiron_horizon_core::nacos::NacosServiceDetail>, AppError> {
    let result = chiron_horizon_core::nacos::service::nacos_get_service_core(&state.app, &req.connection_id, req.query)
        .await
        .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn create_service(
    ...
    chiron_horizon_core::nacos::service::nacos_create_service_core(&state.app, &req.connection_id, req.req)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn update_service(
    ...
    chiron_horizon_core::nacos::service::nacos_update_service_core(&state.app, &req.connection_id, req.req)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn delete_service(
    ...
    chiron_horizon_core::nacos::service::nacos_delete_service_core(&state.app, &req.connection_id, req.query)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn update_instance(
    ...
    chiron_horizon_core::nacos::service::nacos_update_instance_core(&state.app, &req.connection_id, req.req)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn register_instance(
    ...
    chiron_horizon_core::nacos::service::nacos_register_instance_core(&state.app, &req.connection_id, req.req)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
pub async fn deregister_instance(
    ...
    chiron_horizon_core::nacos::service::nacos_deregister_instance_core(&state.app, &req.connection_id, req.req)
        .await
        .map_err(AppError::from)?;
    Ok(Json(()))
}
...
) -> Result<Json<chiron_horizon_core::nacos::NacosDashboardSnapshot>, AppError> {
    let result =
        chiron_horizon_core::nacos::service::nacos_get_dashboard_core(&state.app, &req.connection_id, req.query)
            .await
            .map_err(AppError::from)?;
    Ok(Json(result))
}
...
) -> Result<Json<chiron_horizon_core::nacos::NacosRawResponse>, AppError> {
    let result = chiron_horizon_core::nacos::service::nacos_raw_request_core(&state.app, &req.connection_id, req.req)
        .await
        .map_err(AppError::from)?;
    Ok(Json(result))
}
...
pub async fn search_config_content(
    ...
    let stream = async_stream::stream! {
        ...
        let search = chiron_horizon_core::nacos::service::nacos_search_config_content_core(
            &state.app,
            &req.connection_id,
            req.req,
            move |progress| {
...
pub async fn cancel_operation(Json(req): Json<CancelOperationReq>) -> Json<serde_json::Value> {
    let cancelled = chiron_horizon_core::nacos::service::nacos_cancel_operation_core(&req.operation_id);
...
pub async fn export_configs(
    ...
    let export_result = chiron_horizon_core::nacos::batch::nacos_export_config_archive_core(
        &state.app,
        &req.connection_id,
        req.selector,
        &archive_path,
...
pub async fn preview_config_import(
    ...
    let preview = chiron_horizon_core::nacos::batch::nacos_preview_config_import_core(
        &state.app,
        &connection_id,
        &target_namespace,
        &archive_path,
...
pub async fn apply_config_import(
...
) -> Result<Json<chiron_horizon_core::nacos::NacosBatchReport>, AppError> {
    ...
    let result = chiron_horizon_core::nacos::batch::nacos_apply_config_import_core(
        &state.app,
        &req.connection_id,
...
) -> Result<Json<chiron_horizon_core::nacos::NacosBatchPreview>, AppError> {
    chiron_horizon_core::nacos::batch::nacos_preview_config_transfer_core(&state.app, &req.req)
        .await
        .map(Json)
        .map_err(AppError::from)
}
...
pub async fn apply_config_transfer(
    ...
    chiron_horizon_core::nacos::batch::nacos_apply_config_transfer_core(&state.app, &req.req, &req.plan_hash)
        .await
        .map(Json)
        .map_err(AppError::from)
}
...
mod batch_tests {
    ...
    fn archive_tokens_cannot_escape_the_upload_directory() {
        let data_dir = Path::new("/tmp/chiron-horizon-nacos-route-test");
