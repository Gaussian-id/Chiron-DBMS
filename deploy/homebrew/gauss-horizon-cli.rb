class GaussHorizonCli < Formula
  desc "Command-line interface for Gauss Horizon database connections, schema, and safe queries"
  homepage "https://github.com/Gaussian-id/Gauss-Horizon"
  url "https://registry.npmjs.org/@gauss-horizon/cli/-/cli-0.4.7.tgz"
  ...
  def install
    ...
    node_modules = libexec/"lib/node_modules/@gauss-horizon/cli/node_modules"
  ...
  test do
    assert_path_exists bin/"gauss-horizon"
    system bin/"gauss-horizon", "doctor"
  end
end
