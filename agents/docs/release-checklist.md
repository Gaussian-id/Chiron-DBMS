...
Use this checklist before pushing release tags or publishing Chiron Horizon agent jars.
...
```bash
env JAVA_HOME=/private/tmp/chiron-horizon-jdk/jdk-21.0.11+10/Contents/Home \
  ./gradlew \
  -Dorg.gradle.java.installations.paths=/private/tmp/chiron-horizon-jdk/jdk-21.0.11+10/Contents/Home,/private/tmp/chiron-horizon-jdk8/jdk8/Contents/Home \
...
- Verify Chiron Horizon can download the matching runtime artifact.
...
```bash
unzip -p chiron-horizon-agent-h2.jar META-INF/MANIFEST.MF
```
