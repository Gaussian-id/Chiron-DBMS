...
/**
 * Kafka admin agent for Gauss Horizon. Communicates with the Rust bridge via JSON-RPC
...
public final class KafkaAgent {
    ...
    private static void applyTlsSkipVerification(JsonObject conn, Properties props) {
        ...
        GaussHorizonInsecureTrustManagerFactory.ensureRegistered();
        props.put("ssl.endpoint.identification.algorithm", "");
        props.put("ssl.trustmanager.algorithm", GaussHorizonInsecureTrustManagerFactory.ALGORITHM);
    }
    ...
    static Properties peekConsumerProperties(JsonObject conn, int count) {
        ...
        applyConnectionProperties(conn, props);
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "gauss-horizon-peek-" + UUID.randomUUID());
