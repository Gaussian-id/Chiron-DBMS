...
/**
 * Kafka admin agent for Chiron Horizon. Communicates with the Rust bridge via JSON-RPC
...
public final class KafkaAgent {
    ...
    private static void applyTlsSkipVerification(JsonObject conn, Properties props) {
        ...
        ChironHorizonInsecureTrustManagerFactory.ensureRegistered();
        props.put("ssl.endpoint.identification.algorithm", "");
        props.put("ssl.trustmanager.algorithm", ChironHorizonInsecureTrustManagerFactory.ALGORITHM);
    }
    ...
    static Properties peekConsumerProperties(JsonObject conn, int count) {
        ...
        applyConnectionProperties(conn, props);
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "chiron-horizon-peek-" + UUID.randomUUID());
