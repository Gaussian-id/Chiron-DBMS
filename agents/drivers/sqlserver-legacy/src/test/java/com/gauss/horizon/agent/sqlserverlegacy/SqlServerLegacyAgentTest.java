package com.gauss.horizon.agent.sqlserverlegacy;
...
class SqlServerLegacyAgentTest {
    ...
    void jtdsUrlUsesLegacySqlServerSyntax() {
        ConnectParams params = new ConnectParams(
            ...
            "sa",
            "secret",
            "applicationName=gauss-horizon;encrypt=true;sslProtocol=TLSv1",
            "",
            false
        );

        Assertions.assertEquals(
            "jdbc:jtds:sqlserver://db.example.com:1433/appdb;appName=gauss-horizon",
    ...
    void connectionErrorsPreserveDetailsAndIncludeRuntimeDiagnostics() {
        ...
        Assertions.assertTrue(error.getMessage().contains("Gauss Horizon SQL Server legacy TLS diagnostics:"));
    }
    ...
    void legacyTlsUrlUsesSqlServerTlsV1Properties() {
        ConnectParams params = new ConnectParams(
            ...
            "sa",
            "secret",
            "applicationName=gauss-horizon;sqlserverEncryption=disabled;encrypt=false;trustServerCertificate=false;sslProtocol=TLSv1.2",
            "",
            false
        );

        Assertions.assertEquals(
            "jdbc:sqlserver://db.example.com:14330;databaseName=appdb;applicationName=gauss-horizon;encrypt=true;trustServerCertificate=true;sslProtocol=TLSv1",
    ...
    void legacyTlsUrlKeepsNamedInstanceWithoutPort() {
        ConnectParams params = new ConnectParams(
            ...
            "sa",
            "secret",
            "applicationName=gauss-horizon",
            "",
            false
        );

        Assertions.assertEquals(
            "jdbc:sqlserver://db.example.com\\SQLEXPRESS;databaseName=appdb;applicationName=gauss-horizon;encrypt=true;trustServerCertificate=true;sslProtocol=TLSv1",
            SqlServerLegacyAgent.legacyTlsUrl(params)
        );
    }
    ...
    void legacyTlsUrlUsesExplicitPortInsteadOfNamedInstanceResolution() {
        ...
        Assertions.assertEquals(
            "jdbc:sqlserver://db.example.com:40030;databaseName=appdb;applicationName=gauss-horizon;encrypt=true;trustServerCertificate=true;sslProtocol=TLSv1",
            SqlServerLegacyAgent.legacyTlsUrl(params)
        );
    }
    ...
    void legacyTlsUrlUsesExplicitDefaultPortInsteadOfNamedInstanceResolution() {
        ...
        Assertions.assertEquals(
            "jdbc:sqlserver://db.example.com:1433;databaseName=appdb;applicationName=gauss-horizon;encrypt=true;trustServerCertificate=true;sslProtocol=TLSv1",
            SqlServerLegacyAgent.legacyTlsUrl(params)
        );
    }
    ...
    void legacyTlsUrlNormalizesExplicitConnectionString() {
        ...
        Assertions.assertEquals(
            "jdbc:sqlserver://db.example.com:1433;databaseName=custom;applicationName=gauss-horizon;encrypt=true;trustServerCertificate=true;sslProtocol=TLSv1",
            SqlServerLegacyAgent.legacyTlsUrl(params)
        );
    }
