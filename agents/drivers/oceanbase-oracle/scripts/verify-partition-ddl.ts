...
async function main() {
  ...
  const jar = "agents/drivers/oceanbase-oracle/build/libs/chiron-horizon-agent-oceanbase-oracle.jar";
  ...
  const source = "Chiron Horizon7055_S" + suffix,
    logical = "Chiron Horizon7055_L" + suffix,
    physical = "Chiron Horizon7055_P" + suffix;
  const fixtures = [
