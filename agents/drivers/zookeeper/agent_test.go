...
func TestKVOperationsAndPagination(t *testing.T) {
	...
	put(`{"key":"/app/name","value":{"encoding":"utf8","data":"gauss-horizon"}}`)
	...
	if err != nil || got["found"] != true || got["value"].(valueObject).Data != "gauss-horizon" {
		t.Fatalf("get=%#v err=%v", got, err)
	}
	put(`{"key":"/app/name","value":{"data":"gauss-horizon2"},"writeMode":"update"}`)
