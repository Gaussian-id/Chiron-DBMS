...
func runtimeMetadataLimit(poolSize int) int {
	...
	if raw := os.Getenv("CHIRON_HORIZON_AGENT_VASTBASE_MAX_CONCURRENT_METADATA"); raw != "" {
...
func runtimePoolSize() int {
	...
	if raw := os.Getenv("CHIRON_HORIZON_AGENT_VASTBASE_MAX_CONCURRENT_OPERATIONS"); raw != "" {
