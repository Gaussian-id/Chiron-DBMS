...
import com.gauss.horizon.agent.AbstractJdbcAgent;
...
import com.gauss.horizon.agent.MetadataSqlSupport;
...
import com.gauss.horizon.agent.TriggerInfo;
...
public class H2Agent extends AbstractJdbcAgent {
    ...
    public List<ColumnInfo> getColumns(String schema, String table) {
        return unchecked(() -> {
            ...
            String columnSql = "SELECT COLUMN_NAME, " + typeColumn + " AS GAUSS_HORIZON_DATA_TYPE, IS_NULLABLE, COLUMN_DEFAULT, "
                ...
                try (ResultSet rs = stmt.executeQuery()) {
                    while (rs.next()) {
                        ...
                        result.add(new ColumnInfo(
                            columnName,
                            rs.getString("GAUSS_HORIZON_DATA_TYPE"),
