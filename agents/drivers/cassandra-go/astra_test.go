...
// value exercises the same code path. Set GAUSS_HORIZON_TEST_PASSWORD to override.
func testPlaceholderPassword() string {
	if value := os.Getenv("GAUSS_HORIZON_TEST_PASSWORD"); value != "" {
		return value
	}
...
func writeTestSecureConnectBundle(t *testing.T) string {
	...
	template := &x509.Certificate{
		...
		Subject:               pkix.Name{CommonName: "gauss-horizon-astra-test"},
