...
# gauss-horizon.exe proves the pinned loader was not the one linked. The PE import audit
...
if ($violations.Count -gt 0) {
  ...
  throw @"
gauss-horizon.exe contains WebView2 loader strings newer than the pinned 1.0.902.49:
$summary
