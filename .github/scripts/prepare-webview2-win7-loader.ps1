...
$temporaryRoot = Join-Path ([System.IO.Path]::GetTempPath()) "gauss-horizon-win7-webview2-loader-$([Guid]::NewGuid())"
...
try {
  ...
  $probeDirectory = Join-Path ([System.IO.Path]::GetTempPath()) "gauss-horizon-win7-webview2-loader-probe"
