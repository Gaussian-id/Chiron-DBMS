...
const crateNativeDriverDirectories = {
  "sqlite-worker": "crates/chiron-horizon-sqlite-worker",
};
...
export function evaluateAgentVersionBump({
  ...
  if (skipBump) {
    logs.push("Skipping automatic module version bump for migrated first release; versions.json was carried over from chiron-horizon-agents.");
