...
export const STATIC_LABEL_SPECS = {
  ...
  "area/core": { color: "5319e7", description: "Shared Gauss Horizon core runtime" },
  ...
  "area/cli": { color: "bfd4f2", description: "Gauss Horizon command-line interface" },
...
export function inferAreaLabels(changedFiles) {
  ...
  if (has((file) => file.startsWith("crates/gauss-horizon-core/") || file.startsWith("packages/node-core/"))) {
    labels.add("area/core");
  }
  if (has((file) => file.startsWith("crates/gauss-horizon-web/") || file.startsWith("examples/web-api/"))) {
    labels.add("area/web");
  }
  if (has((file) => file.startsWith("agents/"))) labels.add("area/agents");
  if (has((file) => file.startsWith("crates/gauss-horizon-mcp/")
    || file.startsWith("packages/mcp-")
    || file.startsWith("packages/mcp-server/")
    || file.startsWith("examples/mcp/"))) {
    labels.add("area/mcp");
  }
  if (has((file) => file.startsWith("crates/gauss-horizon-cli/")
...
export function inferDatabaseTypes(changedFiles, knownDatabaseTypes) {
  ...
  for (const file of changedFiles) {
    ...
    if (file.startsWith("apps/desktop/src/") || file.startsWith("crates/gauss-horizon-core/src/")) {
