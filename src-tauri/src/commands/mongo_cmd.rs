...
pub async fn mongo_replace_document(
    ...
    chiron_horizon_core::mongo_ops::mongo_replace_document_core(
        &state,
        &connection_id,
        &database,
        &collection,
...
pub async fn mongo_bulk_write(
    ...
    options_json: Option<String>,
    mcp_request: Option<bool>,
) -> Result<chiron_horizon_core::db::mongo_driver::MongoBulkWriteResult, String> {
    if mcp_request == Some(true) {
    ...
    chiron_horizon_core::mongo_ops::mongo_bulk_write_core(
        &state,
        &connection_id,
        &database,
        &collection,
