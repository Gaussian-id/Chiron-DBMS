# chiron-horizon-plugin-sdk

Rust SDK for Chiron Horizon sidecar protocol v1.
...
The metadata ID and version must exactly match `manifest.json`; Chiron Horizon rejects a mismatched backend during initialization.
...
```rust
use chiron_horizon_plugin_sdk::{PluginServer, PluginTransport};
