# gauss-horizon-plugin-sdk

Rust SDK for Gauss Horizon sidecar protocol v1.
...
The metadata ID and version must exactly match `manifest.json`; Gauss Horizon rejects a mismatched backend during initialization.
...
```rust
use gauss_horizon_plugin_sdk::{PluginServer, PluginTransport};
